 ...
 * </p>
 * <ul>
 *   <li>{@link org.avatar.ds.model.asset.impl.ContractDefinitionImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.avatar.ds.model.asset.impl.ContractDefinitionImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.avatar.ds.model.asset.impl.ContractDefinitionImpl#getAccessPolicyId <em>Access Policy Id</em>}</li>
 *   <li>{@link org.avatar.ds.model.asset.impl.ContractDefinitionImpl#getContractPolicyId <em>Contract Policy Id</em>}</li>
 *   <li>{@link org.avatar.ds.model.asset.impl.ContractDefinitionImpl#getAssetsSelector <em>Assets Selector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractDefinitionImpl extends MinimalEObjectImpl.Container implements ContractDefinition {
	...
	protected EClass eStaticClass() {
		return DataSpaceAssetPackage.Literals.CONTRACT_DEFINITION;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.CONTRACT_DEFINITION__ID, oldId, id));
	}
	...
	public NotificationChain basicSetContext(Context newContext, NotificationChain msgs) {
		...
		context = newContext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTEXT, oldContext, newContext);
	...
	public void setContext(Context newContext) {
		if (newContext != context) {
			...
			if (context != null)
				msgs = ((InternalEObject)context).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTEXT, null, msgs);
			if (newContext != null)
				msgs = ((InternalEObject)newContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTEXT, null, msgs);
			msgs = basicSetContext(newContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTEXT, newContext, newContext));
	}
	...
	public void setAccessPolicyId(String newAccessPolicyId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.CONTRACT_DEFINITION__ACCESS_POLICY_ID, oldAccessPolicyId, accessPolicyId));
	}
	...
	public void setContractPolicyId(String newContractPolicyId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTRACT_POLICY_ID, oldContractPolicyId, contractPolicyId));
	}
	...
	public EList<String> getAssetsSelector() {
		if (assetsSelector == null) {
			assetsSelector = new EDataTypeUniqueEList<String>(String.class, this, DataSpaceAssetPackage.CONTRACT_DEFINITION__ASSETS_SELECTOR);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataSpaceAssetPackage.CONTRACT_DEFINITION__ID:
				return getId();
			case DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTEXT:
				return getContext();
			case DataSpaceAssetPackage.CONTRACT_DEFINITION__ACCESS_POLICY_ID:
				return getAccessPolicyId();
			case DataSpaceAssetPackage.CONTRACT_DEFINITION__CONTRACT_POLICY_ID:
				return getContractPolicyId();
			case DataSpaceAssetPackage.CONTRACT_DEFINITION__ASSETS_SELECTOR:
