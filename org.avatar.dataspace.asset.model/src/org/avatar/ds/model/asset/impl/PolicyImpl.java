...
public class PolicyImpl extends MinimalEObjectImpl.Container implements Policy {
	...
	protected EClass eStaticClass() {
		return DataSpaceAssetPackage.Literals.POLICY;
	}
	...
	public EList<String> getPermission() {
		if (permission == null) {
			permission = new EDataTypeUniqueEList<String>(String.class, this, DataSpaceAssetPackage.POLICY__PERMISSION);
		}
		return permission;
	}
	...
	public EList<String> getProhibition() {
		if (prohibition == null) {
			prohibition = new EDataTypeUniqueEList<String>(String.class, this, DataSpaceAssetPackage.POLICY__PROHIBITION);
		}
		return prohibition;
	}
	...
	public EList<String> getObligation() {
		if (obligation == null) {
			obligation = new EDataTypeUniqueEList<String>(String.class, this, DataSpaceAssetPackage.POLICY__OBLIGATION);
		}
		return obligation;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DataSpaceAssetPackage.POLICY__OBLIGATION:
