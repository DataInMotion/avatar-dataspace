...
public class DataSpaceResponseImpl extends MinimalEObjectImpl.Container implements DataSpaceResponse {
	...
	protected EClass eStaticClass() {
		return DataSpaceAssetPackage.Literals.DATA_SPACE_RESPONSE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.DATA_SPACE_RESPONSE__ID, oldId, id));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.DATA_SPACE_RESPONSE__TYPE, oldType, type));
	}
	...
	public NotificationChain basicSetContext(Context newContext, NotificationChain msgs) {
		...
		context = newContext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.DATA_SPACE_RESPONSE__CONTEXT, oldContext, newContext);
	...
	public void setContext(Context newContext) {
		if (newContext != context) {
			...
			if (context != null)
				msgs = ((InternalEObject)context).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataSpaceAssetPackage.DATA_SPACE_RESPONSE__CONTEXT, null, msgs);
			if (newContext != null)
				msgs = ((InternalEObject)newContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataSpaceAssetPackage.DATA_SPACE_RESPONSE__CONTEXT, null, msgs);
			msgs = basicSetContext(newContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpaceAssetPackage.DATA_SPACE_RESPONSE__CONTEXT, newContext, newContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataSpaceAssetPackage.DATA_SPACE_RESPONSE__ID:
				return getId();
			case DataSpaceAssetPackage.DATA_SPACE_RESPONSE__TYPE:
				return getType();
			case DataSpaceAssetPackage.DATA_SPACE_RESPONSE__CONTEXT:
				return getContext();
