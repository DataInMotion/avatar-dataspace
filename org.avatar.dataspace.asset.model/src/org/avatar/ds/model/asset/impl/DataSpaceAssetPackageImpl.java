 ...
 * @generated
 */
public class DataSpaceAssetPackageImpl extends EPackageImpl implements DataSpaceAssetPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.avatar.ds.model.asset.DataSpaceAssetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DataSpaceAssetPackageImpl() {
		super(eNS_URI, DataSpaceAssetFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link DataSpaceAssetPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DataSpaceAssetPackage init() {
		if (isInited) return (DataSpaceAssetPackage)EPackage.Registry.INSTANCE.getEPackage(DataSpaceAssetPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredDataSpaceAssetPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DataSpaceAssetPackageImpl theDataSpaceAssetPackage = registeredDataSpaceAssetPackage instanceof DataSpaceAssetPackageImpl ? (DataSpaceAssetPackageImpl)registeredDataSpaceAssetPackage : new DataSpaceAssetPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theDataSpaceAssetPackage.createPackageContents();

		// Initialize created meta-data
		theDataSpaceAssetPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theDataSpaceAssetPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DataSpaceAssetPackage.eNS_URI, theDataSpaceAssetPackage);
		return theDataSpaceAssetPackage;
	}
	...
	public EReference getAssetPolicy_Context() {
		return (EReference)assetPolicyEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public DataSpaceAssetFactory getDataSpaceAssetFactory() {
		return (DataSpaceAssetFactory)getEFactoryInstance();
	}
