 ...
 */
@ProviderType
@EPackage(uri = ConfigPackage.eNS_URI, genModel = "/model/gicsService.genmodel", genModelSourceLocations = {"model/gicsService.genmodel","org.avatar.gics.service.model/model/gicsService.genmodel"}, ecore="/model/config.ecore", ecoreSourceLocations="/model/config.ecore")
