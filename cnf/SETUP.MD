...
The Maven group-id is defaulted to **avatar-dataspace** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `avatar-dataspace`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `avatar-dataspace` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/avatar-dataspace/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/avatar-dataspace.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/avatar-dataspace/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `avatar-dataspace`
- [Jenkins avatar-dataspace branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/avatar-dataspace/)
