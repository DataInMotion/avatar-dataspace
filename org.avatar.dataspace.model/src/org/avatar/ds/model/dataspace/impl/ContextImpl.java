 ...
 * </p>
 * <ul>
 *   <li>{@link org.avatar.ds.model.dataspace.impl.ContextImpl#getVocab <em>Vocab</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	protected EClass eStaticClass() {
		return DataspacePackage.Literals.CONTEXT;
	}
	...
	public void setVocab(String newVocab) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataspacePackage.CONTEXT__VOCAB, oldVocab, vocab));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataspacePackage.CONTEXT__VOCAB:
				return getVocab();
		}
