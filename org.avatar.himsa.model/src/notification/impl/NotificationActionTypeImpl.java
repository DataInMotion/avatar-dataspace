 ...
 * </p>
 * <ul>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getActionGUID <em>Action GUID</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getModuleID <em>Module ID</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getModuleParameter <em>Module Parameter</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getIconUrl <em>Icon Url</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link notification.impl.NotificationActionTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotificationActionTypeImpl extends MinimalEObjectImpl.Container implements NotificationActionType {
	...
	protected EClass eStaticClass() {
		return NotificationPackage.Literals.NOTIFICATION_ACTION_TYPE;
	}
	...
	public void setCategory(String newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__CATEGORY, oldCategory, category));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setActionGUID(String newActionGUID) {
		...
		actionGUIDESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__ACTION_GUID, oldActionGUID, actionGUID, !oldActionGUIDESet));
	}
	...
	public void unsetActionGUID() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NotificationPackage.NOTIFICATION_ACTION_TYPE__ACTION_GUID, oldActionGUID, ACTION_GUID_EDEFAULT, oldActionGUIDESet));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__URL, oldUrl, url));
	}
	...
	public void setModuleID(Integer newModuleID) {
		...
		moduleIDESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__MODULE_ID, oldModuleID, moduleID, !oldModuleIDESet));
	}
	...
	public void unsetModuleID() {
		...
		moduleIDESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NotificationPackage.NOTIFICATION_ACTION_TYPE__MODULE_ID, oldModuleID, MODULE_ID_EDEFAULT, oldModuleIDESet));
	}
	...
	public void setModuleParameter(String newModuleParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__MODULE_PARAMETER, oldModuleParameter, moduleParameter));
	}
	...
	public void setIconUrl(String newIconUrl) {
		...
		iconUrl = newIconUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__ICON_URL, oldIconUrl, iconUrl));
	}
	...
	public void setGroup(String newGroup) {
		...
		groupESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__GROUP, oldGroup, group, !oldGroupESet));
	}
	...
	public void unsetGroup() {
		...
		groupESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NotificationPackage.NOTIFICATION_ACTION_TYPE__GROUP, oldGroup, GROUP_EDEFAULT, oldGroupESet));
	}
	...
	public void setConvertedFromDataStandard(BigInteger newConvertedFromDataStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__CONVERTED_FROM_DATA_STANDARD, oldConvertedFromDataStandard, convertedFromDataStandard));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotificationPackage.NOTIFICATION_ACTION_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NotificationPackage.NOTIFICATION_ACTION_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__CATEGORY:
				return getCategory();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__DESCRIPTION:
				return getDescription();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__ACTION_GUID:
				return getActionGUID();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__URL:
				return getUrl();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__MODULE_ID:
				return getModuleID();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__MODULE_PARAMETER:
				return getModuleParameter();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__ICON_URL:
				return getIconUrl();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__GROUP:
				return getGroup();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__CONVERTED_FROM_DATA_STANDARD:
				return getConvertedFromDataStandard();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE__VERSION:
				return getVersion();
		}
