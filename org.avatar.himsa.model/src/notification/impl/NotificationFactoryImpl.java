...
public class NotificationFactoryImpl extends EFactoryImpl implements NotificationFactory {
	...
	public static NotificationFactory init() {
		try {
			NotificationFactory theNotificationFactory = (NotificationFactory)EPackage.Registry.INSTANCE.getEFactory(NotificationPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case NotificationPackage.DOCUMENT_ROOT: return createDocumentRoot();
			case NotificationPackage.NOTIFICATION_ACTION_TYPE: return createNotificationActionType();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case NotificationPackage.ACTION_GUID_TYPE:
				return createActionGUIDTypeFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case NotificationPackage.ACTION_GUID_TYPE:
				return convertActionGUIDTypeToString(eDataType, instanceValue);
			case NotificationPackage.CATEGORY_TYPE:
	...
	public NotificationActionType createNotificationActionType() {
		NotificationActionTypeImpl notificationActionType = new NotificationActionTypeImpl();
	 ...
	 * @generated
	 */
	public String createActionGUIDTypeFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertActionGUIDTypeToString(EDataType eDataType, Object instanceValue) {
