 ...
 * <!-- end-user-doc -->
 * @see notification.NotificationPackage
 * @generated
 */
public class NotificationValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "notification";
	...
	public boolean validateActionGUIDType_Pattern(String actionGUIDType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(NotificationPackage.Literals.ACTION_GUID_TYPE, actionGUIDType, ACTION_GUID_TYPE__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateConvertedFromDataStandardType_Min(BigInteger convertedFromDataStandardType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(NotificationPackage.Literals.CONVERTED_FROM_DATA_STANDARD_TYPE, convertedFromDataStandardType, CONVERTED_FROM_DATA_STANDARD_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateGroupType_Pattern(String groupType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(NotificationPackage.Literals.GROUP_TYPE, groupType, GROUP_TYPE__PATTERN__VALUES, diagnostics, context);
	}
