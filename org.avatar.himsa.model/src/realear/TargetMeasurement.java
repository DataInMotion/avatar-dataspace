 ...
 * </p>
 * <ul>
 *   <li>{@link realear.TargetMeasurement#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link realear.TargetMeasurement#getLevelStep <em>Level Step</em>}</li>
 *   <li>{@link realear.TargetMeasurement#getAttackCurve <em>Attack Curve</em>}</li>
 *   <li>{@link realear.TargetMeasurement#getReleaseCurve <em>Release Curve</em>}</li>
 * </ul>
 *
 * @see realear.RealearPackage#getTargetMeasurement()
...
public interface TargetMeasurement extends EObject {
	 ...
	 * @see realear.RealearPackage#getTargetMeasurement_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link realear.TargetMeasurement#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see realear.RealearPackage#getTargetMeasurement_LevelStep()
	 * @model dataType="realear.LevelStepType" required="true"
	...
	/**
	 * Sets the value of the '{@link realear.TargetMeasurement#getLevelStep <em>Level Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see realear.RealearPackage#getTargetMeasurement_AttackCurve()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link realear.TargetMeasurement#getAttackCurve <em>Attack Curve</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see realear.RealearPackage#getTargetMeasurement_ReleaseCurve()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link realear.TargetMeasurement#getReleaseCurve <em>Release Curve</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
