 ...
 * </p>
 * <ul>
 *   <li>{@link realear.TargetPoint#getTargetFrequency <em>Target Frequency</em>}</li>
 *   <li>{@link realear.TargetPoint#getTargetGain <em>Target Gain</em>}</li>
 * </ul>
 *
 * @see realear.RealearPackage#getTargetPoint()
...
public interface TargetPoint extends EObject {
	 ...
	 * @see realear.RealearPackage#getTargetPoint_TargetFrequency()
	...
	/**
	 * Sets the value of the '{@link realear.TargetPoint#getTargetFrequency <em>Target Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see realear.RealearPackage#getTargetPoint_TargetGain()
	 * @model dataType="realear.TargetGainType" required="true"
	...
	/**
	 * Sets the value of the '{@link realear.TargetPoint#getTargetGain <em>Target Gain</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
