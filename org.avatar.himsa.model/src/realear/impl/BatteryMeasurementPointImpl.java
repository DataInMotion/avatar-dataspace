 ...
 * </p>
 * <ul>
 *   <li>{@link realear.impl.BatteryMeasurementPointImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link realear.impl.BatteryMeasurementPointImpl#getCurrent <em>Current</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BatteryMeasurementPointImpl extends MinimalEObjectImpl.Container implements BatteryMeasurementPoint {
	...
	protected EClass eStaticClass() {
		return RealearPackage.Literals.BATTERY_MEASUREMENT_POINT;
	}
	...
	public void setFrequency(BigInteger newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.BATTERY_MEASUREMENT_POINT__FREQUENCY, oldFrequency, frequency));
	}
	...
	public void setCurrent(BigDecimal newCurrent) {
		...
		current = newCurrent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.BATTERY_MEASUREMENT_POINT__CURRENT, oldCurrent, current));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RealearPackage.BATTERY_MEASUREMENT_POINT__FREQUENCY:
				return getFrequency();
			case RealearPackage.BATTERY_MEASUREMENT_POINT__CURRENT:
				return getCurrent();
		}
