...
import realear.AttackReleaseMeasurementPoint;
import realear.BatteryCurrentMeasurement;
import realear.BatteryMeasurementConditions;
import realear.BatteryMeasurementPoint;
import realear.BatteryPillType;
import realear.BatteryType;
import realear.CouplerType;
import realear.DocumentRoot;
import realear.EquivalentInputNoise;
import realear.FittingRule;
...
import realear.HearingInstrumentType;
...
import realear.MeasurementIdentification;
import realear.MeasurementMode;
...
import realear.SignalOutputType;
import realear.SignalType;
import realear.TargetCurve;
import realear.TargetMeasurement;
import realear.TargetMeasurementPoint;
import realear.TargetPoint;

import realear.util.RealearValidator;
 ...
 * @generated
 */
public class RealearPackageImpl extends EPackageImpl implements RealearPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see realear.RealearPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RealearPackageImpl() {
		super(eNS_URI, RealearFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link RealearPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RealearPackage init() {
		if (isInited) return (RealearPackage)EPackage.Registry.INSTANCE.getEPackage(RealearPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredRealearPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		RealearPackageImpl theRealearPackage = registeredRealearPackage instanceof RealearPackageImpl ? (RealearPackageImpl)registeredRealearPackage : new RealearPackageImpl();
			...
			(theRealearPackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return RealearValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theRealearPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RealearPackage.eNS_URI, theRealearPackage);
		return theRealearPackage;
	}
	 ...
	 */
	@Override
	public RealearFactory getRealearFactory() {
		return (RealearFactory)getEFactoryInstance();
	}
