 ...
 * </p>
 * <ul>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getFreq1 <em>Freq1</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getFreq2 <em>Freq2</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getInput1 <em>Input1</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getInput2 <em>Input2</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getOutput1 <em>Output1</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getOutput2 <em>Output2</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getOutputDiff1 <em>Output Diff1</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getOutputDiff2 <em>Output Diff2</em>}</li>
 *   <li>{@link realear.impl.IntermodulationDistortionPointImpl#getTIDistortion <em>TI Distortion</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermodulationDistortionPointImpl extends MinimalEObjectImpl.Container implements IntermodulationDistortionPoint {
	...
	protected EClass eStaticClass() {
		return RealearPackage.Literals.INTERMODULATION_DISTORTION_POINT;
	}
	...
	public void setFreq1(BigInteger newFreq1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__FREQ1, oldFreq1, freq1));
	}
	...
	public void setFreq2(BigInteger newFreq2) {
		...
		freq2 = newFreq2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__FREQ2, oldFreq2, freq2));
	}
	...
	public void setInput1(BigDecimal newInput1) {
		...
		input1 = newInput1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__INPUT1, oldInput1, input1));
	}
	...
	public void setInput2(BigDecimal newInput2) {
		...
		input2 = newInput2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__INPUT2, oldInput2, input2));
	}
	...
	public void setOutput1(BigDecimal newOutput1) {
		...
		output1 = newOutput1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT1, oldOutput1, output1));
	}
	...
	public void setOutput2(BigDecimal newOutput2) {
		...
		output2 = newOutput2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT2, oldOutput2, output2));
	}
	...
	public void setOutputDiff1(BigDecimal newOutputDiff1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT_DIFF1, oldOutputDiff1, outputDiff1));
	}
	...
	public void setOutputDiff2(BigDecimal newOutputDiff2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT_DIFF2, oldOutputDiff2, outputDiff2));
	}
	...
	public void setTIDistortion(BigDecimal newTIDistortion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.INTERMODULATION_DISTORTION_POINT__TI_DISTORTION, oldTIDistortion, tIDistortion));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__FREQ1:
				return getFreq1();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__FREQ2:
				return getFreq2();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__INPUT1:
				return getInput1();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__INPUT2:
				return getInput2();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT1:
				return getOutput1();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT2:
				return getOutput2();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT_DIFF1:
				return getOutputDiff1();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__OUTPUT_DIFF2:
				return getOutputDiff2();
			case RealearPackage.INTERMODULATION_DISTORTION_POINT__TI_DISTORTION:
