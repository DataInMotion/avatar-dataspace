 ...
 * </p>
 * <ul>
 *   <li>{@link realear.impl.TargetCurveImpl#getCurve <em>Curve</em>}</li>
 *   <li>{@link realear.impl.TargetCurveImpl#getResult <em>Result</em>}</li>
 *   <li>{@link realear.impl.TargetCurveImpl#getResolution <em>Resolution</em>}</li>
 *   <li>{@link realear.impl.TargetCurveImpl#getPreDelay <em>Pre Delay</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetCurveImpl extends MinimalEObjectImpl.Container implements TargetCurve {
	...
	protected EClass eStaticClass() {
		return RealearPackage.Literals.TARGET_CURVE;
	}
	...
	public NotificationChain basicSetCurve(TargetMeasurementPoint newCurve, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealearPackage.TARGET_CURVE__CURVE, oldCurve, newCurve);
	...
	public void setCurve(TargetMeasurementPoint newCurve) {
		if (newCurve != curve) {
			...
			if (curve != null)
				msgs = ((InternalEObject)curve).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealearPackage.TARGET_CURVE__CURVE, null, msgs);
			if (newCurve != null)
				msgs = ((InternalEObject)newCurve).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealearPackage.TARGET_CURVE__CURVE, null, msgs);
			msgs = basicSetCurve(newCurve, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.TARGET_CURVE__CURVE, newCurve, newCurve));
	}
	...
	public void setResult(BigInteger newResult) {
		...
		result = newResult;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.TARGET_CURVE__RESULT, oldResult, result));
	}
	...
	public void setResolution(BigInteger newResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.TARGET_CURVE__RESOLUTION, oldResolution, resolution));
	}
	...
	public void setPreDelay(BigInteger newPreDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.TARGET_CURVE__PRE_DELAY, oldPreDelay, preDelay));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RealearPackage.TARGET_CURVE__CURVE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RealearPackage.TARGET_CURVE__CURVE:
				return getCurve();
			case RealearPackage.TARGET_CURVE__RESULT:
				return getResult();
			case RealearPackage.TARGET_CURVE__RESOLUTION:
				return getResolution();
			case RealearPackage.TARGET_CURVE__PRE_DELAY:
				return getPreDelay();
		}
