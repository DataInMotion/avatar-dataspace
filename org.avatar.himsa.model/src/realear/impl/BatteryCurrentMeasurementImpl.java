 ...
 * </p>
 * <ul>
 *   <li>{@link realear.impl.BatteryCurrentMeasurementImpl#getBatteryConditions <em>Battery Conditions</em>}</li>
 *   <li>{@link realear.impl.BatteryCurrentMeasurementImpl#getBatteryCurve <em>Battery Curve</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BatteryCurrentMeasurementImpl extends MinimalEObjectImpl.Container implements BatteryCurrentMeasurement {
	...
	protected EClass eStaticClass() {
		return RealearPackage.Literals.BATTERY_CURRENT_MEASUREMENT;
	}
	...
	public NotificationChain basicSetBatteryConditions(BatteryMeasurementConditions newBatteryConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CONDITIONS, oldBatteryConditions, newBatteryConditions);
	...
	public void setBatteryConditions(BatteryMeasurementConditions newBatteryConditions) {
		if (newBatteryConditions != batteryConditions) {
			...
			if (batteryConditions != null)
				msgs = ((InternalEObject)batteryConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CONDITIONS, null, msgs);
			if (newBatteryConditions != null)
				msgs = ((InternalEObject)newBatteryConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CONDITIONS, null, msgs);
			msgs = basicSetBatteryConditions(newBatteryConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CONDITIONS, newBatteryConditions, newBatteryConditions));
	}
	...
	public EList<BatteryMeasurementPoint> getBatteryCurve() {
		if (batteryCurve == null) {
			batteryCurve = new EObjectContainmentEList<BatteryMeasurementPoint>(BatteryMeasurementPoint.class, this, RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CURVE);
		}
		return batteryCurve;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CONDITIONS:
				return basicSetBatteryConditions(null, msgs);
			case RealearPackage.BATTERY_CURRENT_MEASUREMENT__BATTERY_CURVE:
