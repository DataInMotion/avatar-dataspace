 ...
 * </p>
 * <ul>
 *   <li>{@link realear.impl.AttackReleaseMeasurementPointImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link realear.impl.AttackReleaseMeasurementPointImpl#getAttackReleaseTime <em>Attack Release Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttackReleaseMeasurementPointImpl extends MinimalEObjectImpl.Container implements AttackReleaseMeasurementPoint {
	...
	protected EClass eStaticClass() {
		return RealearPackage.Literals.ATTACK_RELEASE_MEASUREMENT_POINT;
	}
	...
	public void setOutput(BigDecimal newOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.ATTACK_RELEASE_MEASUREMENT_POINT__OUTPUT, oldOutput, output));
	}
	...
	public void setAttackReleaseTime(BigDecimal newAttackReleaseTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.ATTACK_RELEASE_MEASUREMENT_POINT__ATTACK_RELEASE_TIME, oldAttackReleaseTime, attackReleaseTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RealearPackage.ATTACK_RELEASE_MEASUREMENT_POINT__OUTPUT:
				return getOutput();
			case RealearPackage.ATTACK_RELEASE_MEASUREMENT_POINT__ATTACK_RELEASE_TIME:
