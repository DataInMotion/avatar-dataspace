 ...
 * </p>
 * <ul>
 *   <li>{@link realear.impl.OcclusionEffectsImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link realear.impl.OcclusionEffectsImpl#getREUR <em>REUR</em>}</li>
 *   <li>{@link realear.impl.OcclusionEffectsImpl#getREOR <em>REOR</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OcclusionEffectsImpl extends MinimalEObjectImpl.Container implements OcclusionEffects {
	...
	protected EClass eStaticClass() {
		return RealearPackage.Literals.OCCLUSION_EFFECTS;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditions newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RealearPackage.OCCLUSION_EFFECTS__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditions newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RealearPackage.OCCLUSION_EFFECTS__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RealearPackage.OCCLUSION_EFFECTS__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealearPackage.OCCLUSION_EFFECTS__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public EList<FrequencyMeasurementPoint> getREUR() {
		if (rEUR == null) {
			rEUR = new EObjectContainmentEList<FrequencyMeasurementPoint>(FrequencyMeasurementPoint.class, this, RealearPackage.OCCLUSION_EFFECTS__REUR);
		}
		return rEUR;
	}
	...
	public EList<FrequencyMeasurementPoint> getREOR() {
		if (rEOR == null) {
			rEOR = new EObjectContainmentEList<FrequencyMeasurementPoint>(FrequencyMeasurementPoint.class, this, RealearPackage.OCCLUSION_EFFECTS__REOR);
		}
		return rEOR;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RealearPackage.OCCLUSION_EFFECTS__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case RealearPackage.OCCLUSION_EFFECTS__REUR:
				return ((InternalEList<?>)getREUR()).basicRemove(otherEnd, msgs);
			case RealearPackage.OCCLUSION_EFFECTS__REOR:
