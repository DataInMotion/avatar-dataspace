 ...
 * </p>
 * <ul>
 *   <li>{@link realear.OcclusionEffects#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link realear.OcclusionEffects#getREUR <em>REUR</em>}</li>
 *   <li>{@link realear.OcclusionEffects#getREOR <em>REOR</em>}</li>
 * </ul>
 *
 * @see realear.RealearPackage#getOcclusionEffects()
...
public interface OcclusionEffects extends EObject {
	 ...
	 * @see realear.RealearPackage#getOcclusionEffects_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link realear.OcclusionEffects#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see realear.RealearPackage#getOcclusionEffects_REUR()
	 ...
	 * @see realear.RealearPackage#getOcclusionEffects_REOR()
	 * @model containment="true" required="true" upper="169"
