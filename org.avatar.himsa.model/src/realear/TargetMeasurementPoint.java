 ...
 * </p>
 * <ul>
 *   <li>{@link realear.TargetMeasurementPoint#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @see realear.RealearPackage#getTargetMeasurementPoint()
...
public interface TargetMeasurementPoint extends EObject {
	 ...
	 * @see realear.RealearPackage#getTargetMeasurementPoint_Output()
	 * @model unique="false" dataType="realear.OutputType1" required="true" upper="256"
