 ...
 * @generated
 */
public class RealearSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RealearPackage.HIMSA_REM_STANDARD_TYPE: {
				HIMSARemStandardType himsaRemStandardType = (HIMSARemStandardType)theEObject;
				T result = caseHIMSARemStandardType(himsaRemStandardType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RealearPackage.REAL_EAR_DATA_TYPE: {
				RealEarDataType realEarDataType = (RealEarDataType)theEObject;
				T result = caseRealEarDataType(realEarDataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>HIMSA Rem Standard Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>HIMSA Rem Standard Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHIMSARemStandardType(HIMSARemStandardType object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Real Ear Data Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Real Ear Data Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRealEarDataType(RealEarDataType object) {
		return null;
	}
