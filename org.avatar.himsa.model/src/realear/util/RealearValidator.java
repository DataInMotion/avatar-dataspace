 ...
 * @generated
 */
public class RealearValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final RealearValidator INSTANCE = new RealearValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "realear";
	...
	protected EPackage getEPackage() {
	  return RealearPackage.eINSTANCE;
	}
	 ...
	 * @generated
	 */
	public boolean validateHIMSARemStandardType(HIMSARemStandardType himsaRemStandardType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(himsaRemStandardType, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateRealEarDataType(RealEarDataType realEarDataType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(realEarDataType, diagnostics, context);
	}
	...
	public boolean validateAttackReleaseTimeType_FractionDigits(BigDecimal attackReleaseTimeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.ATTACK_RELEASE_TIME_TYPE, attackReleaseTimeType, 3, diagnostics, context);
		return result;
	}
	...
	public boolean validateAttackReleaseTimeType_Min(BigDecimal attackReleaseTimeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(RealearPackage.Literals.ATTACK_RELEASE_TIME_TYPE, attackReleaseTimeType, ATTACK_RELEASE_TIME_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateBatteryImpedanceType_FractionDigits(BigDecimal batteryImpedanceType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.BATTERY_IMPEDANCE_TYPE, batteryImpedanceType, 3, diagnostics, context);
		return result;
	}
	...
	public boolean validateBatteryImpedanceType1_FractionDigits(BigDecimal batteryImpedanceType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.BATTERY_IMPEDANCE_TYPE1, batteryImpedanceType1, 3, diagnostics, context);
		return result;
	}
	...
	public boolean validateBatteryVoltageType_FractionDigits(BigDecimal batteryVoltageType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.BATTERY_VOLTAGE_TYPE, batteryVoltageType, 3, diagnostics, context);
		return result;
	}
	...
	public boolean validateBatteryVoltageType1_FractionDigits(BigDecimal batteryVoltageType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.BATTERY_VOLTAGE_TYPE1, batteryVoltageType1, 3, diagnostics, context);
		return result;
	}
	...
	public boolean validateConvertedFromDataStandardType_Min(BigInteger convertedFromDataStandardType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(RealearPackage.Literals.CONVERTED_FROM_DATA_STANDARD_TYPE, convertedFromDataStandardType, CONVERTED_FROM_DATA_STANDARD_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateCurrentType_FractionDigits(BigDecimal currentType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.CURRENT_TYPE, currentType, 2, diagnostics, context);
		return result;
	}
	...
	public boolean validateEquivalentRootMeanSquareType_FractionDigits(BigDecimal equivalentRootMeanSquareType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.EQUIVALENT_ROOT_MEAN_SQUARE_TYPE, equivalentRootMeanSquareType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateFx1Type_FractionDigits(BigDecimal fx1Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.FX1_TYPE, fx1Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateFx2Type_FractionDigits(BigDecimal fx2Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.FX2_TYPE, fx2Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateFx3Type_FractionDigits(BigDecimal fx3Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.FX3_TYPE, fx3Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateInput1Type_FractionDigits(BigDecimal input1Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.INPUT1_TYPE, input1Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateInput2Type_FractionDigits(BigDecimal input2Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.INPUT2_TYPE, input2Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateInputType_FractionDigits(BigDecimal inputType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.INPUT_TYPE, inputType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateInputType1_FractionDigits(BigDecimal inputType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.INPUT_TYPE1, inputType1, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateInputType2_FractionDigits(BigDecimal inputType2, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.INPUT_TYPE2, inputType2, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateLevelStepType_FractionDigits(BigDecimal levelStepType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.LEVEL_STEP_TYPE, levelStepType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutput1Type_FractionDigits(BigDecimal output1Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT1_TYPE, output1Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutput2Type_FractionDigits(BigDecimal output2Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT2_TYPE, output2Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputDiff1Type_FractionDigits(BigDecimal outputDiff1Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT_DIFF1_TYPE, outputDiff1Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputDiff2Type_FractionDigits(BigDecimal outputDiff2Type, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT_DIFF2_TYPE, outputDiff2Type, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputType(BigDecimal outputType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		boolean result = validateOutputType_TotalDigits(outputType, diagnostics, context);
		return result;
	}

	/**
	 * Validates the TotalDigits constraint of '<em>Output Type</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateOutputType_TotalDigits(BigDecimal outputType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		int scale = outputType.scale();
		int totalDigits = scale < 0 ? outputType.precision() - scale : outputType.precision();
		boolean result = totalDigits <= 1;
		if (!result && diagnostics != null)
			reportTotalDigitsViolation(RealearPackage.Literals.OUTPUT_TYPE, outputType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputType1(BigDecimal outputType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		boolean result = validateOutputType1_FractionDigits(outputType1, diagnostics, context);
		return result;
	}

	/**
	 * Validates the FractionDigits constraint of '<em>Output Type1</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateOutputType1_FractionDigits(BigDecimal outputType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		boolean result = outputType1.scale() <= 1;
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT_TYPE1, outputType1, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputType2_FractionDigits(BigDecimal outputType2, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT_TYPE2, outputType2, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateOutputType3_FractionDigits(BigDecimal outputType3, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.OUTPUT_TYPE3, outputType3, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateReserveGainType_FractionDigits(BigDecimal reserveGainType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.RESERVE_GAIN_TYPE, reserveGainType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateRuleNameType_MaxLength(String ruleNameType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxLengthViolation(RealearPackage.Literals.RULE_NAME_TYPE, ruleNameType, length, 51, diagnostics, context);
		return result;
	}
	...
	public boolean validateSignalLevelType_FractionDigits(BigDecimal signalLevelType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.SIGNAL_LEVEL_TYPE, signalLevelType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateSignalLevelType1_FractionDigits(BigDecimal signalLevelType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.SIGNAL_LEVEL_TYPE1, signalLevelType1, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateSignalLevelType2_FractionDigits(BigDecimal signalLevelType2, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.SIGNAL_LEVEL_TYPE2, signalLevelType2, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateTargetGainType_FractionDigits(BigDecimal targetGainType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.TARGET_GAIN_TYPE, targetGainType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateThirdHDType_FractionDigits(BigDecimal thirdHDType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.THIRD_HD_TYPE, thirdHDType, 2, diagnostics, context);
		return result;
	}
	...
	public boolean validateTIDistortionType_FractionDigits(BigDecimal tiDistortionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.TI_DISTORTION_TYPE, tiDistortionType, 2, diagnostics, context);
		return result;
	}
	...
	public boolean validateVentCanalDiameterType_FractionDigits(BigDecimal ventCanalDiameterType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.VENT_CANAL_DIAMETER_TYPE, ventCanalDiameterType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateVentCanalLengthType_FractionDigits(BigDecimal ventCanalLengthType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(RealearPackage.Literals.VENT_CANAL_LENGTH_TYPE, ventCanalLengthType, 1, diagnostics, context);
		return result;
	}
