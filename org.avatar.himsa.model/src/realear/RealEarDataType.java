 ...
 * </p>
 * <ul>
 *   <li>{@link realear.RealEarDataType#getTargets <em>Targets</em>}</li>
 *   <li>{@link realear.RealEarDataType#getRealEarUnaidedResponse <em>Real Ear Unaided Response</em>}</li>
 *   <li>{@link realear.RealEarDataType#getRealEarOccludedResponse <em>Real Ear Occluded Response</em>}</li>
 *   <li>{@link realear.RealEarDataType#getRealEarInsertionResponse <em>Real Ear Insertion Response</em>}</li>
 *   <li>{@link realear.RealEarDataType#getRealEarAidedResponse <em>Real Ear Aided Response</em>}</li>
 *   <li>{@link realear.RealEarDataType#getInputOutputMeasurement <em>Input Output Measurement</em>}</li>
 *   <li>{@link realear.RealEarDataType#getTotalHarmonicDistortionMeasurement <em>Total Harmonic Distortion Measurement</em>}</li>
 *   <li>{@link realear.RealEarDataType#getOcclusionMeasurement <em>Occlusion Measurement</em>}</li>
 *   <li>{@link realear.RealEarDataType#getRealEarCoupler <em>Real Ear Coupler</em>}</li>
 * </ul>
 *
 * @see realear.RealearPackage#getRealEarDataType()
...
public interface RealEarDataType extends EObject {
	 ...
	 * The list contents are of type {@link realear.FullTargetCurve}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * ## targets ##
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_Targets()
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_RealEarUnaidedResponse()
	...
	/**
	 * Sets the value of the '{@link realear.RealEarDataType#getRealEarUnaidedResponse <em>Real Ear Unaided Response</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_RealEarOccludedResponse()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link realear.RealEarDataType#getRealEarOccludedResponse <em>Real Ear Occluded Response</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link realear.FrequencyMeasurement}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_RealEarInsertionResponse()
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_RealEarAidedResponse()
	 * @model containment="true" upper="5"
	 ...
	 * The list contents are of type {@link realear.InputOutputMeasurement}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_InputOutputMeasurement()
	 * @model containment="true" upper="5"
	 ...
	 * The list contents are of type {@link realear.HarmonicDistortionMeasurementCurve}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_TotalHarmonicDistortionMeasurement()
	 * @model containment="true" upper="3"
	 ...
	 * The list contents are of type {@link realear.OcclusionEffects}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_OcclusionMeasurement()
	 * @model containment="true" upper="3"
	 ...
	 * @see realear.RealearPackage#getRealEarDataType_RealEarCoupler()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link realear.RealEarDataType#getRealEarCoupler <em>Real Ear Coupler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
