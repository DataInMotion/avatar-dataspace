...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Pitch Match Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.TinnitusPitchMatchType#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link tinnitus.TinnitusPitchMatchType#getMeasurementPoint <em>Measurement Point</em>}</li>
 *   <li>{@link tinnitus.TinnitusPitchMatchType#getMatchingSuccess <em>Matching Success</em>}</li>
 * </ul>
 *
 * @see tinnitus.TinnitusPackage#getTinnitusPitchMatchType()
...
public interface TinnitusPitchMatchType extends EObject {
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusPitchMatchType_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link tinnitus.TinnitusPitchMatchType#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusPitchMatchType_MeasurementPoint()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link tinnitus.TinnitusPitchMatchType#getMeasurementPoint <em>Measurement Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusPitchMatchType_MatchingSuccess()
	...
	/**
	 * Sets the value of the '{@link tinnitus.TinnitusPitchMatchType#getMatchingSuccess <em>Matching Success</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link tinnitus.TinnitusPitchMatchType#getMatchingSuccess <em>Matching Success</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetMatchingSuccess()
	 * @see #getMatchingSuccess()
	...
	/**
	 * Returns whether the value of the '{@link tinnitus.TinnitusPitchMatchType#getMatchingSuccess <em>Matching Success</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
