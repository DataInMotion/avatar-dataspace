 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.MinimumMaskingLevelType#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link tinnitus.MinimumMaskingLevelType#getMeasurementPoint <em>Measurement Point</em>}</li>
 *   <li>{@link tinnitus.MinimumMaskingLevelType#getMatchingSuccess <em>Matching Success</em>}</li>
 * </ul>
 *
 * @see tinnitus.TinnitusPackage#getMinimumMaskingLevelType()
...
public interface MinimumMaskingLevelType extends EObject {
	 ...
	 * @see tinnitus.TinnitusPackage#getMinimumMaskingLevelType_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link tinnitus.MinimumMaskingLevelType#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getMinimumMaskingLevelType_MeasurementPoint()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link tinnitus.MinimumMaskingLevelType#getMeasurementPoint <em>Measurement Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getMinimumMaskingLevelType_MatchingSuccess()
	...
	/**
	 * Sets the value of the '{@link tinnitus.MinimumMaskingLevelType#getMatchingSuccess <em>Matching Success</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link tinnitus.MinimumMaskingLevelType#getMatchingSuccess <em>Matching Success</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetMatchingSuccess()
	 * @see #getMatchingSuccess()
	...
	/**
	 * Returns whether the value of the '{@link tinnitus.MinimumMaskingLevelType#getMatchingSuccess <em>Matching Success</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
