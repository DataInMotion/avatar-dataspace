...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Measurement Data Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getTinnitusMeasurementNotes <em>Tinnitus Measurement Notes</em>}</li>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getTinnitusMeasurementEquipment <em>Tinnitus Measurement Equipment</em>}</li>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getTinnitusPitchMatch <em>Tinnitus Pitch Match</em>}</li>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getTinnitusLoudnessMatch <em>Tinnitus Loudness Match</em>}</li>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getMinimumMaskingLevel <em>Minimum Masking Level</em>}</li>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getResidualInhibition <em>Residual Inhibition</em>}</li>
 *   <li>{@link tinnitus.TinnitusMeasurementDataType#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType()
...
public interface TinnitusMeasurementDataType extends EObject {
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_TinnitusMeasurementNotes()
	...
	/**
	 * Sets the value of the '{@link tinnitus.TinnitusMeasurementDataType#getTinnitusMeasurementNotes <em>Tinnitus Measurement Notes</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_TinnitusMeasurementEquipment()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link tinnitus.TinnitusMeasurementDataType#getTinnitusMeasurementEquipment <em>Tinnitus Measurement Equipment</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link tinnitus.TinnitusPitchMatchType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_TinnitusPitchMatch()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link tinnitus.TinnitusLoudnessMatchType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_TinnitusLoudnessMatch()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link tinnitus.MinimumMaskingLevelType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_MinimumMaskingLevel()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link tinnitus.ResidualInhibitionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_ResidualInhibition()
	 * @model containment="true"
	 ...
	 * @see tinnitus.TinnitusPackage#getTinnitusMeasurementDataType_Version()
	 * @model default="500" unsettable="true" dataType="tinnitus.VersionType" required="true"
	...
	/**
	 * Sets the value of the '{@link tinnitus.TinnitusMeasurementDataType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link tinnitus.TinnitusMeasurementDataType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetVersion()
	 * @see #getVersion()
	...
	/**
	 * Returns whether the value of the '{@link tinnitus.TinnitusMeasurementDataType#getVersion <em>Version</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
