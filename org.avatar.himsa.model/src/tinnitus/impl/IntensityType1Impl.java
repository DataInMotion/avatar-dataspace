 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.IntensityType1Impl#getIntensity <em>Intensity</em>}</li>
 *   <li>{@link tinnitus.impl.IntensityType1Impl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntensityType1Impl extends MinimalEObjectImpl.Container implements IntensityType1 {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.INTENSITY_TYPE1;
	}
	...
	public void setIntensity(BigDecimal newIntensity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.INTENSITY_TYPE1__INTENSITY, oldIntensity, intensity));
	}
	...
	public void setUnit(SignalUnitType newUnit) {
		...
		unitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.INTENSITY_TYPE1__UNIT, oldUnit, unit, !oldUnitESet));
	}
	...
	public void unsetUnit() {
		...
		unitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.INTENSITY_TYPE1__UNIT, oldUnit, UNIT_EDEFAULT, oldUnitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TinnitusPackage.INTENSITY_TYPE1__INTENSITY:
				return getIntensity();
			case TinnitusPackage.INTENSITY_TYPE1__UNIT:
				return getUnit();
		}
