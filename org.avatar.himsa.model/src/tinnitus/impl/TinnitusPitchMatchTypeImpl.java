...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pitch Match Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.TinnitusPitchMatchTypeImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link tinnitus.impl.TinnitusPitchMatchTypeImpl#getMeasurementPoint <em>Measurement Point</em>}</li>
 *   <li>{@link tinnitus.impl.TinnitusPitchMatchTypeImpl#getMatchingSuccess <em>Matching Success</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TinnitusPitchMatchTypeImpl extends MinimalEObjectImpl.Container implements TinnitusPitchMatchType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.TINNITUS_PITCH_MATCH_TYPE;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditionsType newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditionsType newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public NotificationChain basicSetMeasurementPoint(MeasurementFrequencyPointType newMeasurementPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_POINT, oldMeasurementPoint, newMeasurementPoint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementPoint(MeasurementFrequencyPointType newMeasurementPoint) {
		if (newMeasurementPoint != measurementPoint) {
			...
			if (measurementPoint != null)
				msgs = ((InternalEObject)measurementPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_POINT, null, msgs);
			if (newMeasurementPoint != null)
				msgs = ((InternalEObject)newMeasurementPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_POINT, null, msgs);
			msgs = basicSetMeasurementPoint(newMeasurementPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_POINT, newMeasurementPoint, newMeasurementPoint));
	}
	...
	public void setMatchingSuccess(TinnitusMatchSucessType newMatchingSuccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MATCHING_SUCCESS, oldMatchingSuccess, matchingSuccess, !oldMatchingSuccessESet));
	}
	...
	public void unsetMatchingSuccess() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MATCHING_SUCCESS, oldMatchingSuccess, MATCHING_SUCCESS_EDEFAULT, oldMatchingSuccessESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MEASUREMENT_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TinnitusPackage.TINNITUS_PITCH_MATCH_TYPE__MATCHING_SUCCESS:
