 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.BandwidthTypeImpl#getUpperLimit <em>Upper Limit</em>}</li>
 *   <li>{@link tinnitus.impl.BandwidthTypeImpl#getUpperSlope <em>Upper Slope</em>}</li>
 *   <li>{@link tinnitus.impl.BandwidthTypeImpl#getPlateauSlope <em>Plateau Slope</em>}</li>
 *   <li>{@link tinnitus.impl.BandwidthTypeImpl#getLowerLimit <em>Lower Limit</em>}</li>
 *   <li>{@link tinnitus.impl.BandwidthTypeImpl#getLowerSlope <em>Lower Slope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BandwidthTypeImpl extends MinimalEObjectImpl.Container implements BandwidthType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.BANDWIDTH_TYPE;
	}
	...
	public void setUpperLimit(BigDecimal newUpperLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.BANDWIDTH_TYPE__UPPER_LIMIT, oldUpperLimit, upperLimit));
	}
	...
	public void setUpperSlope(BigDecimal newUpperSlope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.BANDWIDTH_TYPE__UPPER_SLOPE, oldUpperSlope, upperSlope));
	}
	...
	public void setPlateauSlope(BigDecimal newPlateauSlope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.BANDWIDTH_TYPE__PLATEAU_SLOPE, oldPlateauSlope, plateauSlope));
	}
	...
	public void setLowerLimit(BigDecimal newLowerLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.BANDWIDTH_TYPE__LOWER_LIMIT, oldLowerLimit, lowerLimit));
	}
	...
	public void setLowerSlope(BigDecimal newLowerSlope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.BANDWIDTH_TYPE__LOWER_SLOPE, oldLowerSlope, lowerSlope));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TinnitusPackage.BANDWIDTH_TYPE__UPPER_LIMIT:
				return getUpperLimit();
			case TinnitusPackage.BANDWIDTH_TYPE__UPPER_SLOPE:
				return getUpperSlope();
			case TinnitusPackage.BANDWIDTH_TYPE__PLATEAU_SLOPE:
				return getPlateauSlope();
			case TinnitusPackage.BANDWIDTH_TYPE__LOWER_LIMIT:
				return getLowerLimit();
			case TinnitusPackage.BANDWIDTH_TYPE__LOWER_SLOPE:
