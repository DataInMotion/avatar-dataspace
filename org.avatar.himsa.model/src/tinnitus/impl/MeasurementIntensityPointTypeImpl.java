 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.MeasurementIntensityPointTypeImpl#getStimulusIntensity <em>Stimulus Intensity</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementIntensityPointTypeImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementIntensityPointTypeImpl#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementIntensityPointTypeImpl#getMaskingIntensity <em>Masking Intensity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementIntensityPointTypeImpl extends MinimalEObjectImpl.Container implements MeasurementIntensityPointType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.MEASUREMENT_INTENSITY_POINT_TYPE;
	}
	...
	public EList<IntensityType1> getStimulusIntensity() {
		if (stimulusIntensity == null) {
			stimulusIntensity = new EObjectContainmentEList<IntensityType1>(IntensityType1.class, this, TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__STIMULUS_INTENSITY);
		}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setMaskingFrequency(BigInteger newMaskingFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__MASKING_FREQUENCY, oldMaskingFrequency, maskingFrequency));
	}
	...
	public EList<IntensityType1> getMaskingIntensity() {
		if (maskingIntensity == null) {
			maskingIntensity = new EObjectContainmentEList<IntensityType1>(IntensityType1.class, this, TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__MASKING_INTENSITY);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__STIMULUS_INTENSITY:
				return ((InternalEList<?>)getStimulusIntensity()).basicRemove(otherEnd, msgs);
			case TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__MASKING_INTENSITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case TinnitusPackage.MEASUREMENT_INTENSITY_POINT_TYPE__MASKING_FREQUENCY:
