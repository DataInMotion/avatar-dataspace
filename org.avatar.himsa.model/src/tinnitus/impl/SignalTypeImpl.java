 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.SignalTypeImpl#getSignalTypes <em>Signal Types</em>}</li>
 *   <li>{@link tinnitus.impl.SignalTypeImpl#getOtherSignalSpecification <em>Other Signal Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignalTypeImpl extends MinimalEObjectImpl.Container implements SignalType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.SIGNAL_TYPE;
	}
	...
	public void setSignalTypes(SignalTypesType newSignalTypes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.SIGNAL_TYPE__SIGNAL_TYPES, oldSignalTypes, signalTypes, !oldSignalTypesESet));
	}
	...
	public void unsetSignalTypes() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.SIGNAL_TYPE__SIGNAL_TYPES, oldSignalTypes, SIGNAL_TYPES_EDEFAULT, oldSignalTypesESet));
	}
	...
	public void setOtherSignalSpecification(String newOtherSignalSpecification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.SIGNAL_TYPE__OTHER_SIGNAL_SPECIFICATION, oldOtherSignalSpecification, otherSignalSpecification));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TinnitusPackage.SIGNAL_TYPE__SIGNAL_TYPES:
				return getSignalTypes();
			case TinnitusPackage.SIGNAL_TYPE__OTHER_SIGNAL_SPECIFICATION:
