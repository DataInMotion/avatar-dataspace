 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusSignalType <em>Stimulus Signal Type</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusSignalOutput <em>Stimulus Signal Output</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingSignalType <em>Masking Signal Type</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingUnit <em>Masking Unit</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingSignalOutput <em>Masking Signal Output</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusTransducerType <em>Stimulus Transducer Type</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingTransducerType <em>Masking Transducer Type</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusTransducerDescription <em>Stimulus Transducer Description</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingTransducerDescription <em>Masking Transducer Description</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusAmplitudeModulation <em>Stimulus Amplitude Modulation</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingAmplitudeModulation <em>Masking Amplitude Modulation</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusBandwidthModulation <em>Stimulus Bandwidth Modulation</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingBandwidthModulation <em>Masking Bandwidth Modulation</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getStimulusFrequencyModulation <em>Stimulus Frequency Modulation</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementConditionsTypeImpl#getMaskingFrequencyModulation <em>Masking Frequency Modulation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementConditionsTypeImpl extends MinimalEObjectImpl.Container implements MeasurementConditionsType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.MEASUREMENT_CONDITIONS_TYPE;
	}
	...
	public NotificationChain basicSetStimulusSignalType(SignalType newStimulusSignalType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_TYPE, oldStimulusSignalType, newStimulusSignalType);
	...
	public void setStimulusSignalType(SignalType newStimulusSignalType) {
		if (newStimulusSignalType != stimulusSignalType) {
			...
			if (stimulusSignalType != null)
				msgs = ((InternalEObject)stimulusSignalType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_TYPE, null, msgs);
			if (newStimulusSignalType != null)
				msgs = ((InternalEObject)newStimulusSignalType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_TYPE, null, msgs);
			msgs = basicSetStimulusSignalType(newStimulusSignalType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_TYPE, newStimulusSignalType, newStimulusSignalType));
	}
	...
	public void setStimulusSignalOutput(SignalOutputType newStimulusSignalOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_OUTPUT, oldStimulusSignalOutput, stimulusSignalOutput, !oldStimulusSignalOutputESet));
	}
	...
	public void unsetStimulusSignalOutput() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_OUTPUT, oldStimulusSignalOutput, STIMULUS_SIGNAL_OUTPUT_EDEFAULT, oldStimulusSignalOutputESet));
	}
	...
	public NotificationChain basicSetMaskingSignalType(SignalType newMaskingSignalType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_TYPE, oldMaskingSignalType, newMaskingSignalType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaskingSignalType(SignalType newMaskingSignalType) {
		if (newMaskingSignalType != maskingSignalType) {
			...
			if (maskingSignalType != null)
				msgs = ((InternalEObject)maskingSignalType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_TYPE, null, msgs);
			if (newMaskingSignalType != null)
				msgs = ((InternalEObject)newMaskingSignalType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_TYPE, null, msgs);
			msgs = basicSetMaskingSignalType(newMaskingSignalType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_TYPE, newMaskingSignalType, newMaskingSignalType));
	}
	...
	public void setMaskingUnit(SignalUnitType newMaskingUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_UNIT, oldMaskingUnit, maskingUnit, !oldMaskingUnitESet));
	}
	...
	public void unsetMaskingUnit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_UNIT, oldMaskingUnit, MASKING_UNIT_EDEFAULT, oldMaskingUnitESet));
	}
	...
	public void setMaskingSignalOutput(SignalOutputType newMaskingSignalOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_OUTPUT, oldMaskingSignalOutput, maskingSignalOutput, !oldMaskingSignalOutputESet));
	}
	...
	public void unsetMaskingSignalOutput() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_OUTPUT, oldMaskingSignalOutput, MASKING_SIGNAL_OUTPUT_EDEFAULT, oldMaskingSignalOutputESet));
	}
	...
	public void setStimulusTransducerType(TransducerType newStimulusTransducerType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_TRANSDUCER_TYPE, oldStimulusTransducerType, stimulusTransducerType, !oldStimulusTransducerTypeESet));
	}
	...
	public void unsetStimulusTransducerType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_TRANSDUCER_TYPE, oldStimulusTransducerType, STIMULUS_TRANSDUCER_TYPE_EDEFAULT, oldStimulusTransducerTypeESet));
	}
	...
	public void setMaskingTransducerType(TransducerType newMaskingTransducerType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_TRANSDUCER_TYPE, oldMaskingTransducerType, maskingTransducerType, !oldMaskingTransducerTypeESet));
	}
	...
	public void unsetMaskingTransducerType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_TRANSDUCER_TYPE, oldMaskingTransducerType, MASKING_TRANSDUCER_TYPE_EDEFAULT, oldMaskingTransducerTypeESet));
	}
	...
	public void setStimulusTransducerDescription(String newStimulusTransducerDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_TRANSDUCER_DESCRIPTION, oldStimulusTransducerDescription, stimulusTransducerDescription, !oldStimulusTransducerDescriptionESet));
	}
	...
	public void unsetStimulusTransducerDescription() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_TRANSDUCER_DESCRIPTION, oldStimulusTransducerDescription, STIMULUS_TRANSDUCER_DESCRIPTION_EDEFAULT, oldStimulusTransducerDescriptionESet));
	}
	...
	public void setMaskingTransducerDescription(String newMaskingTransducerDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_TRANSDUCER_DESCRIPTION, oldMaskingTransducerDescription, maskingTransducerDescription, !oldMaskingTransducerDescriptionESet));
	}
	...
	public void unsetMaskingTransducerDescription() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_TRANSDUCER_DESCRIPTION, oldMaskingTransducerDescription, MASKING_TRANSDUCER_DESCRIPTION_EDEFAULT, oldMaskingTransducerDescriptionESet));
	}
	...
	public void setStimulusAmplitudeModulation(BigDecimal newStimulusAmplitudeModulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_AMPLITUDE_MODULATION, oldStimulusAmplitudeModulation, stimulusAmplitudeModulation));
	}
	...
	public void setMaskingAmplitudeModulation(BigDecimal newMaskingAmplitudeModulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_AMPLITUDE_MODULATION, oldMaskingAmplitudeModulation, maskingAmplitudeModulation));
	}
	...
	public void setStimulusBandwidthModulation(BigDecimal newStimulusBandwidthModulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_BANDWIDTH_MODULATION, oldStimulusBandwidthModulation, stimulusBandwidthModulation));
	}
	...
	public void setMaskingBandwidthModulation(BigDecimal newMaskingBandwidthModulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_BANDWIDTH_MODULATION, oldMaskingBandwidthModulation, maskingBandwidthModulation));
	}
	...
	public void setStimulusFrequencyModulation(BigDecimal newStimulusFrequencyModulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_FREQUENCY_MODULATION, oldStimulusFrequencyModulation, stimulusFrequencyModulation));
	}
	...
	public void setMaskingFrequencyModulation(BigDecimal newMaskingFrequencyModulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_FREQUENCY_MODULATION, oldMaskingFrequencyModulation, maskingFrequencyModulation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_TYPE:
				return basicSetStimulusSignalType(null, msgs);
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_SIGNAL_OUTPUT:
				return getStimulusSignalOutput();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_TYPE:
				return getMaskingSignalType();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_UNIT:
				return getMaskingUnit();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_SIGNAL_OUTPUT:
				return getMaskingSignalOutput();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_TRANSDUCER_TYPE:
				return getStimulusTransducerType();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_TRANSDUCER_TYPE:
				return getMaskingTransducerType();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_TRANSDUCER_DESCRIPTION:
				return getStimulusTransducerDescription();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_TRANSDUCER_DESCRIPTION:
				return getMaskingTransducerDescription();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_AMPLITUDE_MODULATION:
				return getStimulusAmplitudeModulation();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_AMPLITUDE_MODULATION:
				return getMaskingAmplitudeModulation();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_BANDWIDTH_MODULATION:
				return getStimulusBandwidthModulation();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_BANDWIDTH_MODULATION:
				return getMaskingBandwidthModulation();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__STIMULUS_FREQUENCY_MODULATION:
				return getStimulusFrequencyModulation();
			case TinnitusPackage.MEASUREMENT_CONDITIONS_TYPE__MASKING_FREQUENCY_MODULATION:
