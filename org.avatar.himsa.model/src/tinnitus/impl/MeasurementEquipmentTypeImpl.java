 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.MeasurementEquipmentTypeImpl#getAudiometerMakeModel <em>Audiometer Make Model</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementEquipmentTypeImpl#getAudiometerSerialNumber <em>Audiometer Serial Number</em>}</li>
 *   <li>{@link tinnitus.impl.MeasurementEquipmentTypeImpl#getAudiometerLastCalibrationDate <em>Audiometer Last Calibration Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementEquipmentTypeImpl extends MinimalEObjectImpl.Container implements MeasurementEquipmentType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.MEASUREMENT_EQUIPMENT_TYPE;
	}
	...
	public void setAudiometerMakeModel(String newAudiometerMakeModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_EQUIPMENT_TYPE__AUDIOMETER_MAKE_MODEL, oldAudiometerMakeModel, audiometerMakeModel));
	}
	...
	public void setAudiometerSerialNumber(String newAudiometerSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_EQUIPMENT_TYPE__AUDIOMETER_SERIAL_NUMBER, oldAudiometerSerialNumber, audiometerSerialNumber));
	}
	...
	public void setAudiometerLastCalibrationDate(XMLGregorianCalendar newAudiometerLastCalibrationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.MEASUREMENT_EQUIPMENT_TYPE__AUDIOMETER_LAST_CALIBRATION_DATE, oldAudiometerLastCalibrationDate, audiometerLastCalibrationDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TinnitusPackage.MEASUREMENT_EQUIPMENT_TYPE__AUDIOMETER_MAKE_MODEL:
				return getAudiometerMakeModel();
			case TinnitusPackage.MEASUREMENT_EQUIPMENT_TYPE__AUDIOMETER_SERIAL_NUMBER:
				return getAudiometerSerialNumber();
			case TinnitusPackage.MEASUREMENT_EQUIPMENT_TYPE__AUDIOMETER_LAST_CALIBRATION_DATE:
