 ...
 * </p>
 * <ul>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getSignalIntensity <em>Signal Intensity</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getStimulusExposureTime <em>Stimulus Exposure Time</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getInhibitionTime <em>Inhibition Time</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getPulseDuration <em>Pulse Duration</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getGapDuration <em>Gap Duration</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getNumberOfCycles <em>Number Of Cycles</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getInhibitionSuccess <em>Inhibition Success</em>}</li>
 *   <li>{@link tinnitus.impl.ResidualInhibitionTypeImpl#getPerceptionLocation <em>Perception Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResidualInhibitionTypeImpl extends MinimalEObjectImpl.Container implements ResidualInhibitionType {
	...
	protected EClass eStaticClass() {
		return TinnitusPackage.Literals.RESIDUAL_INHIBITION_TYPE;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditionsType newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditionsType newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.RESIDUAL_INHIBITION_TYPE__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.RESIDUAL_INHIBITION_TYPE__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public NotificationChain basicSetSignalIntensity(MeasurementIntensityPointType newSignalIntensity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__SIGNAL_INTENSITY, oldSignalIntensity, newSignalIntensity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSignalIntensity(MeasurementIntensityPointType newSignalIntensity) {
		if (newSignalIntensity != signalIntensity) {
			...
			if (signalIntensity != null)
				msgs = ((InternalEObject)signalIntensity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.RESIDUAL_INHIBITION_TYPE__SIGNAL_INTENSITY, null, msgs);
			if (newSignalIntensity != null)
				msgs = ((InternalEObject)newSignalIntensity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TinnitusPackage.RESIDUAL_INHIBITION_TYPE__SIGNAL_INTENSITY, null, msgs);
			msgs = basicSetSignalIntensity(newSignalIntensity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__SIGNAL_INTENSITY, newSignalIntensity, newSignalIntensity));
	}
	...
	public void setStimulusExposureTime(BigDecimal newStimulusExposureTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__STIMULUS_EXPOSURE_TIME, oldStimulusExposureTime, stimulusExposureTime));
	}
	...
	public void setInhibitionTime(BigDecimal newInhibitionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__INHIBITION_TIME, oldInhibitionTime, inhibitionTime));
	}
	...
	public void setPulseDuration(BigDecimal newPulseDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__PULSE_DURATION, oldPulseDuration, pulseDuration));
	}
	...
	public void setGapDuration(BigDecimal newGapDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__GAP_DURATION, oldGapDuration, gapDuration));
	}
	...
	public void setNumberOfCycles(BigInteger newNumberOfCycles) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__NUMBER_OF_CYCLES, oldNumberOfCycles, numberOfCycles));
	}
	...
	public void setInhibitionSuccess(TinnitusInhibitionSucessType newInhibitionSuccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__INHIBITION_SUCCESS, oldInhibitionSuccess, inhibitionSuccess, !oldInhibitionSuccessESet));
	}
	...
	public void unsetInhibitionSuccess() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__INHIBITION_SUCCESS, oldInhibitionSuccess, INHIBITION_SUCCESS_EDEFAULT, oldInhibitionSuccessESet));
	}
	...
	public void setPerceptionLocation(TinnitusPerceptionLocationType newPerceptionLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__PERCEPTION_LOCATION, oldPerceptionLocation, perceptionLocation, !oldPerceptionLocationESet));
	}
	...
	public void unsetPerceptionLocation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TinnitusPackage.RESIDUAL_INHIBITION_TYPE__PERCEPTION_LOCATION, oldPerceptionLocation, PERCEPTION_LOCATION_EDEFAULT, oldPerceptionLocationESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__SIGNAL_INTENSITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__STIMULUS_EXPOSURE_TIME:
				return getStimulusExposureTime();
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__INHIBITION_TIME:
				return getInhibitionTime();
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__PULSE_DURATION:
				return getPulseDuration();
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__GAP_DURATION:
				return getGapDuration();
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__NUMBER_OF_CYCLES:
				return getNumberOfCycles();
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__INHIBITION_SUCCESS:
				return getInhibitionSuccess();
			case TinnitusPackage.RESIDUAL_INHIBITION_TYPE__PERCEPTION_LOCATION:
