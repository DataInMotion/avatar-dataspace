 ...
 * @generated
 */
public class Audiogram502FactoryImpl extends EFactoryImpl implements Audiogram502Factory {
	/**
	 ...
	 * @generated
	 */
	public static Audiogram502Factory init() {
		try {
			Audiogram502Factory theAudiogram502Factory = (Audiogram502Factory)EPackage.Registry.INSTANCE.getEFactory(Audiogram502Package.eNS_URI);
			if (theAudiogram502Factory != null) {
				return theAudiogram502Factory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new Audiogram502FactoryImpl();
	}
	 ...
	 * @generated
	 */
	public Audiogram502FactoryImpl() {
		super();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Audiogram502Package.ADDITIONAL_MASKING2_TYPE: return createAdditionalMasking2Type();
			case Audiogram502Package.ADDITIONAL_MASKING_TYPE: return createAdditionalMaskingType();
			case Audiogram502Package.ALTERNATE_BINAURAL_LOUDNESS_BALANCE_AUDIOGRAM_TYPE: return createAlternateBinauralLoudnessBalanceAudiogramType();
			case Audiogram502Package.AUDIO_METRIC_MEASUREMENT_CONDITIONS_TYPE: return createAudioMetricMeasurementConditionsType();
			case Audiogram502Package.DECAY_AUDIOGRAM_TYPE: return createDecayAudiogramType();
			case Audiogram502Package.DECAY_POINT_TYPE: return createDecayPointType();
			case Audiogram502Package.DEVICE_SOLUTIONS_TYPE: return createDeviceSolutionsType();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE: return createDifferenceLimenFrequencyPointType();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_TYPE: return createDifferenceLimenFrequencyType();
			case Audiogram502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE: return createDifferenceLimenIntensityPointType();
			case Audiogram502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE: return createDifferenceLimenIntensityType();
			case Audiogram502Package.DOCUMENT_ROOT: return createDocumentRoot();
			case Audiogram502Package.FREQUENCIES_USED_FOR_TONE_AVERAGE_TYPE: return createFrequenciesUsedForToneAverageType();
			case Audiogram502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE: return createHIMSAAudiometricStandardType();
			case Audiogram502Package.INFORMATION_TYPE: return createInformationType();
			case Audiogram502Package.MEASUREMENT_NOTES_TYPE: return createMeasurementNotesType();
			case Audiogram502Package.MOST_COMFORTABLE_LEVEL_TYPE: return createMostComfortableLevelType();
			case Audiogram502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT: return createShortIncrementSensitivityIndexPoint();
			case Audiogram502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE: return createShortIncrementSensitivityIndexType();
			case Audiogram502Package.SPEECH_DISCRIMINATION_AUDIOGRAM_TYPE: return createSpeechDiscriminationAudiogramType();
			case Audiogram502Package.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE: return createSpeechMostComfortableLevelType();
			case Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE: return createSpeechReceptionThresholdAudiogramType();
			case Audiogram502Package.SPEECH_SCORE_POINT_TYPE: return createSpeechScorePointType();
			case Audiogram502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE: return createSpeechUncomfortableLevelType();
			case Audiogram502Package.STENGER_AUDIOGRAM_TYPE: return createStengerAudiogramType();
			case Audiogram502Package.SUPPLEMENTARY_DATA_TYPE: return createSupplementaryDataType();
			case Audiogram502Package.TONE_POINTS_TYPE: return createTonePointsType();
			case Audiogram502Package.TONE_THRESHOLD_AUDIOGRAM_TYPE: return createToneThresholdAudiogramType();
			case Audiogram502Package.UNCOMFORTABLE_LEVEL_TYPE: return createUncomfortableLevelType();
			case Audiogram502Package.WEBER_POINTS_TYPE: return createWeberPointsType();
			case Audiogram502Package.WEBER_POINT_TYPE: return createWeberPointType();
			default:
	...
	public AidedSolutionsType createAidedSolutionsTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createAidedSolutionsTypeFromString(Audiogram502Package.Literals.AIDED_SOLUTIONS_TYPE, initialValue);
	}
	...
	public String convertAidedSolutionsTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertAidedSolutionsTypeToString(Audiogram502Package.Literals.AIDED_SOLUTIONS_TYPE, instanceValue);
	}
	...
	public AuxiliaryParameterType createAuxiliaryParameterTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createAuxiliaryParameterTypeFromString(Audiogram502Package.Literals.AUXILIARY_PARAMETER_TYPE, initialValue);
	}
	...
	public String convertAuxiliaryParameterTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertAuxiliaryParameterTypeToString(Audiogram502Package.Literals.AUXILIARY_PARAMETER_TYPE, instanceValue);
	}
	...
	public DBweightingType createDBweightingTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createDBweightingTypeFromString(Audiogram502Package.Literals.DBWEIGHTING_TYPE, initialValue);
	}
	...
	public String convertDBweightingTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertDBweightingTypeToString(Audiogram502Package.Literals.DBWEIGHTING_TYPE, instanceValue);
	}
	...
	public EarType createEarTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createEarTypeFromString(Audiogram502Package.Literals.EAR_TYPE, initialValue);
	}
	...
	public String convertEarTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertEarTypeToString(Audiogram502Package.Literals.EAR_TYPE, instanceValue);
	}
	...
	public EstimatedResultByType createEstimatedResultByTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createEstimatedResultByTypeFromString(Audiogram502Package.Literals.ESTIMATED_RESULT_BY_TYPE, initialValue);
	}
	...
	public String convertEstimatedResultByTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertEstimatedResultByTypeToString(Audiogram502Package.Literals.ESTIMATED_RESULT_BY_TYPE, instanceValue);
	}
	...
	public HearingInstrumentConditionType createHearingInstrumentConditionTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createHearingInstrumentConditionTypeFromString(Audiogram502Package.Literals.HEARING_INSTRUMENT_CONDITION_TYPE, initialValue);
	}
	...
	public String convertHearingInstrumentConditionTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertHearingInstrumentConditionTypeToString(Audiogram502Package.Literals.HEARING_INSTRUMENT_CONDITION_TYPE, instanceValue);
	}
	...
	public ToneAverageType createLeftEar1TypeFromString(EDataType eDataType, String initialValue) {
		return createToneAverageTypeFromString(Audiogram502Package.Literals.TONE_AVERAGE_TYPE, initialValue);
	}
	...
	public String convertLeftEar1TypeToString(EDataType eDataType, Object instanceValue) {
		return convertToneAverageTypeToString(Audiogram502Package.Literals.TONE_AVERAGE_TYPE, instanceValue);
	}
	...
	public PointStatusType createPointStatusTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createPointStatusTypeFromString(Audiogram502Package.Literals.POINT_STATUS_TYPE, initialValue);
	}
	...
	public String convertPointStatusTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertPointStatusTypeToString(Audiogram502Package.Literals.POINT_STATUS_TYPE, instanceValue);
	}
	...
	public PresentationType createPresentationTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createPresentationTypeFromString(Audiogram502Package.Literals.PRESENTATION_TYPE, initialValue);
	}
	...
	public String convertPresentationTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertPresentationTypeToString(Audiogram502Package.Literals.PRESENTATION_TYPE, instanceValue);
	}
	...
	public SignalOutputType createSignalOutputTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createSignalOutputTypeFromString(Audiogram502Package.Literals.SIGNAL_OUTPUT_TYPE, initialValue);
	}
	...
	public String convertSignalOutputTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertSignalOutputTypeToString(Audiogram502Package.Literals.SIGNAL_OUTPUT_TYPE, instanceValue);
	}
	...
	public SignalType createSignalTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createSignalTypeFromString(Audiogram502Package.Literals.SIGNAL_TYPE, initialValue);
	}
	...
	public String convertSignalTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertSignalTypeToString(Audiogram502Package.Literals.SIGNAL_TYPE, instanceValue);
	}
	...
	public SpeechThresholdType createSpeechThresholdTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createSpeechThresholdTypeFromString(Audiogram502Package.Literals.SPEECH_THRESHOLD_TYPE, initialValue);
	}
	...
	public String convertSpeechThresholdTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertSpeechThresholdTypeToString(Audiogram502Package.Literals.SPEECH_THRESHOLD_TYPE, instanceValue);
	}
	...
	public TransducerCalibrationStandardType createTransducerCalibrationStandardTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createTransducerCalibrationStandardTypeFromString(Audiogram502Package.Literals.TRANSDUCER_CALIBRATION_STANDARD_TYPE, initialValue);
	}
	...
	public String convertTransducerCalibrationStandardTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertTransducerCalibrationStandardTypeToString(Audiogram502Package.Literals.TRANSDUCER_CALIBRATION_STANDARD_TYPE, instanceValue);
	}
	...
	public TransducerType createTransducerTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createTransducerTypeFromString(Audiogram502Package.Literals.TRANSDUCER_TYPE, initialValue);
	}
	...
	public String convertTransducerTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertTransducerTypeToString(Audiogram502Package.Literals.TRANSDUCER_TYPE, instanceValue);
	}
	...
	public WeberPointStatusType createWeberPointStatusTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createWeberPointStatusTypeFromString(Audiogram502Package.Literals.WEBER_POINT_STATUS_TYPE, initialValue);
	}
	...
	public String convertWeberPointStatusTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertWeberPointStatusTypeToString(Audiogram502Package.Literals.WEBER_POINT_STATUS_TYPE, instanceValue);
	}
	 ...
	 */
	@Override
	public Audiogram502Package getAudiogram502Package() {
		return (Audiogram502Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Audiogram502Package getPackage() {
		return Audiogram502Package.eINSTANCE;
	}

} //Audiogram502FactoryImpl
