 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.impl.WeberPointTypeImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link audiogram502.impl.WeberPointTypeImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link audiogram502.impl.WeberPointTypeImpl#getPointStatus <em>Point Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeberPointTypeImpl extends MinimalEObjectImpl.Container implements WeberPointType {
	...
	protected EClass eStaticClass() {
		return Audiogram502Package.Literals.WEBER_POINT_TYPE;
	}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.WEBER_POINT_TYPE__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.WEBER_POINT_TYPE__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setPointStatus(WeberPointStatusType newPointStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.WEBER_POINT_TYPE__POINT_STATUS, oldPointStatus, pointStatus, !oldPointStatusESet));
	}
	...
	public void unsetPointStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Audiogram502Package.WEBER_POINT_TYPE__POINT_STATUS, oldPointStatus, POINT_STATUS_EDEFAULT, oldPointStatusESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Audiogram502Package.WEBER_POINT_TYPE__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case Audiogram502Package.WEBER_POINT_TYPE__STIMULUS_LEVEL:
				return getStimulusLevel();
			case Audiogram502Package.WEBER_POINT_TYPE__POINT_STATUS:
