...
public class Audiogram502PackageImpl extends EPackageImpl implements Audiogram502Package {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAudioMetricMeasurementConditionsType_StimulusSignalType(), this.getSignalType(), "stimulusSignalType", "NoSignalApplied", 1, 1, AudioMetricMeasurementConditionsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAudioMetricMeasurementConditionsType_StimulusPresentationType(), this.getPresentationType(), "stimulusPresentationType", "NoPresentationType", 0, 1, AudioMetricMeasurementConditionsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFrequenciesUsedForToneAverageType_LeftEar1(), this.getToneAverageType(), "leftEar1", null, 0, 13, FrequenciesUsedForToneAverageType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInformationType_Comments(), ecorePackage.getEString(), "comments", null, 0, 1, InformationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
