 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.impl.TonePointsTypeImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link audiogram502.impl.TonePointsTypeImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link audiogram502.impl.TonePointsTypeImpl#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link audiogram502.impl.TonePointsTypeImpl#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link audiogram502.impl.TonePointsTypeImpl#getTonePointStatus <em>Tone Point Status</em>}</li>
 *   <li>{@link audiogram502.impl.TonePointsTypeImpl#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TonePointsTypeImpl extends MinimalEObjectImpl.Container implements TonePointsType {
	...
	protected EClass eStaticClass() {
		return Audiogram502Package.Literals.TONE_POINTS_TYPE;
	}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setMaskingFrequency(BigInteger newMaskingFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__MASKING_FREQUENCY, oldMaskingFrequency, maskingFrequency));
	}
	...
	public void setMaskingLevel(BigDecimal newMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__MASKING_LEVEL, oldMaskingLevel, maskingLevel));
	}
	...
	public void setTonePointStatus(PointStatusType newTonePointStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__TONE_POINT_STATUS, oldTonePointStatus, tonePointStatus, !oldTonePointStatusESet));
	}
	...
	public void unsetTonePointStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Audiogram502Package.TONE_POINTS_TYPE__TONE_POINT_STATUS, oldTonePointStatus, TONE_POINT_STATUS_EDEFAULT, oldTonePointStatusESet));
	}
	...
	public NotificationChain basicSetAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__ADDITIONAL_MASKING_POINT, oldAdditionalMaskingPoint, newAdditionalMaskingPoint);
	...
	public void setAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint) {
		if (newAdditionalMaskingPoint != additionalMaskingPoint) {
			...
			if (additionalMaskingPoint != null)
				msgs = ((InternalEObject)additionalMaskingPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Audiogram502Package.TONE_POINTS_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			if (newAdditionalMaskingPoint != null)
				msgs = ((InternalEObject)newAdditionalMaskingPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Audiogram502Package.TONE_POINTS_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			msgs = basicSetAdditionalMaskingPoint(newAdditionalMaskingPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.TONE_POINTS_TYPE__ADDITIONAL_MASKING_POINT, newAdditionalMaskingPoint, newAdditionalMaskingPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Audiogram502Package.TONE_POINTS_TYPE__ADDITIONAL_MASKING_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Audiogram502Package.TONE_POINTS_TYPE__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case Audiogram502Package.TONE_POINTS_TYPE__STIMULUS_LEVEL:
				return getStimulusLevel();
			case Audiogram502Package.TONE_POINTS_TYPE__MASKING_FREQUENCY:
				return getMaskingFrequency();
			case Audiogram502Package.TONE_POINTS_TYPE__MASKING_LEVEL:
				return getMaskingLevel();
			case Audiogram502Package.TONE_POINTS_TYPE__TONE_POINT_STATUS:
