 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.impl.SpeechReceptionThresholdAudiogramTypeImpl#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link audiogram502.impl.SpeechReceptionThresholdAudiogramTypeImpl#getSpeechReceptionPoints <em>Speech Reception Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeechReceptionThresholdAudiogramTypeImpl extends MinimalEObjectImpl.Container implements SpeechReceptionThresholdAudiogramType {
	...
	protected EClass eStaticClass() {
		return Audiogram502Package.Literals.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE;
	}
	...
	public NotificationChain basicSetAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__AUD_MEASUREMENT_CONDITIONS, oldAudMeasurementConditions, newAudMeasurementConditions);
	...
	public void setAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions) {
		if (newAudMeasurementConditions != audMeasurementConditions) {
			...
			if (audMeasurementConditions != null)
				msgs = ((InternalEObject)audMeasurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			if (newAudMeasurementConditions != null)
				msgs = ((InternalEObject)newAudMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetAudMeasurementConditions(newAudMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__AUD_MEASUREMENT_CONDITIONS, newAudMeasurementConditions, newAudMeasurementConditions));
	}
	...
	public EList<SpeechScorePointType> getSpeechReceptionPoints() {
		if (speechReceptionPoints == null) {
			speechReceptionPoints = new EObjectContainmentEList<SpeechScorePointType>(SpeechScorePointType.class, this, Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__SPEECH_RECEPTION_POINTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__AUD_MEASUREMENT_CONDITIONS:
				return basicSetAudMeasurementConditions(null, msgs);
			case Audiogram502Package.SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM_TYPE__SPEECH_RECEPTION_POINTS:
