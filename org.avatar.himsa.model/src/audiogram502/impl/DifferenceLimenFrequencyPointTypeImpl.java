 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getModulationSize <em>Modulation Size</em>}</li>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getDifferenceLimenFrequencyPointStatus <em>Difference Limen Frequency Point Status</em>}</li>
 *   <li>{@link audiogram502.impl.DifferenceLimenFrequencyPointTypeImpl#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DifferenceLimenFrequencyPointTypeImpl extends MinimalEObjectImpl.Container implements DifferenceLimenFrequencyPointType {
	...
	protected EClass eStaticClass() {
		return Audiogram502Package.Literals.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE;
	}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setMaskingFrequency(BigInteger newMaskingFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__MASKING_FREQUENCY, oldMaskingFrequency, maskingFrequency));
	}
	...
	public void setMaskingLevel(BigDecimal newMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__MASKING_LEVEL, oldMaskingLevel, maskingLevel));
	}
	...
	public void setModulationSize(BigDecimal newModulationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__MODULATION_SIZE, oldModulationSize, modulationSize));
	}
	...
	public void setDifferenceLimenFrequencyPointStatus(PointStatusType newDifferenceLimenFrequencyPointStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__DIFFERENCE_LIMEN_FREQUENCY_POINT_STATUS, oldDifferenceLimenFrequencyPointStatus, differenceLimenFrequencyPointStatus, !oldDifferenceLimenFrequencyPointStatusESet));
	}
	...
	public void unsetDifferenceLimenFrequencyPointStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__DIFFERENCE_LIMEN_FREQUENCY_POINT_STATUS, oldDifferenceLimenFrequencyPointStatus, DIFFERENCE_LIMEN_FREQUENCY_POINT_STATUS_EDEFAULT, oldDifferenceLimenFrequencyPointStatusESet));
	}
	...
	public NotificationChain basicSetAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__ADDITIONAL_MASKING_POINT, oldAdditionalMaskingPoint, newAdditionalMaskingPoint);
	...
	public void setAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint) {
		if (newAdditionalMaskingPoint != additionalMaskingPoint) {
			...
			if (additionalMaskingPoint != null)
				msgs = ((InternalEObject)additionalMaskingPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			if (newAdditionalMaskingPoint != null)
				msgs = ((InternalEObject)newAdditionalMaskingPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			msgs = basicSetAdditionalMaskingPoint(newAdditionalMaskingPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__ADDITIONAL_MASKING_POINT, newAdditionalMaskingPoint, newAdditionalMaskingPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__ADDITIONAL_MASKING_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__STIMULUS_LEVEL:
				return getStimulusLevel();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__MASKING_FREQUENCY:
				return getMaskingFrequency();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__MASKING_LEVEL:
				return getMaskingLevel();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__MODULATION_SIZE:
				return getModulationSize();
			case Audiogram502Package.DIFFERENCE_LIMEN_FREQUENCY_POINT_TYPE__DIFFERENCE_LIMEN_FREQUENCY_POINT_STATUS:
