 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.impl.AdditionalMaskingTypeImpl#getAdditionalStimulusLevel <em>Additional Stimulus Level</em>}</li>
 *   <li>{@link audiogram502.impl.AdditionalMaskingTypeImpl#getAdditionalMaskingLevel <em>Additional Masking Level</em>}</li>
 *   <li>{@link audiogram502.impl.AdditionalMaskingTypeImpl#getAdditionalMaskingPointStatus <em>Additional Masking Point Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalMaskingTypeImpl extends MinimalEObjectImpl.Container implements AdditionalMaskingType {
	...
	protected EClass eStaticClass() {
		return Audiogram502Package.Literals.ADDITIONAL_MASKING_TYPE;
	}
	...
	public void setAdditionalStimulusLevel(BigDecimal newAdditionalStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_STIMULUS_LEVEL, oldAdditionalStimulusLevel, additionalStimulusLevel));
	}
	...
	public void setAdditionalMaskingLevel(BigDecimal newAdditionalMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_MASKING_LEVEL, oldAdditionalMaskingLevel, additionalMaskingLevel));
	}
	...
	public void setAdditionalMaskingPointStatus(PointStatusType newAdditionalMaskingPointStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_MASKING_POINT_STATUS, oldAdditionalMaskingPointStatus, additionalMaskingPointStatus, !oldAdditionalMaskingPointStatusESet));
	}
	...
	public void unsetAdditionalMaskingPointStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_MASKING_POINT_STATUS, oldAdditionalMaskingPointStatus, ADDITIONAL_MASKING_POINT_STATUS_EDEFAULT, oldAdditionalMaskingPointStatusESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_STIMULUS_LEVEL:
				return getAdditionalStimulusLevel();
			case Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_MASKING_LEVEL:
				return getAdditionalMaskingLevel();
			case Audiogram502Package.ADDITIONAL_MASKING_TYPE__ADDITIONAL_MASKING_POINT_STATUS:
