 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.DecayPointType#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link audiogram502.DecayPointType#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link audiogram502.DecayPointType#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link audiogram502.DecayPointType#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link audiogram502.DecayPointType#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link audiogram502.DecayPointType#getEndTime <em>End Time</em>}</li>
 *   <li>{@link audiogram502.DecayPointType#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @see audiogram502.Audiogram502Package#getDecayPointType()
...
public interface DecayPointType extends EObject {
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_StimulusFrequency()
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getStimulusFrequency <em>Stimulus Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_StimulusLevel()
	 * @model dataType="audiogram502.StimulusLevelType3" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getStimulusLevel <em>Stimulus Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_MaskingFrequency()
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getMaskingFrequency <em>Masking Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_MaskingLevel()
	 * @model dataType="audiogram502.MaskingLevelType1"
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getMaskingLevel <em>Masking Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_StartTime()
	 * @model dataType="audiogram502.StartTimeType" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getStartTime <em>Start Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_EndTime()
	 * @model dataType="audiogram502.EndTimeType" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getEndTime <em>End Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getDecayPointType_AdditionalMaskingPoint()
	...
	/**
	 * Sets the value of the '{@link audiogram502.DecayPointType#getAdditionalMaskingPoint <em>Additional Masking Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
