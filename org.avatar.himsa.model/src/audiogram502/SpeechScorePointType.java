 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram502.SpeechScorePointType#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link audiogram502.SpeechScorePointType#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link audiogram502.SpeechScorePointType#getScorePercent <em>Score Percent</em>}</li>
 *   <li>{@link audiogram502.SpeechScorePointType#getNumberOfWords <em>Number Of Words</em>}</li>
 *   <li>{@link audiogram502.SpeechScorePointType#getSpeechPointStatus <em>Speech Point Status</em>}</li>
 *   <li>{@link audiogram502.SpeechScorePointType#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @see audiogram502.Audiogram502Package#getSpeechScorePointType()
...
public interface SpeechScorePointType extends EObject {
	 ...
	 * @see audiogram502.Audiogram502Package#getSpeechScorePointType_StimulusLevel()
	 * @model dataType="audiogram502.StimulusLevelType5" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram502.SpeechScorePointType#getStimulusLevel <em>Stimulus Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getSpeechScorePointType_MaskingLevel()
	 * @model dataType="audiogram502.MaskingLevelType3"
	...
	/**
	 * Sets the value of the '{@link audiogram502.SpeechScorePointType#getMaskingLevel <em>Masking Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getSpeechScorePointType_ScorePercent()
	 * @model dataType="audiogram502.ScorePercentType" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram502.SpeechScorePointType#getScorePercent <em>Score Percent</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getSpeechScorePointType_NumberOfWords()
	...
	/**
	 * Sets the value of the '{@link audiogram502.SpeechScorePointType#getNumberOfWords <em>Number Of Words</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getSpeechScorePointType_SpeechPointStatus()
	...
	/**
	 * Sets the value of the '{@link audiogram502.SpeechScorePointType#getSpeechPointStatus <em>Speech Point Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link audiogram502.SpeechScorePointType#getSpeechPointStatus <em>Speech Point Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetSpeechPointStatus()
	 * @see #getSpeechPointStatus()
	...
	/**
	 * Returns whether the value of the '{@link audiogram502.SpeechScorePointType#getSpeechPointStatus <em>Speech Point Status</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram502.Audiogram502Package#getSpeechScorePointType_AdditionalMaskingPoint()
	...
	/**
	 * Sets the value of the '{@link audiogram502.SpeechScorePointType#getAdditionalMaskingPoint <em>Additional Masking Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
