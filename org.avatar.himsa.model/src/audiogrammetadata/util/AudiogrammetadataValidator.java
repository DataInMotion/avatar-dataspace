 ...
 * @generated
 */
public class AudiogrammetadataValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final AudiogrammetadataValidator INSTANCE = new AudiogrammetadataValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "audiogrammetadata";
	 ...
	 * @generated
	 */
	public AudiogrammetadataValidator() {
		super();
	...
	public boolean validateVersionType_Min(BigInteger versionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(AudiogrammetadataPackage.Literals.VERSION_TYPE, versionType, VERSION_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
