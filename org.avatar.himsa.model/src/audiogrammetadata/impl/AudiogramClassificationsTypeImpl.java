 ...
 * </p>
 * <ul>
 *   <li>{@link audiogrammetadata.impl.AudiogramClassificationsTypeImpl#getAMCLASS <em>AMCLASS</em>}</li>
 *   <li>{@link audiogrammetadata.impl.AudiogramClassificationsTypeImpl#getNonStandardized <em>Non Standardized</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AudiogramClassificationsTypeImpl extends MinimalEObjectImpl.Container implements AudiogramClassificationsType {
	...
	protected EClass eStaticClass() {
		return AudiogrammetadataPackage.Literals.AUDIOGRAM_CLASSIFICATIONS_TYPE;
	}
	...
	public NotificationChain basicSetAMCLASS(AMCLASSType1 newAMCLASS, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__AMCLASS, oldAMCLASS, newAMCLASS);
	...
	public void setAMCLASS(AMCLASSType1 newAMCLASS) {
		if (newAMCLASS != aMCLASS) {
			...
			if (aMCLASS != null)
				msgs = ((InternalEObject)aMCLASS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__AMCLASS, null, msgs);
			if (newAMCLASS != null)
				msgs = ((InternalEObject)newAMCLASS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__AMCLASS, null, msgs);
			msgs = basicSetAMCLASS(newAMCLASS, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__AMCLASS, newAMCLASS, newAMCLASS));
	}
	...
	public void setNonStandardized(String newNonStandardized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__NON_STANDARDIZED, oldNonStandardized, nonStandardized));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__AMCLASS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__AMCLASS:
				return getAMCLASS();
			case AudiogrammetadataPackage.AUDIOGRAM_CLASSIFICATIONS_TYPE__NON_STANDARDIZED:
