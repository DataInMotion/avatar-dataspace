...
import audiogrammetadata.DefinedValueType;
import audiogrammetadata.DefinedValueType1;
import audiogrammetadata.DocumentRoot;
...
import audiogrammetadata.SiteOfLesionType;
...
import audiogrammetadata.util.AudiogrammetadataValidator;
 ...
 * @generated
 */
public class AudiogrammetadataPackageImpl extends EPackageImpl implements AudiogrammetadataPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see audiogrammetadata.AudiogrammetadataPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AudiogrammetadataPackageImpl() {
		super(eNS_URI, AudiogrammetadataFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link AudiogrammetadataPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AudiogrammetadataPackage init() {
		if (isInited) return (AudiogrammetadataPackage)EPackage.Registry.INSTANCE.getEPackage(AudiogrammetadataPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredAudiogrammetadataPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		AudiogrammetadataPackageImpl theAudiogrammetadataPackage = registeredAudiogrammetadataPackage instanceof AudiogrammetadataPackageImpl ? (AudiogrammetadataPackageImpl)registeredAudiogrammetadataPackage : new AudiogrammetadataPackageImpl();
		...
		EValidator.Registry.INSTANCE.put
			(theAudiogrammetadataPackage,
			 new EValidator.Descriptor() {
				 @Override
				 public EValidator getEValidator() {
					 return AudiogrammetadataValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theAudiogrammetadataPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AudiogrammetadataPackage.eNS_URI, theAudiogrammetadataPackage);
		return theAudiogrammetadataPackage;
	}
	 ...
	 */
	@Override
	public AudiogrammetadataFactory getAudiogrammetadataFactory() {
		return (AudiogrammetadataFactory)getEFactoryInstance();
	}
