...
import audiogrammetadata.AudiogramClassificationsType;
 ...
 * </p>
 * <ul>
 *   <li>{@link audiogrammetadata.impl.HIMSAAudiogramMetadataStandardTypeImpl#isAutomatedMeasurement <em>Automated Measurement</em>}</li>
 *   <li>{@link audiogrammetadata.impl.HIMSAAudiogramMetadataStandardTypeImpl#getPredictedAccuracies <em>Predicted Accuracies</em>}</li>
 *   <li>{@link audiogrammetadata.impl.HIMSAAudiogramMetadataStandardTypeImpl#getAudiogramClassifications <em>Audiogram Classifications</em>}</li>
 *   <li>{@link audiogrammetadata.impl.HIMSAAudiogramMetadataStandardTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HIMSAAudiogramMetadataStandardTypeImpl extends MinimalEObjectImpl.Container implements HIMSAAudiogramMetadataStandardType {
	...
	protected EClass eStaticClass() {
		return AudiogrammetadataPackage.Literals.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE;
	}
	...
	public void setAutomatedMeasurement(boolean newAutomatedMeasurement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__AUTOMATED_MEASUREMENT, oldAutomatedMeasurement, automatedMeasurement, !oldAutomatedMeasurementESet));
	}
	...
	public void unsetAutomatedMeasurement() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__AUTOMATED_MEASUREMENT, oldAutomatedMeasurement, AUTOMATED_MEASUREMENT_EDEFAULT, oldAutomatedMeasurementESet));
	}
	...
	public EList<PredictedAccuraciesType> getPredictedAccuracies() {
		if (predictedAccuracies == null) {
			predictedAccuracies = new EObjectContainmentEList<PredictedAccuraciesType>(PredictedAccuraciesType.class, this, AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__PREDICTED_ACCURACIES);
		}
	...
	public EList<AudiogramClassificationsType> getAudiogramClassifications() {
		if (audiogramClassifications == null) {
			audiogramClassifications = new EObjectContainmentEList<AudiogramClassificationsType>(AudiogramClassificationsType.class, this, AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__AUDIOGRAM_CLASSIFICATIONS);
		}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__PREDICTED_ACCURACIES:
				return ((InternalEList<?>)getPredictedAccuracies()).basicRemove(otherEnd, msgs);
			case AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__AUDIOGRAM_CLASSIFICATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__AUTOMATED_MEASUREMENT:
				return isAutomatedMeasurement();
			case AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__PREDICTED_ACCURACIES:
				return getPredictedAccuracies();
			case AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__AUDIOGRAM_CLASSIFICATIONS:
				return getAudiogramClassifications();
			case AudiogrammetadataPackage.HIMSA_AUDIOGRAM_METADATA_STANDARD_TYPE__VERSION:
				return getVersion();
		}
