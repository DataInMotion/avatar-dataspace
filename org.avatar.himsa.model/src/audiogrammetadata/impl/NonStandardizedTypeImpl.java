 ...
 * </p>
 * <ul>
 *   <li>{@link audiogrammetadata.impl.NonStandardizedTypeImpl#getDefinedValue <em>Defined Value</em>}</li>
 *   <li>{@link audiogrammetadata.impl.NonStandardizedTypeImpl#getCustomValue <em>Custom Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NonStandardizedTypeImpl extends MinimalEObjectImpl.Container implements NonStandardizedType {
	...
	protected EClass eStaticClass() {
		return AudiogrammetadataPackage.Literals.NON_STANDARDIZED_TYPE;
	}
	...
	public void setDefinedValue(DefinedValueType newDefinedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.NON_STANDARDIZED_TYPE__DEFINED_VALUE, oldDefinedValue, definedValue, !oldDefinedValueESet));
	}
	...
	public void unsetDefinedValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.NON_STANDARDIZED_TYPE__DEFINED_VALUE, oldDefinedValue, DEFINED_VALUE_EDEFAULT, oldDefinedValueESet));
	}
	...
	public void setCustomValue(String newCustomValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.NON_STANDARDIZED_TYPE__CUSTOM_VALUE, oldCustomValue, customValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AudiogrammetadataPackage.NON_STANDARDIZED_TYPE__DEFINED_VALUE:
				return getDefinedValue();
			case AudiogrammetadataPackage.NON_STANDARDIZED_TYPE__CUSTOM_VALUE:
