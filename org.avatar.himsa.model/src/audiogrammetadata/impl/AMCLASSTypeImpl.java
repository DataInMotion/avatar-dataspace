 ...
 * </p>
 * <ul>
 *   <li>{@link audiogrammetadata.impl.AMCLASSTypeImpl#getSiteOfLesion <em>Site Of Lesion</em>}</li>
 *   <li>{@link audiogrammetadata.impl.AMCLASSTypeImpl#getConfigurationSeverityChoice <em>Configuration Severity Choice</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AMCLASSTypeImpl extends MinimalEObjectImpl.Container implements AMCLASSType {
	...
	protected EClass eStaticClass() {
		return AudiogrammetadataPackage.Literals.AMCLASS_TYPE;
	}
	...
	public void setSiteOfLesion(SiteOfLesionType newSiteOfLesion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.AMCLASS_TYPE__SITE_OF_LESION, oldSiteOfLesion, siteOfLesion, !oldSiteOfLesionESet));
	}
	...
	public void unsetSiteOfLesion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.AMCLASS_TYPE__SITE_OF_LESION, oldSiteOfLesion, SITE_OF_LESION_EDEFAULT, oldSiteOfLesionESet));
	}
	...
	public NotificationChain basicSetConfigurationSeverityChoice(ConfigurationSeverityChoiceType newConfigurationSeverityChoice, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.AMCLASS_TYPE__CONFIGURATION_SEVERITY_CHOICE, oldConfigurationSeverityChoice, newConfigurationSeverityChoice);
	...
	public void setConfigurationSeverityChoice(ConfigurationSeverityChoiceType newConfigurationSeverityChoice) {
		if (newConfigurationSeverityChoice != configurationSeverityChoice) {
			...
			if (configurationSeverityChoice != null)
				msgs = ((InternalEObject)configurationSeverityChoice).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AudiogrammetadataPackage.AMCLASS_TYPE__CONFIGURATION_SEVERITY_CHOICE, null, msgs);
			if (newConfigurationSeverityChoice != null)
				msgs = ((InternalEObject)newConfigurationSeverityChoice).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AudiogrammetadataPackage.AMCLASS_TYPE__CONFIGURATION_SEVERITY_CHOICE, null, msgs);
			msgs = basicSetConfigurationSeverityChoice(newConfigurationSeverityChoice, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.AMCLASS_TYPE__CONFIGURATION_SEVERITY_CHOICE, newConfigurationSeverityChoice, newConfigurationSeverityChoice));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AudiogrammetadataPackage.AMCLASS_TYPE__CONFIGURATION_SEVERITY_CHOICE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AudiogrammetadataPackage.AMCLASS_TYPE__SITE_OF_LESION:
