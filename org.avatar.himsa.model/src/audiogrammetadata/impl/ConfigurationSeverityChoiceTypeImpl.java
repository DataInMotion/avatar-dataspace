...
import audiogrammetadata.ConfigurationSeverityChoiceType;
import audiogrammetadata.FlatHearingLossType;
import audiogrammetadata.OtherType;
import audiogrammetadata.PeakedHearingLossType;
import audiogrammetadata.RisingHearingLossType;
import audiogrammetadata.SlopingHearingLossType;
import audiogrammetadata.TroughShapedHearingLossType;
 ...
 * </p>
 * <ul>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#isNormalHearing <em>Normal Hearing</em>}</li>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#getFlatHearingLoss <em>Flat Hearing Loss</em>}</li>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#getSlopingHearingLoss <em>Sloping Hearing Loss</em>}</li>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#getRisingHearingLoss <em>Rising Hearing Loss</em>}</li>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#getTroughShapedHearingLoss <em>Trough Shaped Hearing Loss</em>}</li>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#getPeakedHearingLoss <em>Peaked Hearing Loss</em>}</li>
 *   <li>{@link audiogrammetadata.impl.ConfigurationSeverityChoiceTypeImpl#getOther <em>Other</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationSeverityChoiceTypeImpl extends MinimalEObjectImpl.Container implements ConfigurationSeverityChoiceType {
	...
	protected EClass eStaticClass() {
		return AudiogrammetadataPackage.Literals.CONFIGURATION_SEVERITY_CHOICE_TYPE;
	}
	...
	public void setNormalHearing(boolean newNormalHearing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__NORMAL_HEARING, oldNormalHearing, normalHearing, !oldNormalHearingESet));
	}
	...
	public void unsetNormalHearing() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__NORMAL_HEARING, oldNormalHearing, NORMAL_HEARING_EDEFAULT, oldNormalHearingESet));
	}
	...
	public void setFlatHearingLoss(FlatHearingLossType newFlatHearingLoss) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__FLAT_HEARING_LOSS, oldFlatHearingLoss, flatHearingLoss, !oldFlatHearingLossESet));
	}
	...
	public void unsetFlatHearingLoss() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__FLAT_HEARING_LOSS, oldFlatHearingLoss, FLAT_HEARING_LOSS_EDEFAULT, oldFlatHearingLossESet));
	}
	...
	public void setSlopingHearingLoss(SlopingHearingLossType newSlopingHearingLoss) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__SLOPING_HEARING_LOSS, oldSlopingHearingLoss, slopingHearingLoss, !oldSlopingHearingLossESet));
	}
	...
	public void unsetSlopingHearingLoss() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__SLOPING_HEARING_LOSS, oldSlopingHearingLoss, SLOPING_HEARING_LOSS_EDEFAULT, oldSlopingHearingLossESet));
	}
	...
	public void setRisingHearingLoss(RisingHearingLossType newRisingHearingLoss) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__RISING_HEARING_LOSS, oldRisingHearingLoss, risingHearingLoss, !oldRisingHearingLossESet));
	}
	...
	public void unsetRisingHearingLoss() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__RISING_HEARING_LOSS, oldRisingHearingLoss, RISING_HEARING_LOSS_EDEFAULT, oldRisingHearingLossESet));
	}
	...
	public void setTroughShapedHearingLoss(TroughShapedHearingLossType newTroughShapedHearingLoss) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__TROUGH_SHAPED_HEARING_LOSS, oldTroughShapedHearingLoss, troughShapedHearingLoss, !oldTroughShapedHearingLossESet));
	}
	...
	public void unsetTroughShapedHearingLoss() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__TROUGH_SHAPED_HEARING_LOSS, oldTroughShapedHearingLoss, TROUGH_SHAPED_HEARING_LOSS_EDEFAULT, oldTroughShapedHearingLossESet));
	}
	...
	public void setPeakedHearingLoss(PeakedHearingLossType newPeakedHearingLoss) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__PEAKED_HEARING_LOSS, oldPeakedHearingLoss, peakedHearingLoss, !oldPeakedHearingLossESet));
	}
	...
	public void unsetPeakedHearingLoss() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__PEAKED_HEARING_LOSS, oldPeakedHearingLoss, PEAKED_HEARING_LOSS_EDEFAULT, oldPeakedHearingLossESet));
	}
	...
	public void setOther(OtherType newOther) {
		...
		otherESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__OTHER, oldOther, other, !oldOtherESet));
	}
	...
	public void unsetOther() {
		...
		otherESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__OTHER, oldOther, OTHER_EDEFAULT, oldOtherESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__NORMAL_HEARING:
				return isNormalHearing();
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__FLAT_HEARING_LOSS:
				return getFlatHearingLoss();
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__SLOPING_HEARING_LOSS:
				return getSlopingHearingLoss();
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__RISING_HEARING_LOSS:
				return getRisingHearingLoss();
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__TROUGH_SHAPED_HEARING_LOSS:
				return getTroughShapedHearingLoss();
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__PEAKED_HEARING_LOSS:
				return getPeakedHearingLoss();
			case AudiogrammetadataPackage.CONFIGURATION_SEVERITY_CHOICE_TYPE__OTHER:
				return getOther();
		}
