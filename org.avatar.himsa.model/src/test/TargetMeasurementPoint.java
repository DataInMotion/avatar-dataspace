 ...
 * </p>
 * <ul>
 *   <li>{@link test.TargetMeasurementPoint#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getTargetMeasurementPoint()
...
public interface TargetMeasurementPoint extends EObject {
	 ...
	 * @see test.TestPackage#getTargetMeasurementPoint_Output()
	 * @model unique="false" dataType="test.OutputType2" required="true" upper="256"
