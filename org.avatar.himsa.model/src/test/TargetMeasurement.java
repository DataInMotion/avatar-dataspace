 ...
 * </p>
 * <ul>
 *   <li>{@link test.TargetMeasurement#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link test.TargetMeasurement#getLevelStep <em>Level Step</em>}</li>
 *   <li>{@link test.TargetMeasurement#getAttackCurve <em>Attack Curve</em>}</li>
 *   <li>{@link test.TargetMeasurement#getReleaseCurve <em>Release Curve</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getTargetMeasurement()
...
public interface TargetMeasurement extends EObject {
	 ...
	 * @see test.TestPackage#getTargetMeasurement_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link test.TargetMeasurement#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getTargetMeasurement_LevelStep()
	 * @model dataType="test.LevelStepType" required="true"
	...
	/**
	 * Sets the value of the '{@link test.TargetMeasurement#getLevelStep <em>Level Step</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getTargetMeasurement_AttackCurve()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link test.TargetMeasurement#getAttackCurve <em>Attack Curve</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getTargetMeasurement_ReleaseCurve()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link test.TargetMeasurement#getReleaseCurve <em>Release Curve</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
