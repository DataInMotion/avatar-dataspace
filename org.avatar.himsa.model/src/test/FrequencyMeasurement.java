 ...
 * </p>
 * <ul>
 *   <li>{@link test.FrequencyMeasurement#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link test.FrequencyMeasurement#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getFrequencyMeasurement()
...
public interface FrequencyMeasurement extends EObject {
	 ...
	 * @see test.TestPackage#getFrequencyMeasurement_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link test.FrequencyMeasurement#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getFrequencyMeasurement_Point()
