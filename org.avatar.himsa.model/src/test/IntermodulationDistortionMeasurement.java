 ...
 * </p>
 * <ul>
 *   <li>{@link test.IntermodulationDistortionMeasurement#getMeasurementCondition <em>Measurement Condition</em>}</li>
 *   <li>{@link test.IntermodulationDistortionMeasurement#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getIntermodulationDistortionMeasurement()
...
public interface IntermodulationDistortionMeasurement extends EObject {
	 ...
	 * @see test.TestPackage#getIntermodulationDistortionMeasurement_MeasurementCondition()
	...
	/**
	 * Sets the value of the '{@link test.IntermodulationDistortionMeasurement#getMeasurementCondition <em>Measurement Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link test.IntermodulationDistortionPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Point</em>' containment reference list.
	 * @see test.TestPackage#getIntermodulationDistortionMeasurement_Point()
