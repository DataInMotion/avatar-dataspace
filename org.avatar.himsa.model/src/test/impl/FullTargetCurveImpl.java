 ...
 * </p>
 * <ul>
 *   <li>{@link test.impl.FullTargetCurveImpl#getManufacturersCode <em>Manufacturers Code</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getDeviceTypeCode <em>Device Type Code</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getFittingRule <em>Fitting Rule</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getHearingInstrumentType <em>Hearing Instrument Type</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getVentCanalDiameter <em>Vent Canal Diameter</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getVentCanalLength <em>Vent Canal Length</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getReserveGain <em>Reserve Gain</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getCouplerType <em>Coupler Type</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link test.impl.FullTargetCurveImpl#getRuleName <em>Rule Name</em>}</li>
 * </ul>
 *
 * @generated
 */
