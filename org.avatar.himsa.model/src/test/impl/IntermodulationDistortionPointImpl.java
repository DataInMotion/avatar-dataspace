 ...
 * </p>
 * <ul>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getFreq1 <em>Freq1</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getFreq2 <em>Freq2</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getInput1 <em>Input1</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getInput2 <em>Input2</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getOutput1 <em>Output1</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getOutput2 <em>Output2</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getOutputDiff1 <em>Output Diff1</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getOutputDiff2 <em>Output Diff2</em>}</li>
 *   <li>{@link test.impl.IntermodulationDistortionPointImpl#getTIDistortion <em>TI Distortion</em>}</li>
 * </ul>
 *
 * @generated
 */
