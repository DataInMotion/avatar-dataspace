 ...
 * </p>
 * <ul>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getManufacturerCode <em>Manufacturer Code</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getDevTypeCode <em>Dev Type Code</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getSignalType <em>Signal Type</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getSignalOutput <em>Signal Output</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getSignalFrequency <em>Signal Frequency</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getBatteryType <em>Battery Type</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getBatteryPillType <em>Battery Pill Type</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getBatteryVoltage <em>Battery Voltage</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getBatteryImpedance <em>Battery Impedance</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#isUseRealEarCoupler <em>Use Real Ear Coupler</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getMeasurementMode <em>Measurement Mode</em>}</li>
 *   <li>{@link test.impl.BatteryMeasurementConditionsImpl#getMeasurementIdentification <em>Measurement Identification</em>}</li>
 * </ul>
 *
 * @generated
 */
