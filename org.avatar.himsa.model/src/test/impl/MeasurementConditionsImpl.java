 ...
 * </p>
 * <ul>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getManufacturerCode <em>Manufacturer Code</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getDevTypeCode <em>Dev Type Code</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getSignalType <em>Signal Type</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getSignalOutput <em>Signal Output</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getSignalFrequency <em>Signal Frequency</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getBatteryType <em>Battery Type</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getBatteryPillType <em>Battery Pill Type</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getBatteryVoltage <em>Battery Voltage</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getBatteryImpedance <em>Battery Impedance</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#isUseRealEarCoupler <em>Use Real Ear Coupler</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getMeasurementMode <em>Measurement Mode</em>}</li>
 *   <li>{@link test.impl.MeasurementConditionsImpl#getMeasurementIdentification <em>Measurement Identification</em>}</li>
 * </ul>
 *
 * @generated
 */
