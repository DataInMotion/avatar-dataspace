 ...
 * </p>
 * <ul>
 *   <li>{@link test.OcclusionEffects#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link test.OcclusionEffects#getREUR <em>REUR</em>}</li>
 *   <li>{@link test.OcclusionEffects#getREOR <em>REOR</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getOcclusionEffects()
...
public interface OcclusionEffects extends EObject {
	 ...
	 * @see test.TestPackage#getOcclusionEffects_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link test.OcclusionEffects#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getOcclusionEffects_REUR()
	 ...
	 * @see test.TestPackage#getOcclusionEffects_REOR()
	 * @model containment="true" required="true" upper="169"
