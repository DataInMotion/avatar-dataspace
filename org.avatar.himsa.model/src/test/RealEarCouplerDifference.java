 ...
 * </p>
 * <ul>
 *   <li>{@link test.RealEarCouplerDifference#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link test.RealEarCouplerDifference#getRECD <em>RECD</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getRealEarCouplerDifference()
...
public interface RealEarCouplerDifference extends EObject {
	 ...
	 * @see test.TestPackage#getRealEarCouplerDifference_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link test.RealEarCouplerDifference#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getRealEarCouplerDifference_RECD()
