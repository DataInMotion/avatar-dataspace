 ...
 * </p>
 * <ul>
 *   <li>{@link test.BatteryCurrentMeasurement#getBatteryConditions <em>Battery Conditions</em>}</li>
 *   <li>{@link test.BatteryCurrentMeasurement#getBatteryCurve <em>Battery Curve</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getBatteryCurrentMeasurement()
...
public interface BatteryCurrentMeasurement extends EObject {
	 ...
	 * @see test.TestPackage#getBatteryCurrentMeasurement_BatteryConditions()
	...
	/**
	 * Sets the value of the '{@link test.BatteryCurrentMeasurement#getBatteryConditions <em>Battery Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link test.BatteryMeasurementPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * 
	 ...
	 * @see test.TestPackage#getBatteryCurrentMeasurement_BatteryCurve()
