 ...
 * </p>
 * <ul>
 *   <li>{@link test.AttackReleaseMeasurementPoint#getOutput <em>Output</em>}</li>
 *   <li>{@link test.AttackReleaseMeasurementPoint#getAttackReleaseTime <em>Attack Release Time</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getAttackReleaseMeasurementPoint()
...
public interface AttackReleaseMeasurementPoint extends EObject {
	 ...
	 * @see test.TestPackage#getAttackReleaseMeasurementPoint_Output()
	 * @model dataType="test.OutputType1" required="true"
	...
	/**
	 * Sets the value of the '{@link test.AttackReleaseMeasurementPoint#getOutput <em>Output</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getAttackReleaseMeasurementPoint_AttackReleaseTime()
	 * @model dataType="test.AttackReleaseTimeType" required="true"
	...
	/**
	 * Sets the value of the '{@link test.AttackReleaseMeasurementPoint#getAttackReleaseTime <em>Attack Release Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
