 ...
 * </p>
 * <ul>
 *   <li>{@link test.HarmonicDistortionPoint#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link test.HarmonicDistortionPoint#getInput <em>Input</em>}</li>
 *   <li>{@link test.HarmonicDistortionPoint#getFx1 <em>Fx1</em>}</li>
 *   <li>{@link test.HarmonicDistortionPoint#getFx2 <em>Fx2</em>}</li>
 *   <li>{@link test.HarmonicDistortionPoint#getFx3 <em>Fx3</em>}</li>
 *   <li>{@link test.HarmonicDistortionPoint#getThirdHD <em>Third HD</em>}</li>
 * </ul>
 *
 * @see test.TestPackage#getHarmonicDistortionPoint()
...
public interface HarmonicDistortionPoint extends EObject {
	 ...
	 * @see test.TestPackage#getHarmonicDistortionPoint_Frequency()
	...
	/**
	 * Sets the value of the '{@link test.HarmonicDistortionPoint#getFrequency <em>Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getHarmonicDistortionPoint_Input()
	 * @model dataType="test.InputType1" required="true"
	...
	/**
	 * Sets the value of the '{@link test.HarmonicDistortionPoint#getInput <em>Input</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getHarmonicDistortionPoint_Fx1()
	 * @model dataType="test.Fx1Type" required="true"
	...
	/**
	 * Sets the value of the '{@link test.HarmonicDistortionPoint#getFx1 <em>Fx1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getHarmonicDistortionPoint_Fx2()
	 * @model dataType="test.Fx2Type" required="true"
	...
	/**
	 * Sets the value of the '{@link test.HarmonicDistortionPoint#getFx2 <em>Fx2</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getHarmonicDistortionPoint_Fx3()
	 * @model dataType="test.Fx3Type" required="true"
	...
	/**
	 * Sets the value of the '{@link test.HarmonicDistortionPoint#getFx3 <em>Fx3</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see test.TestPackage#getHarmonicDistortionPoint_ThirdHD()
	 * @model dataType="test.ThirdHDType" required="true"
	...
	/**
	 * Sets the value of the '{@link test.HarmonicDistortionPoint#getThirdHD <em>Third HD</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
