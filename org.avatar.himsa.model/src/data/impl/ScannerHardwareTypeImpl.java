 ...
 * </p>
 * <ul>
 *   <li>{@link data.impl.ScannerHardwareTypeImpl#getScannerProvider <em>Scanner Provider</em>}</li>
 *   <li>{@link data.impl.ScannerHardwareTypeImpl#getScannerModel <em>Scanner Model</em>}</li>
 *   <li>{@link data.impl.ScannerHardwareTypeImpl#getScannerFirmware <em>Scanner Firmware</em>}</li>
 *   <li>{@link data.impl.ScannerHardwareTypeImpl#getScannerType <em>Scanner Type</em>}</li>
 *   <li>{@link data.impl.ScannerHardwareTypeImpl#getUniqueScannerID <em>Unique Scanner ID</em>}</li>
 * </ul>
 *
 * @generated
 */
