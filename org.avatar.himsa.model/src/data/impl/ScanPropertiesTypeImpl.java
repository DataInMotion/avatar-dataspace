 ...
 * </p>
 * <ul>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getScanTimeStamp <em>Scan Time Stamp</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getEar <em>Ear</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getJawPosition <em>Jaw Position</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getScanFormat <em>Scan Format</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getScanComment <em>Scan Comment</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getScanFileAndLocation <em>Scan File And Location</em>}</li>
 *   <li>{@link data.impl.ScanPropertiesTypeImpl#getScanStoredInNoah <em>Scan Stored In Noah</em>}</li>
 * </ul>
 *
 * @generated
 */
