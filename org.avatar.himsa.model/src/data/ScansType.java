 ...
 * </p>
 * <ul>
 *   <li>{@link data.ScansType#getScannerHardware <em>Scanner Hardware</em>}</li>
 *   <li>{@link data.ScansType#getScanProperties <em>Scan Properties</em>}</li>
 *   <li>{@link data.ScansType#getScanAnnotations <em>Scan Annotations</em>}</li>
 * </ul>
 *
 * @see data.DataPackage#getScansType()
...
public interface ScansType extends EObject {
	 ...
	 * @see data.DataPackage#getScansType_ScannerHardware()
	...
	/**
	 * Sets the value of the '{@link data.ScansType#getScannerHardware <em>Scanner Hardware</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see data.DataPackage#getScansType_ScanProperties()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link data.ScansType#getScanProperties <em>Scan Properties</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see data.DataPackage#getScansType_ScanAnnotations()
	...
	/**
	 * Sets the value of the '{@link data.ScansType#getScanAnnotations <em>Scan Annotations</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
