 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.MeasuredType1#getMeasuredAdmittancePoints <em>Measured Admittance Points</em>}</li>
 *   <li>{@link admittance.MeasuredType1#getMeasuredAdmittanceUnit <em>Measured Admittance Unit</em>}</li>
 * </ul>
 *
 * @see admittance.AdmittancePackage#getMeasuredType1()
...
public interface MeasuredType1 extends EObject {
	 ...
	 * @see admittance.AdmittancePackage#getMeasuredType1_MeasuredAdmittancePoints()
	...
	/**
	 * Sets the value of the '{@link admittance.MeasuredType1#getMeasuredAdmittancePoints <em>Measured Admittance Points</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see admittance.AdmittancePackage#getMeasuredType1_MeasuredAdmittanceUnit()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link admittance.MeasuredType1#getMeasuredAdmittanceUnit <em>Measured Admittance Unit</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
