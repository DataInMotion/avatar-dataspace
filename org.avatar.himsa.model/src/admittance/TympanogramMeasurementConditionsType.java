 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.TympanogramMeasurementConditionsType#getSweepSpeed <em>Sweep Speed</em>}</li>
 *   <li>{@link admittance.TympanogramMeasurementConditionsType#getRecordMode <em>Record Mode</em>}</li>
 *   <li>{@link admittance.TympanogramMeasurementConditionsType#getProbeFrequency <em>Probe Frequency</em>}</li>
 * </ul>
 *
 * @see admittance.AdmittancePackage#getTympanogramMeasurementConditionsType()
...
public interface TympanogramMeasurementConditionsType extends EObject {
	 ...
	 * @see admittance.AdmittancePackage#getTympanogramMeasurementConditionsType_SweepSpeed()
	...
	/**
	 * Sets the value of the '{@link admittance.TympanogramMeasurementConditionsType#getSweepSpeed <em>Sweep Speed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link admittance.RecordingModeType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see admittance.AdmittancePackage#getTympanogramMeasurementConditionsType_RecordMode()
	...
	/**
	 * Sets the value of the '{@link admittance.TympanogramMeasurementConditionsType#getRecordMode <em>Record Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link admittance.TympanogramMeasurementConditionsType#getRecordMode <em>Record Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetRecordMode()
	 * @see #getRecordMode()
	...
	/**
	 * Returns whether the value of the '{@link admittance.TympanogramMeasurementConditionsType#getRecordMode <em>Record Mode</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see admittance.AdmittancePackage#getTympanogramMeasurementConditionsType_ProbeFrequency()
	...
	/**
	 * Sets the value of the '{@link admittance.TympanogramMeasurementConditionsType#getProbeFrequency <em>Probe Frequency</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
