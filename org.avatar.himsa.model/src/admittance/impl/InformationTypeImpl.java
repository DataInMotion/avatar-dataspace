 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.InformationTypeImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link admittance.impl.InformationTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InformationTypeImpl extends MinimalEObjectImpl.Container implements InformationType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.INFORMATION_TYPE;
	}
	...
	public void setComments(Object newComments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.INFORMATION_TYPE__COMMENTS, oldComments, comments));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.INFORMATION_TYPE__VERSION, oldVersion, version));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmittancePackage.INFORMATION_TYPE__COMMENTS:
				return getComments();
			case AdmittancePackage.INFORMATION_TYPE__VERSION:
				return getVersion();
		}
