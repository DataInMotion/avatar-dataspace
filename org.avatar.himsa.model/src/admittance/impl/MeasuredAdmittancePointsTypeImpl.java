 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.MeasuredAdmittancePointsTypeImpl#getPt <em>Pt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasuredAdmittancePointsTypeImpl extends MinimalEObjectImpl.Container implements MeasuredAdmittancePointsType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.MEASURED_ADMITTANCE_POINTS_TYPE;
	}
	...
	public EList<AdmittanceValuePointMeasuredType> getPt() {
		if (pt == null) {
			pt = new EObjectContainmentEList<AdmittanceValuePointMeasuredType>(AdmittanceValuePointMeasuredType.class, this, AdmittancePackage.MEASURED_ADMITTANCE_POINTS_TYPE__PT);
		}
		return pt;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.MEASURED_ADMITTANCE_POINTS_TYPE__PT:
