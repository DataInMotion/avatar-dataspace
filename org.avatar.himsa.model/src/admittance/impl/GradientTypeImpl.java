 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.GradientTypeImpl#getGradientValue <em>Gradient Value</em>}</li>
 *   <li>{@link admittance.impl.GradientTypeImpl#getGradientUnit <em>Gradient Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GradientTypeImpl extends MinimalEObjectImpl.Container implements GradientType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.GRADIENT_TYPE;
	}
	...
	public NotificationChain basicSetGradientValue(AdmittanceValueType newGradientValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.GRADIENT_TYPE__GRADIENT_VALUE, oldGradientValue, newGradientValue);
	...
	public void setGradientValue(AdmittanceValueType newGradientValue) {
		if (newGradientValue != gradientValue) {
			...
			if (gradientValue != null)
				msgs = ((InternalEObject)gradientValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.GRADIENT_TYPE__GRADIENT_VALUE, null, msgs);
			if (newGradientValue != null)
				msgs = ((InternalEObject)newGradientValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.GRADIENT_TYPE__GRADIENT_VALUE, null, msgs);
			msgs = basicSetGradientValue(newGradientValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.GRADIENT_TYPE__GRADIENT_VALUE, newGradientValue, newGradientValue));
	}
	...
	public NotificationChain basicSetGradientUnit(AdmittanceUnitType newGradientUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.GRADIENT_TYPE__GRADIENT_UNIT, oldGradientUnit, newGradientUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGradientUnit(AdmittanceUnitType newGradientUnit) {
		if (newGradientUnit != gradientUnit) {
			...
			if (gradientUnit != null)
				msgs = ((InternalEObject)gradientUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.GRADIENT_TYPE__GRADIENT_UNIT, null, msgs);
			if (newGradientUnit != null)
				msgs = ((InternalEObject)newGradientUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.GRADIENT_TYPE__GRADIENT_UNIT, null, msgs);
			msgs = basicSetGradientUnit(newGradientUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.GRADIENT_TYPE__GRADIENT_UNIT, newGradientUnit, newGradientUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.GRADIENT_TYPE__GRADIENT_VALUE:
				return basicSetGradientValue(null, msgs);
			case AdmittancePackage.GRADIENT_TYPE__GRADIENT_UNIT:
