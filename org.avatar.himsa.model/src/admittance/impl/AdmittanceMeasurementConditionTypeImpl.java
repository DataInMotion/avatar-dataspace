 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getSignalType <em>Signal Type</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getSignalOutput <em>Signal Output</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getPressure <em>Pressure</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getProbeFrequency <em>Probe Frequency</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getTestType <em>Test Type</em>}</li>
 *   <li>{@link admittance.impl.AdmittanceMeasurementConditionTypeImpl#getCanalVolume <em>Canal Volume</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdmittanceMeasurementConditionTypeImpl extends MinimalEObjectImpl.Container implements AdmittanceMeasurementConditionType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.ADMITTANCE_MEASUREMENT_CONDITION_TYPE;
	}
	...
	public NotificationChain basicSetSignalLevel(SignalLevelType newSignalLevel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_LEVEL, oldSignalLevel, newSignalLevel);
	...
	public void setSignalLevel(SignalLevelType newSignalLevel) {
		if (newSignalLevel != signalLevel) {
			...
			if (signalLevel != null)
				msgs = ((InternalEObject)signalLevel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_LEVEL, null, msgs);
			if (newSignalLevel != null)
				msgs = ((InternalEObject)newSignalLevel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_LEVEL, null, msgs);
			msgs = basicSetSignalLevel(newSignalLevel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_LEVEL, newSignalLevel, newSignalLevel));
	}
	...
	public void setSignalType(SignalTypeType newSignalType) {
		...
		signalTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_TYPE, oldSignalType, signalType, !oldSignalTypeESet));
	}
	...
	public void unsetSignalType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_TYPE, oldSignalType, SIGNAL_TYPE_EDEFAULT, oldSignalTypeESet));
	}
	...
	public void setSignalOutput(SignalOutputType newSignalOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_OUTPUT, oldSignalOutput, signalOutput, !oldSignalOutputESet));
	}
	...
	public void unsetSignalOutput() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_OUTPUT, oldSignalOutput, SIGNAL_OUTPUT_EDEFAULT, oldSignalOutputESet));
	}
	...
	public void setFrequency(BigInteger newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__FREQUENCY, oldFrequency, frequency));
	}
	...
	public void setPressure(BigInteger newPressure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__PRESSURE, oldPressure, pressure));
	}
	...
	public void setProbeFrequency(BigInteger newProbeFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__PROBE_FREQUENCY, oldProbeFrequency, probeFrequency));
	}
	...
	public void setTestType(ReflexTestTypeType newTestType) {
		...
		testTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__TEST_TYPE, oldTestType, testType, !oldTestTypeESet));
	}
	...
	public void unsetTestType() {
		...
		testTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__TEST_TYPE, oldTestType, TEST_TYPE_EDEFAULT, oldTestTypeESet));
	}
	...
	public NotificationChain basicSetCanalVolume(AdmittanceType newCanalVolume, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__CANAL_VOLUME, oldCanalVolume, newCanalVolume);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCanalVolume(AdmittanceType newCanalVolume) {
		if (newCanalVolume != canalVolume) {
			NotificationChain msgs = null;
			if (canalVolume != null)
				msgs = ((InternalEObject)canalVolume).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__CANAL_VOLUME, null, msgs);
			if (newCanalVolume != null)
				msgs = ((InternalEObject)newCanalVolume).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__CANAL_VOLUME, null, msgs);
			msgs = basicSetCanalVolume(newCanalVolume, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__CANAL_VOLUME, newCanalVolume, newCanalVolume));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_LEVEL:
				return basicSetSignalLevel(null, msgs);
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__CANAL_VOLUME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_TYPE:
				return getSignalType();
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__SIGNAL_OUTPUT:
				return getSignalOutput();
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__FREQUENCY:
				return getFrequency();
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__PRESSURE:
				return getPressure();
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__PROBE_FREQUENCY:
				return getProbeFrequency();
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__TEST_TYPE:
				return getTestType();
			case AdmittancePackage.ADMITTANCE_MEASUREMENT_CONDITION_TYPE__CANAL_VOLUME:
