 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.PressurePointTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link admittance.impl.PressurePointTypeImpl#getPressure <em>Pressure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PressurePointTypeImpl extends MinimalEObjectImpl.Container implements PressurePointType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.PRESSURE_POINT_TYPE;
	}
	...
	public void setTime(BigDecimal newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.PRESSURE_POINT_TYPE__TIME, oldTime, time));
	}
	...
	public void setPressure(BigInteger newPressure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.PRESSURE_POINT_TYPE__PRESSURE, oldPressure, pressure));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmittancePackage.PRESSURE_POINT_TYPE__TIME:
				return getTime();
			case AdmittancePackage.PRESSURE_POINT_TYPE__PRESSURE:
				return getPressure();
		}
