 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.ReflexValuePointMeasuredTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link admittance.impl.ReflexValuePointMeasuredTypeImpl#getDeltaG <em>Delta G</em>}</li>
 *   <li>{@link admittance.impl.ReflexValuePointMeasuredTypeImpl#getDeltaB <em>Delta B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReflexValuePointMeasuredTypeImpl extends MinimalEObjectImpl.Container implements ReflexValuePointMeasuredType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.REFLEX_VALUE_POINT_MEASURED_TYPE;
	}
	...
	public void setTime(BigDecimal newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_VALUE_POINT_MEASURED_TYPE__TIME, oldTime, time));
	}
	...
	public void setDeltaG(BigDecimal newDeltaG) {
		...
		deltaG = newDeltaG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_VALUE_POINT_MEASURED_TYPE__DELTA_G, oldDeltaG, deltaG));
	}
	...
	public void setDeltaB(BigDecimal newDeltaB) {
		...
		deltaB = newDeltaB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_VALUE_POINT_MEASURED_TYPE__DELTA_B, oldDeltaB, deltaB));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmittancePackage.REFLEX_VALUE_POINT_MEASURED_TYPE__TIME:
				return getTime();
			case AdmittancePackage.REFLEX_VALUE_POINT_MEASURED_TYPE__DELTA_G:
				return getDeltaG();
			case AdmittancePackage.REFLEX_VALUE_POINT_MEASURED_TYPE__DELTA_B:
				return getDeltaB();
		}
