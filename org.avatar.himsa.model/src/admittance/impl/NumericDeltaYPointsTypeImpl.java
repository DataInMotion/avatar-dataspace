 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.NumericDeltaYPointsTypeImpl#getPt <em>Pt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumericDeltaYPointsTypeImpl extends MinimalEObjectImpl.Container implements NumericDeltaYPointsType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.NUMERIC_DELTA_YPOINTS_TYPE;
	}
	...
	public EList<ReflexValuePointCalculatedType> getPt() {
		if (pt == null) {
			pt = new EObjectContainmentEList<ReflexValuePointCalculatedType>(ReflexValuePointCalculatedType.class, this, AdmittancePackage.NUMERIC_DELTA_YPOINTS_TYPE__PT);
		}
		return pt;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.NUMERIC_DELTA_YPOINTS_TYPE__PT:
