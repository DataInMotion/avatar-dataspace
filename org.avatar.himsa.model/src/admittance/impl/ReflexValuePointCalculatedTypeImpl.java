 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.ReflexValuePointCalculatedTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link admittance.impl.ReflexValuePointCalculatedTypeImpl#getNumericDeltaY <em>Numeric Delta Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReflexValuePointCalculatedTypeImpl extends MinimalEObjectImpl.Container implements ReflexValuePointCalculatedType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.REFLEX_VALUE_POINT_CALCULATED_TYPE;
	}
	...
	public void setTime(BigDecimal newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_VALUE_POINT_CALCULATED_TYPE__TIME, oldTime, time));
	}
	...
	public void setNumericDeltaY(BigDecimal newNumericDeltaY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_VALUE_POINT_CALCULATED_TYPE__NUMERIC_DELTA_Y, oldNumericDeltaY, numericDeltaY));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmittancePackage.REFLEX_VALUE_POINT_CALCULATED_TYPE__TIME:
				return getTime();
			case AdmittancePackage.REFLEX_VALUE_POINT_CALCULATED_TYPE__NUMERIC_DELTA_Y:
