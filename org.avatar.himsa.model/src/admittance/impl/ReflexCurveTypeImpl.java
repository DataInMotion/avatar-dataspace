 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.ReflexCurveTypeImpl#getNumericDelta <em>Numeric Delta</em>}</li>
 *   <li>{@link admittance.impl.ReflexCurveTypeImpl#getDeltaY <em>Delta Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReflexCurveTypeImpl extends MinimalEObjectImpl.Container implements ReflexCurveType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.REFLEX_CURVE_TYPE;
	}
	...
	public NotificationChain basicSetNumericDelta(NumericDeltaType newNumericDelta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_CURVE_TYPE__NUMERIC_DELTA, oldNumericDelta, newNumericDelta);
	...
	public void setNumericDelta(NumericDeltaType newNumericDelta) {
		if (newNumericDelta != numericDelta) {
			...
			if (numericDelta != null)
				msgs = ((InternalEObject)numericDelta).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.REFLEX_CURVE_TYPE__NUMERIC_DELTA, null, msgs);
			if (newNumericDelta != null)
				msgs = ((InternalEObject)newNumericDelta).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.REFLEX_CURVE_TYPE__NUMERIC_DELTA, null, msgs);
			msgs = basicSetNumericDelta(newNumericDelta, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_CURVE_TYPE__NUMERIC_DELTA, newNumericDelta, newNumericDelta));
	}
	...
	public NotificationChain basicSetDeltaY(DeltaYType newDeltaY, NotificationChain msgs) {
		...
		deltaY = newDeltaY;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_CURVE_TYPE__DELTA_Y, oldDeltaY, newDeltaY);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeltaY(DeltaYType newDeltaY) {
		if (newDeltaY != deltaY) {
			NotificationChain msgs = null;
			if (deltaY != null)
				msgs = ((InternalEObject)deltaY).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.REFLEX_CURVE_TYPE__DELTA_Y, null, msgs);
			if (newDeltaY != null)
				msgs = ((InternalEObject)newDeltaY).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.REFLEX_CURVE_TYPE__DELTA_Y, null, msgs);
			msgs = basicSetDeltaY(newDeltaY, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.REFLEX_CURVE_TYPE__DELTA_Y, newDeltaY, newDeltaY));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.REFLEX_CURVE_TYPE__NUMERIC_DELTA:
				return basicSetNumericDelta(null, msgs);
			case AdmittancePackage.REFLEX_CURVE_TYPE__DELTA_Y:
