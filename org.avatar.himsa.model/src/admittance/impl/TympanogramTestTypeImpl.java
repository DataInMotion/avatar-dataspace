 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getAdmittanceCurve <em>Admittance Curve</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getMaximumAdmittance <em>Maximum Admittance</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getCanalVolume <em>Canal Volume</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getGradient <em>Gradient</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getPressure <em>Pressure</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getResonanceFrequency <em>Resonance Frequency</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getResult <em>Result</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getMeasurementCondition <em>Measurement Condition</em>}</li>
 *   <li>{@link admittance.impl.TympanogramTestTypeImpl#getStaticAdmittance <em>Static Admittance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TympanogramTestTypeImpl extends MinimalEObjectImpl.Container implements TympanogramTestType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.TYMPANOGRAM_TEST_TYPE;
	}
	...
	public NotificationChain basicSetAdmittanceCurve(AdmittanceCurveType newAdmittanceCurve, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__ADMITTANCE_CURVE, oldAdmittanceCurve, newAdmittanceCurve);
	...
	public void setAdmittanceCurve(AdmittanceCurveType newAdmittanceCurve) {
		if (newAdmittanceCurve != admittanceCurve) {
			...
			if (admittanceCurve != null)
				msgs = ((InternalEObject)admittanceCurve).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__ADMITTANCE_CURVE, null, msgs);
			if (newAdmittanceCurve != null)
				msgs = ((InternalEObject)newAdmittanceCurve).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__ADMITTANCE_CURVE, null, msgs);
			msgs = basicSetAdmittanceCurve(newAdmittanceCurve, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__ADMITTANCE_CURVE, newAdmittanceCurve, newAdmittanceCurve));
	}
	...
	public NotificationChain basicSetMaximumAdmittance(AdmittanceType newMaximumAdmittance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MAXIMUM_ADMITTANCE, oldMaximumAdmittance, newMaximumAdmittance);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMaximumAdmittance(AdmittanceType newMaximumAdmittance) {
		if (newMaximumAdmittance != maximumAdmittance) {
			...
			if (maximumAdmittance != null)
				msgs = ((InternalEObject)maximumAdmittance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MAXIMUM_ADMITTANCE, null, msgs);
			if (newMaximumAdmittance != null)
				msgs = ((InternalEObject)newMaximumAdmittance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MAXIMUM_ADMITTANCE, null, msgs);
			msgs = basicSetMaximumAdmittance(newMaximumAdmittance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MAXIMUM_ADMITTANCE, newMaximumAdmittance, newMaximumAdmittance));
	}
	...
	public NotificationChain basicSetCanalVolume(AdmittanceType newCanalVolume, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__CANAL_VOLUME, oldCanalVolume, newCanalVolume);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCanalVolume(AdmittanceType newCanalVolume) {
		if (newCanalVolume != canalVolume) {
			NotificationChain msgs = null;
			if (canalVolume != null)
				msgs = ((InternalEObject)canalVolume).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__CANAL_VOLUME, null, msgs);
			if (newCanalVolume != null)
				msgs = ((InternalEObject)newCanalVolume).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__CANAL_VOLUME, null, msgs);
			msgs = basicSetCanalVolume(newCanalVolume, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__CANAL_VOLUME, newCanalVolume, newCanalVolume));
	}
	...
	public NotificationChain basicSetGradient(GradientType newGradient, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__GRADIENT, oldGradient, newGradient);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGradient(GradientType newGradient) {
		if (newGradient != gradient) {
			NotificationChain msgs = null;
			if (gradient != null)
				msgs = ((InternalEObject)gradient).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__GRADIENT, null, msgs);
			if (newGradient != null)
				msgs = ((InternalEObject)newGradient).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__GRADIENT, null, msgs);
			msgs = basicSetGradient(newGradient, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__GRADIENT, newGradient, newGradient));
	}
	...
	public void setPressure(BigInteger newPressure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__PRESSURE, oldPressure, pressure));
	}
	...
	public void setResonanceFrequency(BigInteger newResonanceFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__RESONANCE_FREQUENCY, oldResonanceFrequency, resonanceFrequency));
	}
	...
	public void setResult(TympanogramResultType newResult) {
		...
		resultESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__RESULT, oldResult, result, !oldResultESet));
	}
	...
	public void unsetResult() {
		...
		resultESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__RESULT, oldResult, RESULT_EDEFAULT, oldResultESet));
	}
	...
	public NotificationChain basicSetMeasurementCondition(TympanogramMeasurementConditionsType newMeasurementCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MEASUREMENT_CONDITION, oldMeasurementCondition, newMeasurementCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementCondition(TympanogramMeasurementConditionsType newMeasurementCondition) {
		if (newMeasurementCondition != measurementCondition) {
			...
			if (measurementCondition != null)
				msgs = ((InternalEObject)measurementCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MEASUREMENT_CONDITION, null, msgs);
			if (newMeasurementCondition != null)
				msgs = ((InternalEObject)newMeasurementCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MEASUREMENT_CONDITION, null, msgs);
			msgs = basicSetMeasurementCondition(newMeasurementCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MEASUREMENT_CONDITION, newMeasurementCondition, newMeasurementCondition));
	}
	...
	public NotificationChain basicSetStaticAdmittance(StaticAdmittanceType newStaticAdmittance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__STATIC_ADMITTANCE, oldStaticAdmittance, newStaticAdmittance);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStaticAdmittance(StaticAdmittanceType newStaticAdmittance) {
		if (newStaticAdmittance != staticAdmittance) {
			...
			if (staticAdmittance != null)
				msgs = ((InternalEObject)staticAdmittance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__STATIC_ADMITTANCE, null, msgs);
			if (newStaticAdmittance != null)
				msgs = ((InternalEObject)newStaticAdmittance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.TYMPANOGRAM_TEST_TYPE__STATIC_ADMITTANCE, null, msgs);
			msgs = basicSetStaticAdmittance(newStaticAdmittance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.TYMPANOGRAM_TEST_TYPE__STATIC_ADMITTANCE, newStaticAdmittance, newStaticAdmittance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__ADMITTANCE_CURVE:
				return basicSetAdmittanceCurve(null, msgs);
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MAXIMUM_ADMITTANCE:
				return basicSetMaximumAdmittance(null, msgs);
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__CANAL_VOLUME:
				return basicSetCanalVolume(null, msgs);
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__GRADIENT:
				return basicSetGradient(null, msgs);
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MEASUREMENT_CONDITION:
				return basicSetMeasurementCondition(null, msgs);
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__STATIC_ADMITTANCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__GRADIENT:
				return getGradient();
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__PRESSURE:
				return getPressure();
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__RESONANCE_FREQUENCY:
				return getResonanceFrequency();
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__RESULT:
				return getResult();
			case AdmittancePackage.TYMPANOGRAM_TEST_TYPE__MEASUREMENT_CONDITION:
