 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.DeltaYPointsTypeImpl#getPt <em>Pt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeltaYPointsTypeImpl extends MinimalEObjectImpl.Container implements DeltaYPointsType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.DELTA_YPOINTS_TYPE;
	}
	...
	public EList<ReflexValuePointMeasuredType> getPt() {
		if (pt == null) {
			pt = new EObjectContainmentEList<ReflexValuePointMeasuredType>(ReflexValuePointMeasuredType.class, this, AdmittancePackage.DELTA_YPOINTS_TYPE__PT);
		}
		return pt;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.DELTA_YPOINTS_TYPE__PT:
