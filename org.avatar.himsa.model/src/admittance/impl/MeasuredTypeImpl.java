 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.MeasuredTypeImpl#getAdmittancePointMeasured <em>Admittance Point Measured</em>}</li>
 *   <li>{@link admittance.impl.MeasuredTypeImpl#getAdmittanceUnitMeasured <em>Admittance Unit Measured</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasuredTypeImpl extends MinimalEObjectImpl.Container implements MeasuredType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.MEASURED_TYPE;
	}
	...
	public NotificationChain basicSetAdmittancePointMeasured(AdmittanceValueMeasuredType newAdmittancePointMeasured, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.MEASURED_TYPE__ADMITTANCE_POINT_MEASURED, oldAdmittancePointMeasured, newAdmittancePointMeasured);
	...
	public void setAdmittancePointMeasured(AdmittanceValueMeasuredType newAdmittancePointMeasured) {
		if (newAdmittancePointMeasured != admittancePointMeasured) {
			...
			if (admittancePointMeasured != null)
				msgs = ((InternalEObject)admittancePointMeasured).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.MEASURED_TYPE__ADMITTANCE_POINT_MEASURED, null, msgs);
			if (newAdmittancePointMeasured != null)
				msgs = ((InternalEObject)newAdmittancePointMeasured).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.MEASURED_TYPE__ADMITTANCE_POINT_MEASURED, null, msgs);
			msgs = basicSetAdmittancePointMeasured(newAdmittancePointMeasured, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.MEASURED_TYPE__ADMITTANCE_POINT_MEASURED, newAdmittancePointMeasured, newAdmittancePointMeasured));
	}
	...
	public NotificationChain basicSetAdmittanceUnitMeasured(AdmittanceUnitMeasuredType newAdmittanceUnitMeasured, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.MEASURED_TYPE__ADMITTANCE_UNIT_MEASURED, oldAdmittanceUnitMeasured, newAdmittanceUnitMeasured);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdmittanceUnitMeasured(AdmittanceUnitMeasuredType newAdmittanceUnitMeasured) {
		if (newAdmittanceUnitMeasured != admittanceUnitMeasured) {
			...
			if (admittanceUnitMeasured != null)
				msgs = ((InternalEObject)admittanceUnitMeasured).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.MEASURED_TYPE__ADMITTANCE_UNIT_MEASURED, null, msgs);
			if (newAdmittanceUnitMeasured != null)
				msgs = ((InternalEObject)newAdmittanceUnitMeasured).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.MEASURED_TYPE__ADMITTANCE_UNIT_MEASURED, null, msgs);
			msgs = basicSetAdmittanceUnitMeasured(newAdmittanceUnitMeasured, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.MEASURED_TYPE__ADMITTANCE_UNIT_MEASURED, newAdmittanceUnitMeasured, newAdmittanceUnitMeasured));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.MEASURED_TYPE__ADMITTANCE_POINT_MEASURED:
				return basicSetAdmittancePointMeasured(null, msgs);
			case AdmittancePackage.MEASURED_TYPE__ADMITTANCE_UNIT_MEASURED:
