 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.CalculatedTypeImpl#getAdmittanceValueCalculated <em>Admittance Value Calculated</em>}</li>
 *   <li>{@link admittance.impl.CalculatedTypeImpl#getCalculatedAdmittanceUnit <em>Calculated Admittance Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CalculatedTypeImpl extends MinimalEObjectImpl.Container implements CalculatedType {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.CALCULATED_TYPE;
	}
	...
	public NotificationChain basicSetAdmittanceValueCalculated(AdmittanceValueCalculatedType newAdmittanceValueCalculated, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.CALCULATED_TYPE__ADMITTANCE_VALUE_CALCULATED, oldAdmittanceValueCalculated, newAdmittanceValueCalculated);
	...
	public void setAdmittanceValueCalculated(AdmittanceValueCalculatedType newAdmittanceValueCalculated) {
		if (newAdmittanceValueCalculated != admittanceValueCalculated) {
			...
			if (admittanceValueCalculated != null)
				msgs = ((InternalEObject)admittanceValueCalculated).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.CALCULATED_TYPE__ADMITTANCE_VALUE_CALCULATED, null, msgs);
			if (newAdmittanceValueCalculated != null)
				msgs = ((InternalEObject)newAdmittanceValueCalculated).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.CALCULATED_TYPE__ADMITTANCE_VALUE_CALCULATED, null, msgs);
			msgs = basicSetAdmittanceValueCalculated(newAdmittanceValueCalculated, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.CALCULATED_TYPE__ADMITTANCE_VALUE_CALCULATED, newAdmittanceValueCalculated, newAdmittanceValueCalculated));
	}
	...
	public NotificationChain basicSetCalculatedAdmittanceUnit(AdmittanceUnitCalculatedType newCalculatedAdmittanceUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdmittancePackage.CALCULATED_TYPE__CALCULATED_ADMITTANCE_UNIT, oldCalculatedAdmittanceUnit, newCalculatedAdmittanceUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalculatedAdmittanceUnit(AdmittanceUnitCalculatedType newCalculatedAdmittanceUnit) {
		if (newCalculatedAdmittanceUnit != calculatedAdmittanceUnit) {
			...
			if (calculatedAdmittanceUnit != null)
				msgs = ((InternalEObject)calculatedAdmittanceUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.CALCULATED_TYPE__CALCULATED_ADMITTANCE_UNIT, null, msgs);
			if (newCalculatedAdmittanceUnit != null)
				msgs = ((InternalEObject)newCalculatedAdmittanceUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdmittancePackage.CALCULATED_TYPE__CALCULATED_ADMITTANCE_UNIT, null, msgs);
			msgs = basicSetCalculatedAdmittanceUnit(newCalculatedAdmittanceUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.CALCULATED_TYPE__CALCULATED_ADMITTANCE_UNIT, newCalculatedAdmittanceUnit, newCalculatedAdmittanceUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.CALCULATED_TYPE__ADMITTANCE_VALUE_CALCULATED:
				return basicSetAdmittanceValueCalculated(null, msgs);
			case AdmittancePackage.CALCULATED_TYPE__CALCULATED_ADMITTANCE_UNIT:
