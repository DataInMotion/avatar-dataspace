 ...
 * </p>
 * <ul>
 *   <li>{@link admittance.impl.EustachianTubeFunctionPerforatedEarDrumTestImpl#getPressurePoint <em>Pressure Point</em>}</li>
 *   <li>{@link admittance.impl.EustachianTubeFunctionPerforatedEarDrumTestImpl#getOpenPoint <em>Open Point</em>}</li>
 *   <li>{@link admittance.impl.EustachianTubeFunctionPerforatedEarDrumTestImpl#getClosePoint <em>Close Point</em>}</li>
 *   <li>{@link admittance.impl.EustachianTubeFunctionPerforatedEarDrumTestImpl#getTimeBase <em>Time Base</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EustachianTubeFunctionPerforatedEarDrumTestImpl extends MinimalEObjectImpl.Container implements EustachianTubeFunctionPerforatedEarDrumTest {
	...
	protected EClass eStaticClass() {
		return AdmittancePackage.Literals.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST;
	}
	...
	public EList<PressurePointType> getPressurePoint() {
		if (pressurePoint == null) {
			pressurePoint = new EObjectContainmentEList<PressurePointType>(PressurePointType.class, this, AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__PRESSURE_POINT);
		}
	...
	public EList<BigInteger> getOpenPoint() {
		if (openPoint == null) {
			openPoint = new EDataTypeEList<BigInteger>(BigInteger.class, this, AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__OPEN_POINT);
		}
		return openPoint;
	}
	...
	public EList<BigInteger> getClosePoint() {
		if (closePoint == null) {
			closePoint = new EDataTypeEList<BigInteger>(BigInteger.class, this, AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__CLOSE_POINT);
		}
		return closePoint;
	}
	...
	public void setTimeBase(BigDecimal newTimeBase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__TIME_BASE, oldTimeBase, timeBase));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__PRESSURE_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__OPEN_POINT:
				return getOpenPoint();
			case AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__CLOSE_POINT:
				return getClosePoint();
			case AdmittancePackage.EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST__TIME_BASE:
				return getTimeBase();
		}
