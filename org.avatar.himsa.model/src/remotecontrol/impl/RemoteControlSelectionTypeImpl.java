 ...
 * </p>
 * <ul>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getInstrumentTypeName <em>Instrument Type Name</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getSerialNumber <em>Serial Number</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getBatteryType <em>Battery Type</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getReserved <em>Reserved</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getPrivateSelectionData <em>Private Selection Data</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link remotecontrol.impl.RemoteControlSelectionTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoteControlSelectionTypeImpl extends MinimalEObjectImpl.Container implements RemoteControlSelectionType {
	...
	protected EClass eStaticClass() {
		return RemotecontrolPackage.Literals.REMOTE_CONTROL_SELECTION_TYPE;
	}
	...
	public void setInstrumentTypeName(String newInstrumentTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__INSTRUMENT_TYPE_NAME, oldInstrumentTypeName, instrumentTypeName));
	}
	...
	public void setSerialNumber(String newSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__SERIAL_NUMBER, oldSerialNumber, serialNumber));
	}
	...
	public NotificationChain basicSetBatteryType(BatteryType newBatteryType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__BATTERY_TYPE, oldBatteryType, newBatteryType);
	...
	public void setBatteryType(BatteryType newBatteryType) {
		if (newBatteryType != batteryType) {
			...
			if (batteryType != null)
				msgs = ((InternalEObject)batteryType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__BATTERY_TYPE, null, msgs);
			if (newBatteryType != null)
				msgs = ((InternalEObject)newBatteryType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__BATTERY_TYPE, null, msgs);
			msgs = basicSetBatteryType(newBatteryType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__BATTERY_TYPE, newBatteryType, newBatteryType));
	}
	...
	public void setReserved(byte[] newReserved) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__RESERVED, oldReserved, reserved));
	}
	...
	public void setPrivateSelectionData(byte[] newPrivateSelectionData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__PRIVATE_SELECTION_DATA, oldPrivateSelectionData, privateSelectionData));
	}
	...
	public void setConvertedFromDataStandard(BigInteger newConvertedFromDataStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__CONVERTED_FROM_DATA_STANDARD, oldConvertedFromDataStandard, convertedFromDataStandard));
	}
	...
	public void setValidatedByNOAH(boolean newValidatedByNOAH) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, validatedByNOAH, !oldValidatedByNOAHESet));
	}
	...
	public void unsetValidatedByNOAH() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, VALIDATED_BY_NOAH_EDEFAULT, oldValidatedByNOAHESet));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__BATTERY_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__INSTRUMENT_TYPE_NAME:
				return getInstrumentTypeName();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__SERIAL_NUMBER:
				return getSerialNumber();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__BATTERY_TYPE:
				return getBatteryType();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__RESERVED:
				return getReserved();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__PRIVATE_SELECTION_DATA:
				return getPrivateSelectionData();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__CONVERTED_FROM_DATA_STANDARD:
				return getConvertedFromDataStandard();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__VALIDATED_BY_NOAH:
				return isValidatedByNOAH();
			case RemotecontrolPackage.REMOTE_CONTROL_SELECTION_TYPE__VERSION:
				return getVersion();
		}
