...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Point Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.scan.scan.meta.data.impl.PointType1Impl#getAnnotationComment <em>Annotation Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointType1Impl extends PointTypeImpl implements PointType1 {
	/**
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.POINT_TYPE1;
	}
	...
	public void setAnnotationComment(String newAnnotationComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.POINT_TYPE1__ANNOTATION_COMMENT, oldAnnotationComment, annotationComment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.POINT_TYPE1__ANNOTATION_COMMENT:
