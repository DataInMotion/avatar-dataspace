 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerProvider <em>Scanner Provider</em>}</li>
 *   <li>{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerModel <em>Scanner Model</em>}</li>
 *   <li>{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerFirmware <em>Scanner Firmware</em>}</li>
 *   <li>{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerType <em>Scanner Type</em>}</li>
 *   <li>{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getUniqueScannerID <em>Unique Scanner ID</em>}</li>
 * </ul>
 *
 * @see com.himsa.scan.scan.meta.data.DataPackage#getScannerHardwareType()
...
public interface ScannerHardwareType extends EObject {
	 ...
	 * @see com.himsa.scan.scan.meta.data.DataPackage#getScannerHardwareType_ScannerProvider()
	...
	/**
	 * Sets the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerProvider <em>Scanner Provider</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.himsa.scan.scan.meta.data.DataPackage#getScannerHardwareType_ScannerModel()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerModel <em>Scanner Model</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.himsa.scan.scan.meta.data.DataPackage#getScannerHardwareType_ScannerFirmware()
	...
	/**
	 * Sets the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerFirmware <em>Scanner Firmware</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link com.himsa.scan.scan.meta.data.ScannerTypeType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see com.himsa.scan.scan.meta.data.DataPackage#getScannerHardwareType_ScannerType()
	...
	/**
	 * Sets the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerType <em>Scanner Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerType <em>Scanner Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetScannerType()
	 * @see #getScannerType()
	...
	/**
	 * Returns whether the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getScannerType <em>Scanner Type</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.himsa.scan.scan.meta.data.DataPackage#getScannerHardwareType_UniqueScannerID()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link com.himsa.scan.scan.meta.data.ScannerHardwareType#getUniqueScannerID <em>Unique Scanner ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
