...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cochlear Implant Sound Processor Selection Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.cochlear.implant.sound.processor.selection._500.impl.CochlearImplantSoundProcessorSelectionTypeImpl#getSoundProcessor <em>Sound Processor</em>}</li>
 *   <li>{@link com.himsa.cochlear.implant.sound.processor.selection._500.impl.CochlearImplantSoundProcessorSelectionTypeImpl#getSerialNumber <em>Serial Number</em>}</li>
 *   <li>{@link com.himsa.cochlear.implant.sound.processor.selection._500.impl.CochlearImplantSoundProcessorSelectionTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CochlearImplantSoundProcessorSelectionTypeImpl extends MinimalEObjectImpl.Container implements CochlearImplantSoundProcessorSelectionType {
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE;
	}
	...
	public void setSoundProcessor(String newSoundProcessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__SOUND_PROCESSOR, oldSoundProcessor, soundProcessor));
	}
	...
	public void setSerialNumber(String newSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__SERIAL_NUMBER, oldSerialNumber, serialNumber));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__SOUND_PROCESSOR:
				return getSoundProcessor();
			case _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__SERIAL_NUMBER:
				return getSerialNumber();
			case _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE__VERSION:
				return getVersion();
		}
