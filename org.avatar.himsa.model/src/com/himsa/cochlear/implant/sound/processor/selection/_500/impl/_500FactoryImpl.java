...
public class _500FactoryImpl extends EFactoryImpl implements _500Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case _500Package.COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION_TYPE: return createCochlearImplantSoundProcessorSelectionType();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case _500Package.SERIAL_NUMBER_TYPE:
				return createSerialNumberTypeFromString(eDataType, initialValue);
			case _500Package.SOUND_PROCESSOR_TYPE:
