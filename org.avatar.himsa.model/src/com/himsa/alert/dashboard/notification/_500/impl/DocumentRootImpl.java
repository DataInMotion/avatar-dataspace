 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.alert.dashboard.notification._500.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.himsa.alert.dashboard.notification._500.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.himsa.alert.dashboard.notification._500.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.himsa.alert.dashboard.notification._500.impl.DocumentRootImpl#getNotificationAction <em>Notification Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public NotificationActionType getNotificationAction() {
		return (NotificationActionType)getMixed().get(_500Package.Literals.DOCUMENT_ROOT__NOTIFICATION_ACTION, true);
	}
	...
	public NotificationChain basicSetNotificationAction(NotificationActionType newNotificationAction, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(_500Package.Literals.DOCUMENT_ROOT__NOTIFICATION_ACTION, newNotificationAction, msgs);
	}
	...
	public void setNotificationAction(NotificationActionType newNotificationAction) {
		((FeatureMap.Internal)getMixed()).set(_500Package.Literals.DOCUMENT_ROOT__NOTIFICATION_ACTION, newNotificationAction);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case _500Package.DOCUMENT_ROOT__NOTIFICATION_ACTION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case _500Package.DOCUMENT_ROOT__NOTIFICATION_ACTION:
				return getNotificationAction() != null;
		}
