 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.IntermodulationDistortionMeasurement#getMeasurementCondition <em>Measurement Condition</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.IntermodulationDistortionMeasurement#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.real.ear.EarPackage#getIntermodulationDistortionMeasurement()
...
public interface IntermodulationDistortionMeasurement extends EObject {
	 ...
	 * @see com.himsa.measurement.real.ear.EarPackage#getIntermodulationDistortionMeasurement_MeasurementCondition()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.real.ear.IntermodulationDistortionMeasurement#getMeasurementCondition <em>Measurement Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link com.himsa.measurement.real.ear.IntermodulationDistortionPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Point</em>' containment reference list.
	 * @see com.himsa.measurement.real.ear.EarPackage#getIntermodulationDistortionMeasurement_Point()
