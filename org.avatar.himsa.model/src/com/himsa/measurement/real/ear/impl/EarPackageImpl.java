...
import com.himsa.measurement.real.ear.DocumentRoot;
import com.himsa.measurement.real.ear.EarFactory;
import com.himsa.measurement.real.ear.EarPackage;
import com.himsa.measurement.real.ear.EquivalentInputNoise;
import com.himsa.measurement.real.ear.FittingRule;
import com.himsa.measurement.real.ear.FrequencyMeasurement;
...
import com.himsa.measurement.real.ear.HarmonicDistortionMeasurementCurve;
import com.himsa.measurement.real.ear.HarmonicDistortionPoint;
import com.himsa.measurement.real.ear.HearingInstrumentType;
import com.himsa.measurement.real.ear.InputOutputMeasurement;
import com.himsa.measurement.real.ear.InputOutputPoint;
import com.himsa.measurement.real.ear.IntermodulationDistortionMeasurement;
import com.himsa.measurement.real.ear.IntermodulationDistortionPoint;
...
import com.himsa.measurement.real.ear.RealEarDataType;
...
import com.himsa.measurement.real.ear.TargetMeasurement;
import com.himsa.measurement.real.ear.TargetMeasurementPoint;
import com.himsa.measurement.real.ear.TargetPoint;

import com.himsa.measurement.real.ear.util.EarValidator;
 ...
 * @generated
 */
public class EarPackageImpl extends EPackageImpl implements EarPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass himsaRemStandardTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass realEarDataTypeEClass = null;
	 ...
	 * @see com.himsa.measurement.real.ear.EarPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EarPackageImpl() {
		super(eNS_URI, EarFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link EarPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EarPackage init() {
		if (isInited) return (EarPackage)EPackage.Registry.INSTANCE.getEPackage(EarPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredEarPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		EarPackageImpl theEarPackage = registeredEarPackage instanceof EarPackageImpl ? (EarPackageImpl)registeredEarPackage : new EarPackageImpl();
			...
			(theEarPackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return EarValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theEarPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EarPackage.eNS_URI, theEarPackage);
		return theEarPackage;
	}
	 ...
	 */
	@Override
	public EReference getDocumentRoot_HIMSARemStandard() {
	 ...
	 */
	@Override
	public EClass getHIMSARemStandardType() {
		return himsaRemStandardTypeEClass;
	}
	 ...
	 */
	@Override
	public EReference getHIMSARemStandardType_RealEarData() {
		return (EReference)himsaRemStandardTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getHIMSARemStandardType_PrivateREM() {
		return (EAttribute)himsaRemStandardTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getHIMSARemStandardType_ConvertedFromDataStandard() {
		return (EAttribute)himsaRemStandardTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getHIMSARemStandardType_ValidatedByNOAH() {
		return (EAttribute)himsaRemStandardTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getHIMSARemStandardType_Version() {
		return (EAttribute)himsaRemStandardTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getRealEarDataType() {
		return realEarDataTypeEClass;
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_Targets() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_RealEarUnaidedResponse() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_RealEarOccludedResponse() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_RealEarInsertionResponse() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_RealEarAidedResponse() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_InputOutputMeasurement() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_TotalHarmonicDistortionMeasurement() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_OcclusionMeasurement() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EReference getRealEarDataType_RealEarCoupler() {
		return (EReference)realEarDataTypeEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EarFactory getEarFactory() {
		return (EarFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(documentRootEClass, DOCUMENT_ROOT__HIMSA_REM_STANDARD);
		...
		himsaRemStandardTypeEClass = createEClass(HIMSA_REM_STANDARD_TYPE);
		createEReference(himsaRemStandardTypeEClass, HIMSA_REM_STANDARD_TYPE__REAL_EAR_DATA);
		createEAttribute(himsaRemStandardTypeEClass, HIMSA_REM_STANDARD_TYPE__PRIVATE_REM);
		createEAttribute(himsaRemStandardTypeEClass, HIMSA_REM_STANDARD_TYPE__CONVERTED_FROM_DATA_STANDARD);
		createEAttribute(himsaRemStandardTypeEClass, HIMSA_REM_STANDARD_TYPE__VALIDATED_BY_NOAH);
		createEAttribute(himsaRemStandardTypeEClass, HIMSA_REM_STANDARD_TYPE__VERSION);
		...
		realEarDataTypeEClass = createEClass(REAL_EAR_DATA_TYPE);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__TARGETS);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__REAL_EAR_UNAIDED_RESPONSE);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__REAL_EAR_OCCLUDED_RESPONSE);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__REAL_EAR_INSERTION_RESPONSE);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__REAL_EAR_AIDED_RESPONSE);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__INPUT_OUTPUT_MEASUREMENT);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__TOTAL_HARMONIC_DISTORTION_MEASUREMENT);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__OCCLUSION_MEASUREMENT);
		createEReference(realEarDataTypeEClass, REAL_EAR_DATA_TYPE__REAL_EAR_COUPLER);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAttackReleaseMeasurementPoint_Output(), this.getOutputType(), "output", null, 1, 1, AttackReleaseMeasurementPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_HIMSARemStandard(), this.getHIMSARemStandardType(), null, "hIMSARemStandard", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFullTargetCurve_SignalLevel(), this.getSignalLevelType2(), "signalLevel", null, 0, 1, FullTargetCurve.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHarmonicDistortionPoint_Input(), this.getInputType(), "input", null, 1, 1, HarmonicDistortionPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(himsaRemStandardTypeEClass, HIMSARemStandardType.class, "HIMSARemStandardType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHIMSARemStandardType_RealEarData(), this.getRealEarDataType(), null, "realEarData", null, 0, 1, HIMSARemStandardType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHIMSARemStandardType_PrivateREM(), theXMLTypePackage.getBase64Binary(), "privateREM", null, 0, 1, HIMSARemStandardType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHIMSARemStandardType_ConvertedFromDataStandard(), this.getConvertedFromDataStandardType(), "convertedFromDataStandard", null, 0, 1, HIMSARemStandardType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHIMSARemStandardType_ValidatedByNOAH(), theXMLTypePackage.getBoolean(), "validatedByNOAH", null, 0, 1, HIMSARemStandardType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHIMSARemStandardType_Version(), this.getVersionType(), "version", "500", 1, 1, HIMSARemStandardType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInputOutputPoint_Input(), this.getInputType1(), "input", null, 1, 1, InputOutputPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInputOutputPoint_Output(), this.getOutputType2(), "output", null, 1, 1, InputOutputPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMeasurementConditions_SignalLevel(), this.getSignalLevelType1(), "signalLevel", null, 0, 1, MeasurementConditions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(realEarDataTypeEClass, RealEarDataType.class, "RealEarDataType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRealEarDataType_Targets(), this.getFullTargetCurve(), null, "targets", null, 0, 3, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_RealEarUnaidedResponse(), this.getFrequencyMeasurement(), null, "realEarUnaidedResponse", null, 0, 1, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_RealEarOccludedResponse(), this.getFrequencyMeasurement(), null, "realEarOccludedResponse", null, 0, 1, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_RealEarInsertionResponse(), this.getFrequencyMeasurement(), null, "realEarInsertionResponse", null, 0, 5, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_RealEarAidedResponse(), this.getFrequencyMeasurement(), null, "realEarAidedResponse", null, 0, 5, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_InputOutputMeasurement(), this.getInputOutputMeasurement(), null, "inputOutputMeasurement", null, 0, 5, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_TotalHarmonicDistortionMeasurement(), this.getHarmonicDistortionMeasurementCurve(), null, "totalHarmonicDistortionMeasurement", null, 0, 3, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_OcclusionMeasurement(), this.getOcclusionEffects(), null, "occlusionMeasurement", null, 0, 3, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealEarDataType_RealEarCoupler(), this.getRealEarCouplerDifference(), null, "realEarCoupler", null, 0, 1, RealEarDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTargetMeasurementPoint_Output(), this.getOutputType1(), "output", null, 1, 256, TargetMeasurementPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getDocumentRoot_HIMSARemStandard(),
		   source,
		   new String[] {
			   "kind", "element",
		...
		addAnnotation
		  (himsaRemStandardTypeEClass,
		   source,
		   new String[] {
			   "name", "HIMSARemStandard_._type",
			   "kind", "elementOnly"
		   });
		addAnnotation
		  (getHIMSARemStandardType_RealEarData(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "RealEarData",
		...
		addAnnotation
		  (getHIMSARemStandardType_PrivateREM(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "PrivateREM",
		...
		addAnnotation
		  (getHIMSARemStandardType_ConvertedFromDataStandard(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getHIMSARemStandardType_ValidatedByNOAH(),
		   source,
		   new String[] {
			   "kind", "attribute",
		...
		addAnnotation
		  (getHIMSARemStandardType_Version(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "Version"
		...
		addAnnotation
		  (realEarDataTypeEClass,
		   source,
		   new String[] {
			   "name", "RealEarData_._type",
			   "kind", "elementOnly"
		   });
		addAnnotation
		  (getRealEarDataType_Targets(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "Targets",
		...
		addAnnotation
		  (getRealEarDataType_RealEarUnaidedResponse(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "RealEarUnaidedResponse",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (getRealEarDataType_RealEarOccludedResponse(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "RealEarOccludedResponse",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (getRealEarDataType_RealEarInsertionResponse(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "RealEarInsertionResponse",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (getRealEarDataType_RealEarAidedResponse(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "RealEarAidedResponse",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (getRealEarDataType_InputOutputMeasurement(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "InputOutputMeasurement",
		...
		addAnnotation
		  (getRealEarDataType_TotalHarmonicDistortionMeasurement(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "TotalHarmonicDistortionMeasurement",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (getRealEarDataType_OcclusionMeasurement(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "OcclusionMeasurement",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (getRealEarDataType_RealEarCoupler(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "RealEarCoupler",
