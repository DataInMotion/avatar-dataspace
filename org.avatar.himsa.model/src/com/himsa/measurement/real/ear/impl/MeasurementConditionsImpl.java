 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getManufacturerCode <em>Manufacturer Code</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getDevTypeCode <em>Dev Type Code</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getSignalType <em>Signal Type</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getSignalOutput <em>Signal Output</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getSignalFrequency <em>Signal Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getBatteryType <em>Battery Type</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getBatteryPillType <em>Battery Pill Type</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getBatteryVoltage <em>Battery Voltage</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getBatteryImpedance <em>Battery Impedance</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#isUseRealEarCoupler <em>Use Real Ear Coupler</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getMeasurementMode <em>Measurement Mode</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.MeasurementConditionsImpl#getMeasurementIdentification <em>Measurement Identification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementConditionsImpl extends MinimalEObjectImpl.Container implements MeasurementConditions {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.MEASUREMENT_CONDITIONS;
	}
	...
	public void setManufacturerCode(BigInteger newManufacturerCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__MANUFACTURER_CODE, oldManufacturerCode, manufacturerCode));
	}
	...
	public void setDevTypeCode(BigInteger newDevTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__DEV_TYPE_CODE, oldDevTypeCode, devTypeCode));
	}
	...
	public void setSignalType(SignalType newSignalType) {
		...
		signalTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_TYPE, oldSignalType, signalType, !oldSignalTypeESet));
	}
	...
	public void unsetSignalType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_TYPE, oldSignalType, SIGNAL_TYPE_EDEFAULT, oldSignalTypeESet));
	}
	...
	public void setSignalOutput(SignalOutputType newSignalOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_OUTPUT, oldSignalOutput, signalOutput, !oldSignalOutputESet));
	}
	...
	public void unsetSignalOutput() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_OUTPUT, oldSignalOutput, SIGNAL_OUTPUT_EDEFAULT, oldSignalOutputESet));
	}
	...
	public void setSignalLevel(BigDecimal newSignalLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_LEVEL, oldSignalLevel, signalLevel));
	}
	...
	public void setSignalFrequency(BigInteger newSignalFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_FREQUENCY, oldSignalFrequency, signalFrequency));
	}
	...
	public void setBatteryType(BatteryType newBatteryType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__BATTERY_TYPE, oldBatteryType, batteryType, !oldBatteryTypeESet));
	}
	...
	public void unsetBatteryType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__BATTERY_TYPE, oldBatteryType, BATTERY_TYPE_EDEFAULT, oldBatteryTypeESet));
	}
	...
	public void setBatteryPillType(BatteryPillType newBatteryPillType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__BATTERY_PILL_TYPE, oldBatteryPillType, batteryPillType, !oldBatteryPillTypeESet));
	}
	...
	public void unsetBatteryPillType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__BATTERY_PILL_TYPE, oldBatteryPillType, BATTERY_PILL_TYPE_EDEFAULT, oldBatteryPillTypeESet));
	}
	...
	public void setBatteryVoltage(BigDecimal newBatteryVoltage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__BATTERY_VOLTAGE, oldBatteryVoltage, batteryVoltage));
	}
	...
	public void setBatteryImpedance(BigDecimal newBatteryImpedance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__BATTERY_IMPEDANCE, oldBatteryImpedance, batteryImpedance));
	}
	...
	public void setUseRealEarCoupler(boolean newUseRealEarCoupler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__USE_REAL_EAR_COUPLER, oldUseRealEarCoupler, useRealEarCoupler, !oldUseRealEarCouplerESet));
	}
	...
	public void unsetUseRealEarCoupler() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__USE_REAL_EAR_COUPLER, oldUseRealEarCoupler, USE_REAL_EAR_COUPLER_EDEFAULT, oldUseRealEarCouplerESet));
	}
	...
	public void setMeasurementMode(MeasurementMode newMeasurementMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__MEASUREMENT_MODE, oldMeasurementMode, measurementMode, !oldMeasurementModeESet));
	}
	...
	public void unsetMeasurementMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__MEASUREMENT_MODE, oldMeasurementMode, MEASUREMENT_MODE_EDEFAULT, oldMeasurementModeESet));
	}
	...
	public void setMeasurementIdentification(MeasurementIdentification newMeasurementIdentification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.MEASUREMENT_CONDITIONS__MEASUREMENT_IDENTIFICATION, oldMeasurementIdentification, measurementIdentification, !oldMeasurementIdentificationESet));
	}
	...
	public void unsetMeasurementIdentification() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.MEASUREMENT_CONDITIONS__MEASUREMENT_IDENTIFICATION, oldMeasurementIdentification, MEASUREMENT_IDENTIFICATION_EDEFAULT, oldMeasurementIdentificationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EarPackage.MEASUREMENT_CONDITIONS__MANUFACTURER_CODE:
				return getManufacturerCode();
			case EarPackage.MEASUREMENT_CONDITIONS__DEV_TYPE_CODE:
				return getDevTypeCode();
			case EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_TYPE:
				return getSignalType();
			case EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_OUTPUT:
				return getSignalOutput();
			case EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_LEVEL:
				return getSignalLevel();
			case EarPackage.MEASUREMENT_CONDITIONS__SIGNAL_FREQUENCY:
				return getSignalFrequency();
			case EarPackage.MEASUREMENT_CONDITIONS__BATTERY_TYPE:
				return getBatteryType();
			case EarPackage.MEASUREMENT_CONDITIONS__BATTERY_PILL_TYPE:
				return getBatteryPillType();
			case EarPackage.MEASUREMENT_CONDITIONS__BATTERY_VOLTAGE:
				return getBatteryVoltage();
			case EarPackage.MEASUREMENT_CONDITIONS__BATTERY_IMPEDANCE:
				return getBatteryImpedance();
			case EarPackage.MEASUREMENT_CONDITIONS__USE_REAL_EAR_COUPLER:
				return isUseRealEarCoupler();
			case EarPackage.MEASUREMENT_CONDITIONS__MEASUREMENT_MODE:
				return getMeasurementMode();
			case EarPackage.MEASUREMENT_CONDITIONS__MEASUREMENT_IDENTIFICATION:
