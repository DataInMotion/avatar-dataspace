 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.FrequencyMeasurementPointImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.FrequencyMeasurementPointImpl#getInput <em>Input</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.FrequencyMeasurementPointImpl#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FrequencyMeasurementPointImpl extends MinimalEObjectImpl.Container implements FrequencyMeasurementPoint {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.FREQUENCY_MEASUREMENT_POINT;
	}
	...
	public void setFrequency(BigInteger newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.FREQUENCY_MEASUREMENT_POINT__FREQUENCY, oldFrequency, frequency));
	}
	...
	public void setInput(BigDecimal newInput) {
		...
		input = newInput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.FREQUENCY_MEASUREMENT_POINT__INPUT, oldInput, input));
	}
	...
	public void setOutput(BigDecimal newOutput) {
		...
		output = newOutput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.FREQUENCY_MEASUREMENT_POINT__OUTPUT, oldOutput, output));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EarPackage.FREQUENCY_MEASUREMENT_POINT__FREQUENCY:
				return getFrequency();
			case EarPackage.FREQUENCY_MEASUREMENT_POINT__INPUT:
				return getInput();
			case EarPackage.FREQUENCY_MEASUREMENT_POINT__OUTPUT:
				return getOutput();
		}
