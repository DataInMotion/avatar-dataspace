 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.FrequencyMeasurementImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.FrequencyMeasurementImpl#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FrequencyMeasurementImpl extends MinimalEObjectImpl.Container implements FrequencyMeasurement {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.FREQUENCY_MEASUREMENT;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditions newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.FREQUENCY_MEASUREMENT__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditions newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.FREQUENCY_MEASUREMENT__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.FREQUENCY_MEASUREMENT__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.FREQUENCY_MEASUREMENT__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public EList<FrequencyMeasurementPoint> getPoint() {
		if (point == null) {
			point = new EObjectContainmentEList<FrequencyMeasurementPoint>(FrequencyMeasurementPoint.class, this, EarPackage.FREQUENCY_MEASUREMENT__POINT);
		}
		return point;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.FREQUENCY_MEASUREMENT__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case EarPackage.FREQUENCY_MEASUREMENT__POINT:
