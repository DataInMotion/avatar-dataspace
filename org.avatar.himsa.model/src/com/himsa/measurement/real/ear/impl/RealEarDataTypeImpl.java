 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getTargets <em>Targets</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getRealEarUnaidedResponse <em>Real Ear Unaided Response</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getRealEarOccludedResponse <em>Real Ear Occluded Response</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getRealEarInsertionResponse <em>Real Ear Insertion Response</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getRealEarAidedResponse <em>Real Ear Aided Response</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getInputOutputMeasurement <em>Input Output Measurement</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getTotalHarmonicDistortionMeasurement <em>Total Harmonic Distortion Measurement</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getOcclusionMeasurement <em>Occlusion Measurement</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.RealEarDataTypeImpl#getRealEarCoupler <em>Real Ear Coupler</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealEarDataTypeImpl extends MinimalEObjectImpl.Container implements RealEarDataType {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.REAL_EAR_DATA_TYPE;
	}
	...
	public EList<FullTargetCurve> getTargets() {
		if (targets == null) {
			targets = new EObjectContainmentEList<FullTargetCurve>(FullTargetCurve.class, this, EarPackage.REAL_EAR_DATA_TYPE__TARGETS);
		}
		return targets;
	}
	...
	public NotificationChain basicSetRealEarUnaidedResponse(FrequencyMeasurement newRealEarUnaidedResponse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_UNAIDED_RESPONSE, oldRealEarUnaidedResponse, newRealEarUnaidedResponse);
	...
	public void setRealEarUnaidedResponse(FrequencyMeasurement newRealEarUnaidedResponse) {
		if (newRealEarUnaidedResponse != realEarUnaidedResponse) {
			...
			if (realEarUnaidedResponse != null)
				msgs = ((InternalEObject)realEarUnaidedResponse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_UNAIDED_RESPONSE, null, msgs);
			if (newRealEarUnaidedResponse != null)
				msgs = ((InternalEObject)newRealEarUnaidedResponse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_UNAIDED_RESPONSE, null, msgs);
			msgs = basicSetRealEarUnaidedResponse(newRealEarUnaidedResponse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_UNAIDED_RESPONSE, newRealEarUnaidedResponse, newRealEarUnaidedResponse));
	}
	...
	public NotificationChain basicSetRealEarOccludedResponse(FrequencyMeasurement newRealEarOccludedResponse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_OCCLUDED_RESPONSE, oldRealEarOccludedResponse, newRealEarOccludedResponse);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRealEarOccludedResponse(FrequencyMeasurement newRealEarOccludedResponse) {
		if (newRealEarOccludedResponse != realEarOccludedResponse) {
			...
			if (realEarOccludedResponse != null)
				msgs = ((InternalEObject)realEarOccludedResponse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_OCCLUDED_RESPONSE, null, msgs);
			if (newRealEarOccludedResponse != null)
				msgs = ((InternalEObject)newRealEarOccludedResponse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_OCCLUDED_RESPONSE, null, msgs);
			msgs = basicSetRealEarOccludedResponse(newRealEarOccludedResponse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_OCCLUDED_RESPONSE, newRealEarOccludedResponse, newRealEarOccludedResponse));
	}
	...
	public EList<FrequencyMeasurement> getRealEarInsertionResponse() {
		if (realEarInsertionResponse == null) {
			realEarInsertionResponse = new EObjectContainmentEList<FrequencyMeasurement>(FrequencyMeasurement.class, this, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_INSERTION_RESPONSE);
		}
	...
	public EList<FrequencyMeasurement> getRealEarAidedResponse() {
		if (realEarAidedResponse == null) {
			realEarAidedResponse = new EObjectContainmentEList<FrequencyMeasurement>(FrequencyMeasurement.class, this, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_AIDED_RESPONSE);
		}
	...
	public EList<InputOutputMeasurement> getInputOutputMeasurement() {
		if (inputOutputMeasurement == null) {
			inputOutputMeasurement = new EObjectContainmentEList<InputOutputMeasurement>(InputOutputMeasurement.class, this, EarPackage.REAL_EAR_DATA_TYPE__INPUT_OUTPUT_MEASUREMENT);
		}
	...
	public EList<HarmonicDistortionMeasurementCurve> getTotalHarmonicDistortionMeasurement() {
		if (totalHarmonicDistortionMeasurement == null) {
			totalHarmonicDistortionMeasurement = new EObjectContainmentEList<HarmonicDistortionMeasurementCurve>(HarmonicDistortionMeasurementCurve.class, this, EarPackage.REAL_EAR_DATA_TYPE__TOTAL_HARMONIC_DISTORTION_MEASUREMENT);
		}
	...
	public EList<OcclusionEffects> getOcclusionMeasurement() {
		if (occlusionMeasurement == null) {
			occlusionMeasurement = new EObjectContainmentEList<OcclusionEffects>(OcclusionEffects.class, this, EarPackage.REAL_EAR_DATA_TYPE__OCCLUSION_MEASUREMENT);
		}
	...
	public NotificationChain basicSetRealEarCoupler(RealEarCouplerDifference newRealEarCoupler, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_COUPLER, oldRealEarCoupler, newRealEarCoupler);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRealEarCoupler(RealEarCouplerDifference newRealEarCoupler) {
		if (newRealEarCoupler != realEarCoupler) {
			...
			if (realEarCoupler != null)
				msgs = ((InternalEObject)realEarCoupler).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_COUPLER, null, msgs);
			if (newRealEarCoupler != null)
				msgs = ((InternalEObject)newRealEarCoupler).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_COUPLER, null, msgs);
			msgs = basicSetRealEarCoupler(newRealEarCoupler, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_COUPLER, newRealEarCoupler, newRealEarCoupler));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.REAL_EAR_DATA_TYPE__TARGETS:
				return ((InternalEList<?>)getTargets()).basicRemove(otherEnd, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_UNAIDED_RESPONSE:
				return basicSetRealEarUnaidedResponse(null, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_OCCLUDED_RESPONSE:
				return basicSetRealEarOccludedResponse(null, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_INSERTION_RESPONSE:
				return ((InternalEList<?>)getRealEarInsertionResponse()).basicRemove(otherEnd, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_AIDED_RESPONSE:
				return ((InternalEList<?>)getRealEarAidedResponse()).basicRemove(otherEnd, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__INPUT_OUTPUT_MEASUREMENT:
				return ((InternalEList<?>)getInputOutputMeasurement()).basicRemove(otherEnd, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__TOTAL_HARMONIC_DISTORTION_MEASUREMENT:
				return ((InternalEList<?>)getTotalHarmonicDistortionMeasurement()).basicRemove(otherEnd, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__OCCLUSION_MEASUREMENT:
				return ((InternalEList<?>)getOcclusionMeasurement()).basicRemove(otherEnd, msgs);
			case EarPackage.REAL_EAR_DATA_TYPE__REAL_EAR_COUPLER:
