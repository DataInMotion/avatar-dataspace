 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HarmonicDistortionMeasurementCurveImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HarmonicDistortionMeasurementCurveImpl#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HarmonicDistortionMeasurementCurveImpl extends MinimalEObjectImpl.Container implements HarmonicDistortionMeasurementCurve {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.HARMONIC_DISTORTION_MEASUREMENT_CURVE;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditions newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditions newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public EList<HarmonicDistortionPoint> getPoint() {
		if (point == null) {
			point = new EObjectContainmentEList<HarmonicDistortionPoint>(HarmonicDistortionPoint.class, this, EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__POINT);
		}
		return point;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case EarPackage.HARMONIC_DISTORTION_MEASUREMENT_CURVE__POINT:
