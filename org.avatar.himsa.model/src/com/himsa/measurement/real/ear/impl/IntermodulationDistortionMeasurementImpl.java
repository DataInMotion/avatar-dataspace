 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.IntermodulationDistortionMeasurementImpl#getMeasurementCondition <em>Measurement Condition</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.IntermodulationDistortionMeasurementImpl#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermodulationDistortionMeasurementImpl extends MinimalEObjectImpl.Container implements IntermodulationDistortionMeasurement {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.INTERMODULATION_DISTORTION_MEASUREMENT;
	}
	...
	public NotificationChain basicSetMeasurementCondition(MeasurementConditions newMeasurementCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__MEASUREMENT_CONDITION, oldMeasurementCondition, newMeasurementCondition);
	...
	public void setMeasurementCondition(MeasurementConditions newMeasurementCondition) {
		if (newMeasurementCondition != measurementCondition) {
			...
			if (measurementCondition != null)
				msgs = ((InternalEObject)measurementCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__MEASUREMENT_CONDITION, null, msgs);
			if (newMeasurementCondition != null)
				msgs = ((InternalEObject)newMeasurementCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__MEASUREMENT_CONDITION, null, msgs);
			msgs = basicSetMeasurementCondition(newMeasurementCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__MEASUREMENT_CONDITION, newMeasurementCondition, newMeasurementCondition));
	}
	...
	public EList<IntermodulationDistortionPoint> getPoint() {
		if (point == null) {
			point = new EObjectContainmentEList<IntermodulationDistortionPoint>(IntermodulationDistortionPoint.class, this, EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__POINT);
		}
		return point;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__MEASUREMENT_CONDITION:
				return basicSetMeasurementCondition(null, msgs);
			case EarPackage.INTERMODULATION_DISTORTION_MEASUREMENT__POINT:
