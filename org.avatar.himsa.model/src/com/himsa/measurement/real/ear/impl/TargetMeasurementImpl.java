 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.TargetMeasurementImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.TargetMeasurementImpl#getLevelStep <em>Level Step</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.TargetMeasurementImpl#getAttackCurve <em>Attack Curve</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.TargetMeasurementImpl#getReleaseCurve <em>Release Curve</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetMeasurementImpl extends MinimalEObjectImpl.Container implements TargetMeasurement {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.TARGET_MEASUREMENT;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditions newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditions newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.TARGET_MEASUREMENT__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.TARGET_MEASUREMENT__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public void setLevelStep(BigDecimal newLevelStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__LEVEL_STEP, oldLevelStep, levelStep));
	}
	...
	public NotificationChain basicSetAttackCurve(TargetCurve newAttackCurve, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__ATTACK_CURVE, oldAttackCurve, newAttackCurve);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAttackCurve(TargetCurve newAttackCurve) {
		if (newAttackCurve != attackCurve) {
			NotificationChain msgs = null;
			if (attackCurve != null)
				msgs = ((InternalEObject)attackCurve).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.TARGET_MEASUREMENT__ATTACK_CURVE, null, msgs);
			if (newAttackCurve != null)
				msgs = ((InternalEObject)newAttackCurve).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.TARGET_MEASUREMENT__ATTACK_CURVE, null, msgs);
			msgs = basicSetAttackCurve(newAttackCurve, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__ATTACK_CURVE, newAttackCurve, newAttackCurve));
	}
	...
	public NotificationChain basicSetReleaseCurve(TargetCurve newReleaseCurve, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__RELEASE_CURVE, oldReleaseCurve, newReleaseCurve);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReleaseCurve(TargetCurve newReleaseCurve) {
		if (newReleaseCurve != releaseCurve) {
			...
			if (releaseCurve != null)
				msgs = ((InternalEObject)releaseCurve).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.TARGET_MEASUREMENT__RELEASE_CURVE, null, msgs);
			if (newReleaseCurve != null)
				msgs = ((InternalEObject)newReleaseCurve).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.TARGET_MEASUREMENT__RELEASE_CURVE, null, msgs);
			msgs = basicSetReleaseCurve(newReleaseCurve, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.TARGET_MEASUREMENT__RELEASE_CURVE, newReleaseCurve, newReleaseCurve));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.TARGET_MEASUREMENT__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case EarPackage.TARGET_MEASUREMENT__ATTACK_CURVE:
				return basicSetAttackCurve(null, msgs);
			case EarPackage.TARGET_MEASUREMENT__RELEASE_CURVE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EarPackage.TARGET_MEASUREMENT__LEVEL_STEP:
				return getLevelStep();
			case EarPackage.TARGET_MEASUREMENT__ATTACK_CURVE:
