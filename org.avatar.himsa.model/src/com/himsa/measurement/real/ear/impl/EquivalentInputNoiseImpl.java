 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.EquivalentInputNoiseImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.EquivalentInputNoiseImpl#getPoint <em>Point</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.EquivalentInputNoiseImpl#getEquivalentRootMeanSquare <em>Equivalent Root Mean Square</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquivalentInputNoiseImpl extends MinimalEObjectImpl.Container implements EquivalentInputNoise {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.EQUIVALENT_INPUT_NOISE;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditions newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.EQUIVALENT_INPUT_NOISE__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditions newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.EQUIVALENT_INPUT_NOISE__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.EQUIVALENT_INPUT_NOISE__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.EQUIVALENT_INPUT_NOISE__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public EList<FrequencyMeasurementPoint> getPoint() {
		if (point == null) {
			point = new EObjectContainmentEList<FrequencyMeasurementPoint>(FrequencyMeasurementPoint.class, this, EarPackage.EQUIVALENT_INPUT_NOISE__POINT);
		}
		return point;
	}
	...
	public void setEquivalentRootMeanSquare(BigDecimal newEquivalentRootMeanSquare) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.EQUIVALENT_INPUT_NOISE__EQUIVALENT_ROOT_MEAN_SQUARE, oldEquivalentRootMeanSquare, equivalentRootMeanSquare));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.EQUIVALENT_INPUT_NOISE__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case EarPackage.EQUIVALENT_INPUT_NOISE__POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EarPackage.EQUIVALENT_INPUT_NOISE__POINT:
				return getPoint();
			case EarPackage.EQUIVALENT_INPUT_NOISE__EQUIVALENT_ROOT_MEAN_SQUARE:
