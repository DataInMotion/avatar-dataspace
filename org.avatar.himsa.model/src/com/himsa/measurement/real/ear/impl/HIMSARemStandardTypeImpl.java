 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HIMSARemStandardTypeImpl#getRealEarData <em>Real Ear Data</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HIMSARemStandardTypeImpl#getPrivateREM <em>Private REM</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HIMSARemStandardTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HIMSARemStandardTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link com.himsa.measurement.real.ear.impl.HIMSARemStandardTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HIMSARemStandardTypeImpl extends MinimalEObjectImpl.Container implements HIMSARemStandardType {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.HIMSA_REM_STANDARD_TYPE;
	}
	...
	public NotificationChain basicSetRealEarData(RealEarDataType newRealEarData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EarPackage.HIMSA_REM_STANDARD_TYPE__REAL_EAR_DATA, oldRealEarData, newRealEarData);
	...
	public void setRealEarData(RealEarDataType newRealEarData) {
		if (newRealEarData != realEarData) {
			...
			if (realEarData != null)
				msgs = ((InternalEObject)realEarData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EarPackage.HIMSA_REM_STANDARD_TYPE__REAL_EAR_DATA, null, msgs);
			if (newRealEarData != null)
				msgs = ((InternalEObject)newRealEarData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EarPackage.HIMSA_REM_STANDARD_TYPE__REAL_EAR_DATA, null, msgs);
			msgs = basicSetRealEarData(newRealEarData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.HIMSA_REM_STANDARD_TYPE__REAL_EAR_DATA, newRealEarData, newRealEarData));
	}
	...
	public void setPrivateREM(byte[] newPrivateREM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.HIMSA_REM_STANDARD_TYPE__PRIVATE_REM, oldPrivateREM, privateREM));
	}
	...
	public void setConvertedFromDataStandard(BigInteger newConvertedFromDataStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.HIMSA_REM_STANDARD_TYPE__CONVERTED_FROM_DATA_STANDARD, oldConvertedFromDataStandard, convertedFromDataStandard));
	}
	...
	public void setValidatedByNOAH(boolean newValidatedByNOAH) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.HIMSA_REM_STANDARD_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, validatedByNOAH, !oldValidatedByNOAHESet));
	}
	...
	public void unsetValidatedByNOAH() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.HIMSA_REM_STANDARD_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, VALIDATED_BY_NOAH_EDEFAULT, oldValidatedByNOAHESet));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EarPackage.HIMSA_REM_STANDARD_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EarPackage.HIMSA_REM_STANDARD_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EarPackage.HIMSA_REM_STANDARD_TYPE__REAL_EAR_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EarPackage.HIMSA_REM_STANDARD_TYPE__PRIVATE_REM:
				return getPrivateREM();
			case EarPackage.HIMSA_REM_STANDARD_TYPE__CONVERTED_FROM_DATA_STANDARD:
				return getConvertedFromDataStandard();
			case EarPackage.HIMSA_REM_STANDARD_TYPE__VALIDATED_BY_NOAH:
				return isValidatedByNOAH();
			case EarPackage.HIMSA_REM_STANDARD_TYPE__VERSION:
				return getVersion();
		}
