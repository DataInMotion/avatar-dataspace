 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.real.ear.impl.TargetMeasurementPointImpl#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetMeasurementPointImpl extends MinimalEObjectImpl.Container implements TargetMeasurementPoint {
	...
	protected EClass eStaticClass() {
		return EarPackage.Literals.TARGET_MEASUREMENT_POINT;
	}
	...
	public EList<BigDecimal> getOutput() {
		if (output == null) {
			output = new EDataTypeEList<BigDecimal>(BigDecimal.class, this, EarPackage.TARGET_MEASUREMENT_POINT__OUTPUT);
		}
		return output;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EarPackage.TARGET_MEASUREMENT_POINT__OUTPUT:
				return getOutput();
		}
