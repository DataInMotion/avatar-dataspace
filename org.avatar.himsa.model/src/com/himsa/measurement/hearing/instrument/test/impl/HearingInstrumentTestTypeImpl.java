...
import com.himsa.measurement.hearing.instrument.test.BatteryCurrentMeasurement;
import com.himsa.measurement.hearing.instrument.test.EquivalentInputNoise;
...
import com.himsa.measurement.hearing.instrument.test.HearingInstrumentTestType;
import com.himsa.measurement.hearing.instrument.test.InputOutputMeasurement;
import com.himsa.measurement.hearing.instrument.test.IntermodulationDistortionMeasurement;
import com.himsa.measurement.hearing.instrument.test.TargetMeasurement;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getSaturationResponse <em>Saturation Response</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getFullOnGain <em>Full On Gain</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getFrequencyResponse <em>Frequency Response</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getBatteryMeasurement <em>Battery Measurement</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getSecondThirdHarmonicDistortion <em>Second Third Harmonic Distortion</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getIntermodulationDistortionMeasurement <em>Intermodulation Distortion Measurement</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getEquivalentInputNoiseMeasurement <em>Equivalent Input Noise Measurement</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getInputOutput <em>Input Output</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getAttackRecoverCurve <em>Attack Recover Curve</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HearingInstrumentTestTypeImpl#getInductionCoil <em>Induction Coil</em>}</li>
 * </ul>
 *
 * @generated
 */
