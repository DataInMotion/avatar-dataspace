 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HarmonicDistortionPointImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HarmonicDistortionPointImpl#getInput <em>Input</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HarmonicDistortionPointImpl#getFx1 <em>Fx1</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HarmonicDistortionPointImpl#getFx2 <em>Fx2</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HarmonicDistortionPointImpl#getFx3 <em>Fx3</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.HarmonicDistortionPointImpl#getThirdHD <em>Third HD</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HarmonicDistortionPointImpl extends MinimalEObjectImpl.Container implements HarmonicDistortionPoint {
	...
	protected EClass eStaticClass() {
		return TestPackage.Literals.HARMONIC_DISTORTION_POINT;
	}
	...
	public void setFrequency(BigInteger newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.HARMONIC_DISTORTION_POINT__FREQUENCY, oldFrequency, frequency));
	}
	...
	public void setInput(BigDecimal newInput) {
		...
		input = newInput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.HARMONIC_DISTORTION_POINT__INPUT, oldInput, input));
	}
	...
	public void setFx1(BigDecimal newFx1) {
		...
		fx1 = newFx1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.HARMONIC_DISTORTION_POINT__FX1, oldFx1, fx1));
	}
	...
	public void setFx2(BigDecimal newFx2) {
		...
		fx2 = newFx2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.HARMONIC_DISTORTION_POINT__FX2, oldFx2, fx2));
	}
	...
	public void setFx3(BigDecimal newFx3) {
		...
		fx3 = newFx3;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.HARMONIC_DISTORTION_POINT__FX3, oldFx3, fx3));
	}
	...
	public void setThirdHD(BigDecimal newThirdHD) {
		...
		thirdHD = newThirdHD;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.HARMONIC_DISTORTION_POINT__THIRD_HD, oldThirdHD, thirdHD));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestPackage.HARMONIC_DISTORTION_POINT__FREQUENCY:
				return getFrequency();
			case TestPackage.HARMONIC_DISTORTION_POINT__INPUT:
				return getInput();
			case TestPackage.HARMONIC_DISTORTION_POINT__FX1:
				return getFx1();
			case TestPackage.HARMONIC_DISTORTION_POINT__FX2:
				return getFx2();
			case TestPackage.HARMONIC_DISTORTION_POINT__FX3:
				return getFx3();
			case TestPackage.HARMONIC_DISTORTION_POINT__THIRD_HD:
				return getThirdHD();
		}
