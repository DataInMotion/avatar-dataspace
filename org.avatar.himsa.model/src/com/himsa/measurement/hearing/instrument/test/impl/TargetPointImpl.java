 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.TargetPointImpl#getTargetFrequency <em>Target Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.TargetPointImpl#getTargetGain <em>Target Gain</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetPointImpl extends MinimalEObjectImpl.Container implements TargetPoint {
	...
	protected EClass eStaticClass() {
		return TestPackage.Literals.TARGET_POINT;
	}
	...
	public void setTargetFrequency(BigInteger newTargetFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.TARGET_POINT__TARGET_FREQUENCY, oldTargetFrequency, targetFrequency));
	}
	...
	public void setTargetGain(BigDecimal newTargetGain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.TARGET_POINT__TARGET_GAIN, oldTargetGain, targetGain));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestPackage.TARGET_POINT__TARGET_FREQUENCY:
				return getTargetFrequency();
			case TestPackage.TARGET_POINT__TARGET_GAIN:
