...
import com.himsa.measurement.hearing.instrument.test.BatteryMeasurementConditions;
import com.himsa.measurement.hearing.instrument.test.BatteryPillType;
import com.himsa.measurement.hearing.instrument.test.BatteryType;
import com.himsa.measurement.hearing.instrument.test.MeasurementIdentification;
import com.himsa.measurement.hearing.instrument.test.MeasurementMode;
import com.himsa.measurement.hearing.instrument.test.SignalOutputType;
import com.himsa.measurement.hearing.instrument.test.SignalType;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getManufacturerCode <em>Manufacturer Code</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getDevTypeCode <em>Dev Type Code</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getSignalType <em>Signal Type</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getSignalOutput <em>Signal Output</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getSignalFrequency <em>Signal Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getBatteryType <em>Battery Type</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getBatteryPillType <em>Battery Pill Type</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getBatteryVoltage <em>Battery Voltage</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getBatteryImpedance <em>Battery Impedance</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#isUseRealEarCoupler <em>Use Real Ear Coupler</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getMeasurementMode <em>Measurement Mode</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.BatteryMeasurementConditionsImpl#getMeasurementIdentification <em>Measurement Identification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BatteryMeasurementConditionsImpl extends MinimalEObjectImpl.Container implements BatteryMeasurementConditions {
	...
	protected EClass eStaticClass() {
		return TestPackage.Literals.BATTERY_MEASUREMENT_CONDITIONS;
	}
	...
	public void setManufacturerCode(BigInteger newManufacturerCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MANUFACTURER_CODE, oldManufacturerCode, manufacturerCode));
	}
	...
	public void setDevTypeCode(BigInteger newDevTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__DEV_TYPE_CODE, oldDevTypeCode, devTypeCode));
	}
	...
	public void setSignalType(SignalType newSignalType) {
		...
		signalTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_TYPE, oldSignalType, signalType, !oldSignalTypeESet));
	}
	...
	public void unsetSignalType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_TYPE, oldSignalType, SIGNAL_TYPE_EDEFAULT, oldSignalTypeESet));
	}
	...
	public void setSignalOutput(SignalOutputType newSignalOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_OUTPUT, oldSignalOutput, signalOutput, !oldSignalOutputESet));
	}
	...
	public void unsetSignalOutput() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_OUTPUT, oldSignalOutput, SIGNAL_OUTPUT_EDEFAULT, oldSignalOutputESet));
	}
	...
	public void setSignalLevel(BigDecimal newSignalLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_LEVEL, oldSignalLevel, signalLevel));
	}
	...
	public void setSignalFrequency(BigInteger newSignalFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_FREQUENCY, oldSignalFrequency, signalFrequency));
	}
	...
	public void setBatteryType(BatteryType newBatteryType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_TYPE, oldBatteryType, batteryType, !oldBatteryTypeESet));
	}
	...
	public void unsetBatteryType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_TYPE, oldBatteryType, BATTERY_TYPE_EDEFAULT, oldBatteryTypeESet));
	}
	...
	public void setBatteryPillType(BatteryPillType newBatteryPillType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_PILL_TYPE, oldBatteryPillType, batteryPillType, !oldBatteryPillTypeESet));
	}
	...
	public void unsetBatteryPillType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_PILL_TYPE, oldBatteryPillType, BATTERY_PILL_TYPE_EDEFAULT, oldBatteryPillTypeESet));
	}
	...
	public void setBatteryVoltage(BigDecimal newBatteryVoltage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_VOLTAGE, oldBatteryVoltage, batteryVoltage));
	}
	...
	public void setBatteryImpedance(BigDecimal newBatteryImpedance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_IMPEDANCE, oldBatteryImpedance, batteryImpedance));
	}
	...
	public void setUseRealEarCoupler(boolean newUseRealEarCoupler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__USE_REAL_EAR_COUPLER, oldUseRealEarCoupler, useRealEarCoupler, !oldUseRealEarCouplerESet));
	}
	...
	public void unsetUseRealEarCoupler() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__USE_REAL_EAR_COUPLER, oldUseRealEarCoupler, USE_REAL_EAR_COUPLER_EDEFAULT, oldUseRealEarCouplerESet));
	}
	...
	public void setMeasurementMode(MeasurementMode newMeasurementMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MEASUREMENT_MODE, oldMeasurementMode, measurementMode, !oldMeasurementModeESet));
	}
	...
	public void unsetMeasurementMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MEASUREMENT_MODE, oldMeasurementMode, MEASUREMENT_MODE_EDEFAULT, oldMeasurementModeESet));
	}
	...
	public void setMeasurementIdentification(MeasurementIdentification newMeasurementIdentification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MEASUREMENT_IDENTIFICATION, oldMeasurementIdentification, measurementIdentification, !oldMeasurementIdentificationESet));
	}
	...
	public void unsetMeasurementIdentification() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MEASUREMENT_IDENTIFICATION, oldMeasurementIdentification, MEASUREMENT_IDENTIFICATION_EDEFAULT, oldMeasurementIdentificationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MANUFACTURER_CODE:
				return getManufacturerCode();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__DEV_TYPE_CODE:
				return getDevTypeCode();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_TYPE:
				return getSignalType();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_OUTPUT:
				return getSignalOutput();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_LEVEL:
				return getSignalLevel();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__SIGNAL_FREQUENCY:
				return getSignalFrequency();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_TYPE:
				return getBatteryType();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_PILL_TYPE:
				return getBatteryPillType();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_VOLTAGE:
				return getBatteryVoltage();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__BATTERY_IMPEDANCE:
				return getBatteryImpedance();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__USE_REAL_EAR_COUPLER:
				return isUseRealEarCoupler();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MEASUREMENT_MODE:
				return getMeasurementMode();
			case TestPackage.BATTERY_MEASUREMENT_CONDITIONS__MEASUREMENT_IDENTIFICATION:
