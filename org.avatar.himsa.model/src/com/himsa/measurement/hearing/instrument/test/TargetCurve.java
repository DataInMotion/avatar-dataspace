 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getCurve <em>Curve</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getResult <em>Result</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getResolution <em>Resolution</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getPreDelay <em>Pre Delay</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getTargetCurve()
...
public interface TargetCurve extends EObject {
	 ...
	 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getTargetCurve_Curve()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getCurve <em>Curve</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getTargetCurve_Result()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getResult <em>Result</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getTargetCurve_Resolution()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" required="true"
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getResolution <em>Resolution</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getTargetCurve_PreDelay()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.Integer" required="true"
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.hearing.instrument.test.TargetCurve#getPreDelay <em>Pre Delay</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
