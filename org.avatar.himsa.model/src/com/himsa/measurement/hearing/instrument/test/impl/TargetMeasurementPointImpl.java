 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.TargetMeasurementPointImpl#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetMeasurementPointImpl extends MinimalEObjectImpl.Container implements TargetMeasurementPoint {
	...
	protected EClass eStaticClass() {
		return TestPackage.Literals.TARGET_MEASUREMENT_POINT;
	}
	...
	public EList<BigDecimal> getOutput() {
		if (output == null) {
			output = new EDataTypeEList<BigDecimal>(BigDecimal.class, this, TestPackage.TARGET_MEASUREMENT_POINT__OUTPUT);
		}
		return output;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestPackage.TARGET_MEASUREMENT_POINT__OUTPUT:
				return getOutput();
		}
