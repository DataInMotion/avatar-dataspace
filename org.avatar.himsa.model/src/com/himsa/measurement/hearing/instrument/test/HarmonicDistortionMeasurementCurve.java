 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.HarmonicDistortionMeasurementCurve#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.HarmonicDistortionMeasurementCurve#getPoint <em>Point</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getHarmonicDistortionMeasurementCurve()
...
public interface HarmonicDistortionMeasurementCurve extends EObject {
	 ...
	 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getHarmonicDistortionMeasurementCurve_MeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.hearing.instrument.test.HarmonicDistortionMeasurementCurve#getMeasurementConditions <em>Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link com.himsa.measurement.hearing.instrument.test.HarmonicDistortionPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see com.himsa.measurement.hearing.instrument.test.TestPackage#getHarmonicDistortionMeasurementCurve_Point()
