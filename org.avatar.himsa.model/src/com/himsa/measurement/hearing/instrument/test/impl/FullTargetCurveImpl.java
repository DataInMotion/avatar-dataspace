...
import com.himsa.measurement.hearing.instrument.test.CouplerType;
import com.himsa.measurement.hearing.instrument.test.FittingRule;
import com.himsa.measurement.hearing.instrument.test.FullTargetCurve;
import com.himsa.measurement.hearing.instrument.test.HearingInstrumentType;
import com.himsa.measurement.hearing.instrument.test.TargetPoint;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getManufacturersCode <em>Manufacturers Code</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getDeviceTypeCode <em>Device Type Code</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getFittingRule <em>Fitting Rule</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getHearingInstrumentType <em>Hearing Instrument Type</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getVentCanalDiameter <em>Vent Canal Diameter</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getVentCanalLength <em>Vent Canal Length</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getReserveGain <em>Reserve Gain</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getCouplerType <em>Coupler Type</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getSignalLevel <em>Signal Level</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link com.himsa.measurement.hearing.instrument.test.impl.FullTargetCurveImpl#getRuleName <em>Rule Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FullTargetCurveImpl extends MinimalEObjectImpl.Container implements FullTargetCurve {
	...
	protected EClass eStaticClass() {
		return TestPackage.Literals.FULL_TARGET_CURVE;
	}
	...
	public void setManufacturersCode(BigInteger newManufacturersCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__MANUFACTURERS_CODE, oldManufacturersCode, manufacturersCode));
	}
	...
	public void setDeviceTypeCode(BigInteger newDeviceTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__DEVICE_TYPE_CODE, oldDeviceTypeCode, deviceTypeCode));
	}
	...
	public void setFittingRule(FittingRule newFittingRule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__FITTING_RULE, oldFittingRule, fittingRule, !oldFittingRuleESet));
	}
	...
	public void unsetFittingRule() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.FULL_TARGET_CURVE__FITTING_RULE, oldFittingRule, FITTING_RULE_EDEFAULT, oldFittingRuleESet));
	}
	...
	public void setHearingInstrumentType(HearingInstrumentType newHearingInstrumentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__HEARING_INSTRUMENT_TYPE, oldHearingInstrumentType, hearingInstrumentType, !oldHearingInstrumentTypeESet));
	}
	...
	public void unsetHearingInstrumentType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.FULL_TARGET_CURVE__HEARING_INSTRUMENT_TYPE, oldHearingInstrumentType, HEARING_INSTRUMENT_TYPE_EDEFAULT, oldHearingInstrumentTypeESet));
	}
	...
	public void setVentCanalDiameter(BigDecimal newVentCanalDiameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__VENT_CANAL_DIAMETER, oldVentCanalDiameter, ventCanalDiameter));
	}
	...
	public void setVentCanalLength(BigDecimal newVentCanalLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__VENT_CANAL_LENGTH, oldVentCanalLength, ventCanalLength));
	}
	...
	public void setReserveGain(BigDecimal newReserveGain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__RESERVE_GAIN, oldReserveGain, reserveGain));
	}
	...
	public void setCouplerType(CouplerType newCouplerType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__COUPLER_TYPE, oldCouplerType, couplerType, !oldCouplerTypeESet));
	}
	...
	public void unsetCouplerType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TestPackage.FULL_TARGET_CURVE__COUPLER_TYPE, oldCouplerType, COUPLER_TYPE_EDEFAULT, oldCouplerTypeESet));
	}
	...
	public void setSignalLevel(BigDecimal newSignalLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__SIGNAL_LEVEL, oldSignalLevel, signalLevel));
	}
	...
	public EList<TargetPoint> getTarget() {
		if (target == null) {
			target = new EObjectContainmentEList<TargetPoint>(TargetPoint.class, this, TestPackage.FULL_TARGET_CURVE__TARGET);
		}
		return target;
	}
	...
	public void setRuleName(String newRuleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.FULL_TARGET_CURVE__RULE_NAME, oldRuleName, ruleName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TestPackage.FULL_TARGET_CURVE__TARGET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestPackage.FULL_TARGET_CURVE__MANUFACTURERS_CODE:
				return getManufacturersCode();
			case TestPackage.FULL_TARGET_CURVE__DEVICE_TYPE_CODE:
				return getDeviceTypeCode();
			case TestPackage.FULL_TARGET_CURVE__FITTING_RULE:
				return getFittingRule();
			case TestPackage.FULL_TARGET_CURVE__HEARING_INSTRUMENT_TYPE:
				return getHearingInstrumentType();
			case TestPackage.FULL_TARGET_CURVE__VENT_CANAL_DIAMETER:
				return getVentCanalDiameter();
			case TestPackage.FULL_TARGET_CURVE__VENT_CANAL_LENGTH:
				return getVentCanalLength();
			case TestPackage.FULL_TARGET_CURVE__RESERVE_GAIN:
				return getReserveGain();
			case TestPackage.FULL_TARGET_CURVE__COUPLER_TYPE:
				return getCouplerType();
			case TestPackage.FULL_TARGET_CURVE__SIGNAL_LEVEL:
				return getSignalLevel();
			case TestPackage.FULL_TARGET_CURVE__TARGET:
				return getTarget();
			case TestPackage.FULL_TARGET_CURVE__RULE_NAME:
				return getRuleName();
		}
