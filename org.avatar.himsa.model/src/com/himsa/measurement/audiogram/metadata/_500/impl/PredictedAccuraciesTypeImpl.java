 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.PredictedAccuraciesTypeImpl#getQualind <em>Qualind</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.PredictedAccuraciesTypeImpl#getNonStandardized <em>Non Standardized</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PredictedAccuraciesTypeImpl extends MinimalEObjectImpl.Container implements PredictedAccuraciesType {
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.PREDICTED_ACCURACIES_TYPE;
	}
	...
	public NotificationChain basicSetQualind(QualindType newQualind, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.PREDICTED_ACCURACIES_TYPE__QUALIND, oldQualind, newQualind);
	...
	public void setQualind(QualindType newQualind) {
		if (newQualind != qualind) {
			...
			if (qualind != null)
				msgs = ((InternalEObject)qualind).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.PREDICTED_ACCURACIES_TYPE__QUALIND, null, msgs);
			if (newQualind != null)
				msgs = ((InternalEObject)newQualind).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.PREDICTED_ACCURACIES_TYPE__QUALIND, null, msgs);
			msgs = basicSetQualind(newQualind, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.PREDICTED_ACCURACIES_TYPE__QUALIND, newQualind, newQualind));
	}
	...
	public NotificationChain basicSetNonStandardized(NonStandardizedType newNonStandardized, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.PREDICTED_ACCURACIES_TYPE__NON_STANDARDIZED, oldNonStandardized, newNonStandardized);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNonStandardized(NonStandardizedType newNonStandardized) {
		if (newNonStandardized != nonStandardized) {
			...
			if (nonStandardized != null)
				msgs = ((InternalEObject)nonStandardized).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.PREDICTED_ACCURACIES_TYPE__NON_STANDARDIZED, null, msgs);
			if (newNonStandardized != null)
				msgs = ((InternalEObject)newNonStandardized).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.PREDICTED_ACCURACIES_TYPE__NON_STANDARDIZED, null, msgs);
			msgs = basicSetNonStandardized(newNonStandardized, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.PREDICTED_ACCURACIES_TYPE__NON_STANDARDIZED, newNonStandardized, newNonStandardized));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _500Package.PREDICTED_ACCURACIES_TYPE__QUALIND:
				return basicSetQualind(null, msgs);
			case _500Package.PREDICTED_ACCURACIES_TYPE__NON_STANDARDIZED:
