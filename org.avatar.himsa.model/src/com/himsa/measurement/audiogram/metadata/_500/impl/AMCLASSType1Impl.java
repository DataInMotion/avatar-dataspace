 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.AMCLASSType1Impl#getSymmetry <em>Symmetry</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.AMCLASSType1Impl#getRightEar <em>Right Ear</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.AMCLASSType1Impl#getLeftEar <em>Left Ear</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AMCLASSType1Impl extends MinimalEObjectImpl.Container implements AMCLASSType1 {
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.AMCLASS_TYPE1;
	}
	...
	public void setSymmetry(SymmetryType newSymmetry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.AMCLASS_TYPE1__SYMMETRY, oldSymmetry, symmetry, !oldSymmetryESet));
	}
	...
	public void unsetSymmetry() {
		...
		symmetryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.AMCLASS_TYPE1__SYMMETRY, oldSymmetry, SYMMETRY_EDEFAULT, oldSymmetryESet));
	}
	...
	public NotificationChain basicSetRightEar(AMCLASSType newRightEar, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.AMCLASS_TYPE1__RIGHT_EAR, oldRightEar, newRightEar);
	...
	public void setRightEar(AMCLASSType newRightEar) {
		if (newRightEar != rightEar) {
			...
			if (rightEar != null)
				msgs = ((InternalEObject)rightEar).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.AMCLASS_TYPE1__RIGHT_EAR, null, msgs);
			if (newRightEar != null)
				msgs = ((InternalEObject)newRightEar).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.AMCLASS_TYPE1__RIGHT_EAR, null, msgs);
			msgs = basicSetRightEar(newRightEar, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.AMCLASS_TYPE1__RIGHT_EAR, newRightEar, newRightEar));
	}
	...
	public NotificationChain basicSetLeftEar(AMCLASSType newLeftEar, NotificationChain msgs) {
		...
		leftEar = newLeftEar;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.AMCLASS_TYPE1__LEFT_EAR, oldLeftEar, newLeftEar);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLeftEar(AMCLASSType newLeftEar) {
		if (newLeftEar != leftEar) {
			NotificationChain msgs = null;
			if (leftEar != null)
				msgs = ((InternalEObject)leftEar).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.AMCLASS_TYPE1__LEFT_EAR, null, msgs);
			if (newLeftEar != null)
				msgs = ((InternalEObject)newLeftEar).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.AMCLASS_TYPE1__LEFT_EAR, null, msgs);
			msgs = basicSetLeftEar(newLeftEar, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.AMCLASS_TYPE1__LEFT_EAR, newLeftEar, newLeftEar));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _500Package.AMCLASS_TYPE1__RIGHT_EAR:
				return basicSetRightEar(null, msgs);
			case _500Package.AMCLASS_TYPE1__LEFT_EAR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _500Package.AMCLASS_TYPE1__SYMMETRY:
				return getSymmetry();
			case _500Package.AMCLASS_TYPE1__RIGHT_EAR:
				return getRightEar();
			case _500Package.AMCLASS_TYPE1__LEFT_EAR:
