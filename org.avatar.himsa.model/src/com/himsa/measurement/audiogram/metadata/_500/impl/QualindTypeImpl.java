 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.QualindTypeImpl#getDefinedValue <em>Defined Value</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.QualindTypeImpl#getDisagree <em>Disagree</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QualindTypeImpl extends MinimalEObjectImpl.Container implements QualindType {
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.QUALIND_TYPE;
	}
	...
	public void setDefinedValue(DefinedValueType1 newDefinedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.QUALIND_TYPE__DEFINED_VALUE, oldDefinedValue, definedValue, !oldDefinedValueESet));
	}
	...
	public void unsetDefinedValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.QUALIND_TYPE__DEFINED_VALUE, oldDefinedValue, DEFINED_VALUE_EDEFAULT, oldDefinedValueESet));
	}
	...
	public void setDisagree(String newDisagree) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.QUALIND_TYPE__DISAGREE, oldDisagree, disagree));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _500Package.QUALIND_TYPE__DEFINED_VALUE:
				return getDefinedValue();
			case _500Package.QUALIND_TYPE__DISAGREE:
				return getDisagree();
		}
