 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.metadata._500.impl.DocumentRootImpl#getHIMSAAudiogramMetadataStandard <em>HIMSA Audiogram Metadata Standard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public HIMSAAudiogramMetadataStandardType getHIMSAAudiogramMetadataStandard() {
		return (HIMSAAudiogramMetadataStandardType)getMixed().get(_500Package.Literals.DOCUMENT_ROOT__HIMSA_AUDIOGRAM_METADATA_STANDARD, true);
	}
	...
	public NotificationChain basicSetHIMSAAudiogramMetadataStandard(HIMSAAudiogramMetadataStandardType newHIMSAAudiogramMetadataStandard, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(_500Package.Literals.DOCUMENT_ROOT__HIMSA_AUDIOGRAM_METADATA_STANDARD, newHIMSAAudiogramMetadataStandard, msgs);
	}
	...
	public void setHIMSAAudiogramMetadataStandard(HIMSAAudiogramMetadataStandardType newHIMSAAudiogramMetadataStandard) {
		((FeatureMap.Internal)getMixed()).set(_500Package.Literals.DOCUMENT_ROOT__HIMSA_AUDIOGRAM_METADATA_STANDARD, newHIMSAAudiogramMetadataStandard);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case _500Package.DOCUMENT_ROOT__HIMSA_AUDIOGRAM_METADATA_STANDARD:
