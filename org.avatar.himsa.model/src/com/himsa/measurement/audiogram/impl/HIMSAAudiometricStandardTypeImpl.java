 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getToneThresholdAudiogram <em>Tone Threshold Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getUncomfortableLevel <em>Uncomfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getMostComfortableLevel <em>Most Comfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getSpeechDiscriminationAudiogram <em>Speech Discrimination Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getSpeechReceptionThresholdAudiogram <em>Speech Reception Threshold Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getSpeechMostComfortableLevel <em>Speech Most Comfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getSpeechUncomfortableLevel <em>Speech Uncomfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getToneNotes <em>Tone Notes</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getSpeechNotes <em>Speech Notes</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getFrequenciesUsedForToneAverage <em>Frequencies Used For Tone Average</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getDecayAudiogram <em>Decay Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getAlternateBinauralLoudnessBalanceAudiogram <em>Alternate Binaural Loudness Balance Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getStengerAudiogram <em>Stenger Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getDifferenceLimenIntensity <em>Difference Limen Intensity</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getDifferenceLimenFrequency <em>Difference Limen Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getShortIncrementSensitivityIndex <em>Short Increment Sensitivity Index</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getPrivateAudiogramData <em>Private Audiogram Data</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.HIMSAAudiometricStandardTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
