...
import com.himsa.measurement.audiogram.AudiogramFactory;
import com.himsa.measurement.audiogram.AudiogramPackage;
import com.himsa.measurement.audiogram.AuxiliaryParameterType;
import com.himsa.measurement.audiogram.DBweightingType;
import com.himsa.measurement.audiogram.HearingInstrumentConditionType;
import com.himsa.measurement.audiogram.PresentationType;
import com.himsa.measurement.audiogram.SignalOutputType;
import com.himsa.measurement.audiogram.SignalType;
import com.himsa.measurement.audiogram.SpeechThresholdType;
import com.himsa.measurement.audiogram.TransducerCalibrationStandardType;
import com.himsa.measurement.audiogram.TransducerType;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusSignalType <em>Stimulus Signal Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingSignalType <em>Masking Signal Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusSignalOutput <em>Stimulus Signal Output</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingSignalOutput <em>Masking Signal Output</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusdBWeighting <em>Stimulusd BWeighting</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingdBWeighting <em>Maskingd BWeighting</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusPresentationType <em>Stimulus Presentation Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingPresentationType <em>Masking Presentation Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusTransducerType <em>Stimulus Transducer Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingTransducerType <em>Masking Transducer Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getTransducerDescription <em>Transducer Description</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusTransducerCalibrationStandard <em>Stimulus Transducer Calibration Standard</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingTransducerCalibrationStandard <em>Masking Transducer Calibration Standard</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getHearingInstrument1Condition <em>Hearing Instrument1 Condition</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getHearingInstrument2Condition <em>Hearing Instrument2 Condition</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getHearingInstrumentDescription <em>Hearing Instrument Description</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusAuxiliary <em>Stimulus Auxiliary</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingAuxiliary <em>Masking Auxiliary</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getWordListName <em>Word List Name</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getAuxiliaryParameterDescription <em>Auxiliary Parameter Description</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getSpeechThresholdType <em>Speech Threshold Type</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusOnTime <em>Stimulus On Time</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingOnTime <em>Masking On Time</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusOffTime <em>Stimulus Off Time</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingOffTime <em>Masking Off Time</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusSiSiParameter <em>Stimulus Si Si Parameter</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingSiSiParameter <em>Masking Si Si Parameter</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusWarbleModulation <em>Stimulus Warble Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingWarbleModulation <em>Masking Warble Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusWarbleModulationSize <em>Stimulus Warble Modulation Size</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingWarbleModulationSize <em>Masking Warble Modulation Size</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusFrequencyModulation <em>Stimulus Frequency Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingFrequencyModulation <em>Masking Frequency Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusAmplitudeModulation <em>Stimulus Amplitude Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingAmplitudeModulation <em>Masking Amplitude Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusPulseModulation <em>Stimulus Pulse Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingPulseModulation <em>Masking Pulse Modulation</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getStimulusPulseCycle <em>Stimulus Pulse Cycle</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.AudioMetricMeasurementConditionsTypeImpl#getMaskingPulseCycle <em>Masking Pulse Cycle</em>}</li>
 * </ul>
 *
 * @generated
 */
