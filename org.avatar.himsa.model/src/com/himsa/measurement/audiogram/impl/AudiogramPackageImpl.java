...
import com.himsa.measurement.audiogram.AlternateBinauralLoudnessBalanceAudiogramType;
...
import com.himsa.measurement.audiogram.DecayAudiogramType;
import com.himsa.measurement.audiogram.DecayPointType;
import com.himsa.measurement.audiogram.DifferenceLimenFrequencyPointType;
import com.himsa.measurement.audiogram.DifferenceLimenFrequencyType;
import com.himsa.measurement.audiogram.DifferenceLimenIntensityPointType;
import com.himsa.measurement.audiogram.DifferenceLimenIntensityType;
import com.himsa.measurement.audiogram.DocumentRoot;
import com.himsa.measurement.audiogram.FrequenciesUsedForToneAverageType;
...
import com.himsa.measurement.audiogram.MostComfortableLevelType;
import com.himsa.measurement.audiogram.PointStatusType;
...
import com.himsa.measurement.audiogram.ShortIncrementSensitivityIndexType;
...
import com.himsa.measurement.audiogram.SpeechMostComfortableLevelType;
...
import com.himsa.measurement.audiogram.SpeechUncomfortableLevelType;
import com.himsa.measurement.audiogram.StengerAudiogramType;
import com.himsa.measurement.audiogram.ToneAverageType;
import com.himsa.measurement.audiogram.TonePointsType;
import com.himsa.measurement.audiogram.ToneThresholdAudiogramType;
...
import com.himsa.measurement.audiogram.UncomfortableLevelType;

import com.himsa.measurement.audiogram._502._502Package;

import com.himsa.measurement.audiogram._502.impl._502PackageImpl;

import com.himsa.measurement.audiogram.util.AudiogramValidator;
 ...
 * @generated
 */
public class AudiogramPackageImpl extends EPackageImpl implements AudiogramPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.himsa.measurement.audiogram.AudiogramPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AudiogramPackageImpl() {
		super(eNS_URI, AudiogramFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link AudiogramPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AudiogramPackage init() {
		if (isInited) return (AudiogramPackage)EPackage.Registry.INSTANCE.getEPackage(AudiogramPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredAudiogramPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		AudiogramPackageImpl theAudiogramPackage = registeredAudiogramPackage instanceof AudiogramPackageImpl ? (AudiogramPackageImpl)registeredAudiogramPackage : new AudiogramPackageImpl();
			...
			(theAudiogramPackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return AudiogramValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theAudiogramPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AudiogramPackage.eNS_URI, theAudiogramPackage);
		return theAudiogramPackage;
	}
	...
	public EAttribute getHIMSAAudiometricStandardType_ConvertedFromDataStandard() {
		return (EAttribute)himsaAudiometricStandardTypeEClass.getEStructuralFeatures().get(17);
	}
	...
	public EAttribute getHIMSAAudiometricStandardType_ValidatedByNOAH() {
		return (EAttribute)himsaAudiometricStandardTypeEClass.getEStructuralFeatures().get(18);
	}
	 ...
	 */
	@Override
	public AudiogramFactory getAudiogramFactory() {
		return (AudiogramFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDecayPointType_StimulusLevel(), this.getStimulusLevelType(), "stimulusLevel", null, 1, 1, DecayPointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDecayPointType_MaskingLevel(), this.getMaskingLevelType2(), "maskingLevel", null, 0, 1, DecayPointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDifferenceLimenFrequencyPointType_MaskingLevel(), this.getMaskingLevelType(), "maskingLevel", null, 0, 1, DifferenceLimenFrequencyPointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDifferenceLimenIntensityPointType_StimulusLevel(), this.getStimulusLevelType2(), "stimulusLevel", null, 1, 1, DifferenceLimenIntensityPointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDifferenceLimenIntensityPointType_MaskingLevel(), this.getMaskingLevelType3(), "maskingLevel", null, 0, 1, DifferenceLimenIntensityPointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHIMSAAudiometricStandardType_Version(), this.getVersionType(), "version", "500", 1, 1, HIMSAAudiometricStandardType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getShortIncrementSensitivityIndexPoint_StimulusLevel(), this.getStimulusLevelType3(), "stimulusLevel", null, 1, 1, ShortIncrementSensitivityIndexPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getShortIncrementSensitivityIndexPoint_MaskingLevel(), this.getMaskingLevelType1(), "maskingLevel", null, 0, 1, ShortIncrementSensitivityIndexPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSpeechScorePointType_StimulusLevel(), this.getStimulusLevelType4(), "stimulusLevel", null, 1, 1, SpeechScorePointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSpeechScorePointType_MaskingLevel(), this.getMaskingLevelType4(), "maskingLevel", null, 0, 1, SpeechScorePointType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTonePointsType_StimulusLevel(), this.getStimulusLevelType5(), "stimulusLevel", null, 1, 1, TonePointsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
