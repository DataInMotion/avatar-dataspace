 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.impl.SpeechMostComfortableLevelTypeImpl#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.impl.SpeechMostComfortableLevelTypeImpl#getSpeechMostComfortablePoint <em>Speech Most Comfortable Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeechMostComfortableLevelTypeImpl extends MinimalEObjectImpl.Container implements SpeechMostComfortableLevelType {
	...
	protected EClass eStaticClass() {
		return AudiogramPackage.Literals.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE;
	}
	...
	public NotificationChain basicSetAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, oldAudMeasurementConditions, newAudMeasurementConditions);
	...
	public void setAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions) {
		if (newAudMeasurementConditions != audMeasurementConditions) {
			...
			if (audMeasurementConditions != null)
				msgs = ((InternalEObject)audMeasurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			if (newAudMeasurementConditions != null)
				msgs = ((InternalEObject)newAudMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetAudMeasurementConditions(newAudMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, newAudMeasurementConditions, newAudMeasurementConditions));
	}
	...
	public NotificationChain basicSetSpeechMostComfortablePoint(SpeechScorePointType newSpeechMostComfortablePoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__SPEECH_MOST_COMFORTABLE_POINT, oldSpeechMostComfortablePoint, newSpeechMostComfortablePoint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpeechMostComfortablePoint(SpeechScorePointType newSpeechMostComfortablePoint) {
		if (newSpeechMostComfortablePoint != speechMostComfortablePoint) {
			...
			if (speechMostComfortablePoint != null)
				msgs = ((InternalEObject)speechMostComfortablePoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__SPEECH_MOST_COMFORTABLE_POINT, null, msgs);
			if (newSpeechMostComfortablePoint != null)
				msgs = ((InternalEObject)newSpeechMostComfortablePoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__SPEECH_MOST_COMFORTABLE_POINT, null, msgs);
			msgs = basicSetSpeechMostComfortablePoint(newSpeechMostComfortablePoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__SPEECH_MOST_COMFORTABLE_POINT, newSpeechMostComfortablePoint, newSpeechMostComfortablePoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS:
				return basicSetAudMeasurementConditions(null, msgs);
			case AudiogramPackage.SPEECH_MOST_COMFORTABLE_LEVEL_TYPE__SPEECH_MOST_COMFORTABLE_POINT:
