...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Alternate Binaural Loudness Balance Audiogram Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.AlternateBinauralLoudnessBalanceAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.AlternateBinauralLoudnessBalanceAudiogramType#getAlternateBinauralLoudnessBalancePoints <em>Alternate Binaural Loudness Balance Points</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram.AudiogramPackage#getAlternateBinauralLoudnessBalanceAudiogramType()
 * @model extendedMetaData="name='AlternateBinauralLoudnessBalanceAudiogram_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface AlternateBinauralLoudnessBalanceAudiogramType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram.AudiogramPackage#getAlternateBinauralLoudnessBalanceAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram.AlternateBinauralLoudnessBalanceAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Alternate Binaural Loudness Balance Points</b></em>' containment reference list.
	 * The list contents are of type {@link com.himsa.measurement.audiogram.TonePointsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Alternate Binaural Loudness Balance Points</em>' containment reference list.
	 * @see com.himsa.measurement.audiogram.AudiogramPackage#getAlternateBinauralLoudnessBalanceAudiogramType_AlternateBinauralLoudnessBalancePoints()
	 * @model containment="true" required="true" upper="192"
	 *        extendedMetaData="kind='element' name='AlternateBinauralLoudnessBalancePoints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<TonePointsType> getAlternateBinauralLoudnessBalancePoints();

} // AlternateBinauralLoudnessBalanceAudiogramType
