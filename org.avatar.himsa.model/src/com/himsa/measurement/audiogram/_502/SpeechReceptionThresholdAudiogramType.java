...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Speech Reception Threshold Audiogram Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.SpeechReceptionThresholdAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.SpeechReceptionThresholdAudiogramType#getSpeechReceptionPoints <em>Speech Reception Points</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechReceptionThresholdAudiogramType()
 * @model extendedMetaData="name='SpeechReceptionThresholdAudiogram_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface SpeechReceptionThresholdAudiogramType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechReceptionThresholdAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram._502.SpeechReceptionThresholdAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Speech Reception Points</b></em>' containment reference list.
	 * The list contents are of type {@link com.himsa.measurement.audiogram._502.SpeechScorePointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Speech Reception Points</em>' containment reference list.
	 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechReceptionThresholdAudiogramType_SpeechReceptionPoints()
	 * @model containment="true" required="true" upper="24"
	 *        extendedMetaData="kind='element' name='SpeechReceptionPoints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<SpeechScorePointType> getSpeechReceptionPoints();

} // SpeechReceptionThresholdAudiogramType
