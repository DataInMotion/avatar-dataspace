...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Short Increment Sensitivity Index Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.ShortIncrementSensitivityIndexType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.ShortIncrementSensitivityIndexType#getShortIncrementSensitivityIndexPoints <em>Short Increment Sensitivity Index Points</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram._502._502Package#getShortIncrementSensitivityIndexType()
 * @model extendedMetaData="name='ShortIncrementSensitivityIndex_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface ShortIncrementSensitivityIndexType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram._502._502Package#getShortIncrementSensitivityIndexType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram._502.ShortIncrementSensitivityIndexType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Short Increment Sensitivity Index Points</b></em>' containment reference list.
	 * The list contents are of type {@link com.himsa.measurement.audiogram._502.ShortIncrementSensitivityIndexPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Short Increment Sensitivity Index Points</em>' containment reference list.
	 * @see com.himsa.measurement.audiogram._502._502Package#getShortIncrementSensitivityIndexType_ShortIncrementSensitivityIndexPoints()
	 * @model containment="true" required="true" upper="24"
	 *        extendedMetaData="kind='element' name='ShortIncrementSensitivityIndexPoints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<ShortIncrementSensitivityIndexPoint> getShortIncrementSensitivityIndexPoints();

} // ShortIncrementSensitivityIndexType
