...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Decay Audiogram Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.DecayAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.DecayAudiogramType#getDecayPoints <em>Decay Points</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram._502._502Package#getDecayAudiogramType()
 * @model extendedMetaData="name='DecayAudiogram_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface DecayAudiogramType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram._502._502Package#getDecayAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram._502.DecayAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Decay Points</b></em>' containment reference list.
	 * The list contents are of type {@link com.himsa.measurement.audiogram._502.DecayPointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Decay Points</em>' containment reference list.
	 * @see com.himsa.measurement.audiogram._502._502Package#getDecayAudiogramType_DecayPoints()
	 * @model containment="true" required="true" upper="50"
	 *        extendedMetaData="kind='element' name='DecayPoints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<DecayPointType> getDecayPoints();
