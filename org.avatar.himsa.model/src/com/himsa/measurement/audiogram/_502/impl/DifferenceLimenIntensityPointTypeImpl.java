...
import com.himsa.measurement.audiogram._502.DifferenceLimenIntensityPointType;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getModulationSize <em>Modulation Size</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getDifferenceLimenIntensityPointStatus <em>Difference Limen Intensity Point Status</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityPointTypeImpl#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DifferenceLimenIntensityPointTypeImpl extends MinimalEObjectImpl.Container implements DifferenceLimenIntensityPointType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE;
	}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setMaskingFrequency(BigInteger newMaskingFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__MASKING_FREQUENCY, oldMaskingFrequency, maskingFrequency));
	}
	...
	public void setMaskingLevel(BigDecimal newMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__MASKING_LEVEL, oldMaskingLevel, maskingLevel));
	}
	...
	public void setModulationSize(BigDecimal newModulationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__MODULATION_SIZE, oldModulationSize, modulationSize));
	}
	...
	public void setDifferenceLimenIntensityPointStatus(PointStatusType newDifferenceLimenIntensityPointStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__DIFFERENCE_LIMEN_INTENSITY_POINT_STATUS, oldDifferenceLimenIntensityPointStatus, differenceLimenIntensityPointStatus, !oldDifferenceLimenIntensityPointStatusESet));
	}
	...
	public void unsetDifferenceLimenIntensityPointStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__DIFFERENCE_LIMEN_INTENSITY_POINT_STATUS, oldDifferenceLimenIntensityPointStatus, DIFFERENCE_LIMEN_INTENSITY_POINT_STATUS_EDEFAULT, oldDifferenceLimenIntensityPointStatusESet));
	}
	...
	public NotificationChain basicSetAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__ADDITIONAL_MASKING_POINT, oldAdditionalMaskingPoint, newAdditionalMaskingPoint);
	...
	public void setAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint) {
		if (newAdditionalMaskingPoint != additionalMaskingPoint) {
			...
			if (additionalMaskingPoint != null)
				msgs = ((InternalEObject)additionalMaskingPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			if (newAdditionalMaskingPoint != null)
				msgs = ((InternalEObject)newAdditionalMaskingPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			msgs = basicSetAdditionalMaskingPoint(newAdditionalMaskingPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__ADDITIONAL_MASKING_POINT, newAdditionalMaskingPoint, newAdditionalMaskingPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__ADDITIONAL_MASKING_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__STIMULUS_LEVEL:
				return getStimulusLevel();
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__MASKING_FREQUENCY:
				return getMaskingFrequency();
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__MASKING_LEVEL:
				return getMaskingLevel();
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__MODULATION_SIZE:
				return getModulationSize();
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_POINT_TYPE__DIFFERENCE_LIMEN_INTENSITY_POINT_STATUS:
