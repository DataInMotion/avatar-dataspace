 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.WeberPointsTypeImpl#getWeberPoint <em>Weber Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeberPointsTypeImpl extends MinimalEObjectImpl.Container implements WeberPointsType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.WEBER_POINTS_TYPE;
	}
	...
	public EList<WeberPointType> getWeberPoint() {
		if (weberPoint == null) {
			weberPoint = new EObjectContainmentEList<WeberPointType>(WeberPointType.class, this, _502Package.WEBER_POINTS_TYPE__WEBER_POINT);
		}
		return weberPoint;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.WEBER_POINTS_TYPE__WEBER_POINT:
