 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityTypeImpl#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DifferenceLimenIntensityTypeImpl#getDifferenceLimenIntensityPoints <em>Difference Limen Intensity Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DifferenceLimenIntensityTypeImpl extends MinimalEObjectImpl.Container implements DifferenceLimenIntensityType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.DIFFERENCE_LIMEN_INTENSITY_TYPE;
	}
	...
	public NotificationChain basicSetAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__AUD_MEASUREMENT_CONDITIONS, oldAudMeasurementConditions, newAudMeasurementConditions);
	...
	public void setAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions) {
		if (newAudMeasurementConditions != audMeasurementConditions) {
			...
			if (audMeasurementConditions != null)
				msgs = ((InternalEObject)audMeasurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			if (newAudMeasurementConditions != null)
				msgs = ((InternalEObject)newAudMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetAudMeasurementConditions(newAudMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__AUD_MEASUREMENT_CONDITIONS, newAudMeasurementConditions, newAudMeasurementConditions));
	}
	...
	public EList<DifferenceLimenIntensityPointType> getDifferenceLimenIntensityPoints() {
		if (differenceLimenIntensityPoints == null) {
			differenceLimenIntensityPoints = new EObjectContainmentEList<DifferenceLimenIntensityPointType>(DifferenceLimenIntensityPointType.class, this, _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__DIFFERENCE_LIMEN_INTENSITY_POINTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__AUD_MEASUREMENT_CONDITIONS:
				return basicSetAudMeasurementConditions(null, msgs);
			case _502Package.DIFFERENCE_LIMEN_INTENSITY_TYPE__DIFFERENCE_LIMEN_INTENSITY_POINTS:
