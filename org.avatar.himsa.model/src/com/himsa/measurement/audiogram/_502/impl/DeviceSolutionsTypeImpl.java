 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DeviceSolutionsTypeImpl#getRightEarDevice <em>Right Ear Device</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DeviceSolutionsTypeImpl#getLeftEarDevice <em>Left Ear Device</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceSolutionsTypeImpl extends MinimalEObjectImpl.Container implements DeviceSolutionsType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.DEVICE_SOLUTIONS_TYPE;
	}
	...
	public void setRightEarDevice(AidedSolutionsType newRightEarDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DEVICE_SOLUTIONS_TYPE__RIGHT_EAR_DEVICE, oldRightEarDevice, rightEarDevice, !oldRightEarDeviceESet));
	}
	...
	public void unsetRightEarDevice() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.DEVICE_SOLUTIONS_TYPE__RIGHT_EAR_DEVICE, oldRightEarDevice, RIGHT_EAR_DEVICE_EDEFAULT, oldRightEarDeviceESet));
	}
	...
	public void setLeftEarDevice(AidedSolutionsType newLeftEarDevice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DEVICE_SOLUTIONS_TYPE__LEFT_EAR_DEVICE, oldLeftEarDevice, leftEarDevice, !oldLeftEarDeviceESet));
	}
	...
	public void unsetLeftEarDevice() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.DEVICE_SOLUTIONS_TYPE__LEFT_EAR_DEVICE, oldLeftEarDevice, LEFT_EAR_DEVICE_EDEFAULT, oldLeftEarDeviceESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.DEVICE_SOLUTIONS_TYPE__RIGHT_EAR_DEVICE:
				return getRightEarDevice();
			case _502Package.DEVICE_SOLUTIONS_TYPE__LEFT_EAR_DEVICE:
