 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechScorePointTypeImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechScorePointTypeImpl#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechScorePointTypeImpl#getScorePercent <em>Score Percent</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechScorePointTypeImpl#getNumberOfWords <em>Number Of Words</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechScorePointTypeImpl#getSpeechPointStatus <em>Speech Point Status</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechScorePointTypeImpl#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeechScorePointTypeImpl extends MinimalEObjectImpl.Container implements SpeechScorePointType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.SPEECH_SCORE_POINT_TYPE;
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setMaskingLevel(BigDecimal newMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__MASKING_LEVEL, oldMaskingLevel, maskingLevel));
	}
	...
	public void setScorePercent(BigDecimal newScorePercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__SCORE_PERCENT, oldScorePercent, scorePercent));
	}
	...
	public void setNumberOfWords(BigInteger newNumberOfWords) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__NUMBER_OF_WORDS, oldNumberOfWords, numberOfWords));
	}
	...
	public void setSpeechPointStatus(PointStatusType newSpeechPointStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__SPEECH_POINT_STATUS, oldSpeechPointStatus, speechPointStatus, !oldSpeechPointStatusESet));
	}
	...
	public void unsetSpeechPointStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.SPEECH_SCORE_POINT_TYPE__SPEECH_POINT_STATUS, oldSpeechPointStatus, SPEECH_POINT_STATUS_EDEFAULT, oldSpeechPointStatusESet));
	}
	...
	public NotificationChain basicSetAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__ADDITIONAL_MASKING_POINT, oldAdditionalMaskingPoint, newAdditionalMaskingPoint);
	...
	public void setAdditionalMaskingPoint(AdditionalMaskingType newAdditionalMaskingPoint) {
		if (newAdditionalMaskingPoint != additionalMaskingPoint) {
			...
			if (additionalMaskingPoint != null)
				msgs = ((InternalEObject)additionalMaskingPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.SPEECH_SCORE_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			if (newAdditionalMaskingPoint != null)
				msgs = ((InternalEObject)newAdditionalMaskingPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.SPEECH_SCORE_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			msgs = basicSetAdditionalMaskingPoint(newAdditionalMaskingPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_SCORE_POINT_TYPE__ADDITIONAL_MASKING_POINT, newAdditionalMaskingPoint, newAdditionalMaskingPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.SPEECH_SCORE_POINT_TYPE__ADDITIONAL_MASKING_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.SPEECH_SCORE_POINT_TYPE__STIMULUS_LEVEL:
				return getStimulusLevel();
			case _502Package.SPEECH_SCORE_POINT_TYPE__MASKING_LEVEL:
				return getMaskingLevel();
			case _502Package.SPEECH_SCORE_POINT_TYPE__SCORE_PERCENT:
				return getScorePercent();
			case _502Package.SPEECH_SCORE_POINT_TYPE__NUMBER_OF_WORDS:
				return getNumberOfWords();
			case _502Package.SPEECH_SCORE_POINT_TYPE__SPEECH_POINT_STATUS:
