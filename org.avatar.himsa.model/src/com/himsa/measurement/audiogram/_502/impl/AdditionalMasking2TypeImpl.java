 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.AdditionalMasking2TypeImpl#getAdditionalStimulusLevel <em>Additional Stimulus Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.AdditionalMasking2TypeImpl#getAdditionalMaskingLevel <em>Additional Masking Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalMasking2TypeImpl extends MinimalEObjectImpl.Container implements AdditionalMasking2Type {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.ADDITIONAL_MASKING2_TYPE;
	}
	...
	public void setAdditionalStimulusLevel(BigDecimal newAdditionalStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.ADDITIONAL_MASKING2_TYPE__ADDITIONAL_STIMULUS_LEVEL, oldAdditionalStimulusLevel, additionalStimulusLevel));
	}
	...
	public void setAdditionalMaskingLevel(BigDecimal newAdditionalMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.ADDITIONAL_MASKING2_TYPE__ADDITIONAL_MASKING_LEVEL, oldAdditionalMaskingLevel, additionalMaskingLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.ADDITIONAL_MASKING2_TYPE__ADDITIONAL_STIMULUS_LEVEL:
				return getAdditionalStimulusLevel();
			case _502Package.ADDITIONAL_MASKING2_TYPE__ADDITIONAL_MASKING_LEVEL:
