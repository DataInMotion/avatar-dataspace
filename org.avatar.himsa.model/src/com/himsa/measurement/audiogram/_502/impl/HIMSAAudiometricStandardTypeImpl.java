...
import com.himsa.measurement.audiogram._502.AlternateBinauralLoudnessBalanceAudiogramType;
import com.himsa.measurement.audiogram._502.DecayAudiogramType;
import com.himsa.measurement.audiogram._502.DifferenceLimenFrequencyType;
import com.himsa.measurement.audiogram._502.DifferenceLimenIntensityType;
import com.himsa.measurement.audiogram._502.FrequenciesUsedForToneAverageType;
import com.himsa.measurement.audiogram._502.HIMSAAudiometricStandardType;
import com.himsa.measurement.audiogram._502.MeasurementNotesType;
import com.himsa.measurement.audiogram._502.MostComfortableLevelType;
import com.himsa.measurement.audiogram._502.ShortIncrementSensitivityIndexType;
import com.himsa.measurement.audiogram._502.SpeechDiscriminationAudiogramType;
import com.himsa.measurement.audiogram._502.SpeechMostComfortableLevelType;
import com.himsa.measurement.audiogram._502.SpeechReceptionThresholdAudiogramType;
import com.himsa.measurement.audiogram._502.SpeechUncomfortableLevelType;
import com.himsa.measurement.audiogram._502.StengerAudiogramType;
import com.himsa.measurement.audiogram._502.SupplementaryDataType;
import com.himsa.measurement.audiogram._502.ToneThresholdAudiogramType;
import com.himsa.measurement.audiogram._502.UncomfortableLevelType;
import com.himsa.measurement.audiogram._502.WeberPointsType;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getToneThresholdAudiogram <em>Tone Threshold Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getUncomfortableLevel <em>Uncomfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getMostComfortableLevel <em>Most Comfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getSpeechDiscriminationAudiogram <em>Speech Discrimination Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getSpeechReceptionThresholdAudiogram <em>Speech Reception Threshold Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getSpeechMostComfortableLevel <em>Speech Most Comfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getSpeechUncomfortableLevel <em>Speech Uncomfortable Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getToneNotes <em>Tone Notes</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getSpeechNotes <em>Speech Notes</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getFrequenciesUsedForToneAverage <em>Frequencies Used For Tone Average</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getDecayAudiogram <em>Decay Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getAlternateBinauralLoudnessBalanceAudiogram <em>Alternate Binaural Loudness Balance Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getStengerAudiogram <em>Stenger Audiogram</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getDifferenceLimenIntensity <em>Difference Limen Intensity</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getDifferenceLimenFrequency <em>Difference Limen Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getShortIncrementSensitivityIndex <em>Short Increment Sensitivity Index</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getPrivateAudiogramData <em>Private Audiogram Data</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getWeberPoints <em>Weber Points</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getSupplementaryData <em>Supplementary Data</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.HIMSAAudiometricStandardTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HIMSAAudiometricStandardTypeImpl extends MinimalEObjectImpl.Container implements HIMSAAudiometricStandardType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.HIMSA_AUDIOMETRIC_STANDARD_TYPE;
	}
	...
	public EList<ToneThresholdAudiogramType> getToneThresholdAudiogram() {
		if (toneThresholdAudiogram == null) {
			toneThresholdAudiogram = new EObjectContainmentEList<ToneThresholdAudiogramType>(ToneThresholdAudiogramType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_THRESHOLD_AUDIOGRAM);
		}
	...
	public EList<UncomfortableLevelType> getUncomfortableLevel() {
		if (uncomfortableLevel == null) {
			uncomfortableLevel = new EObjectContainmentEList<UncomfortableLevelType>(UncomfortableLevelType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__UNCOMFORTABLE_LEVEL);
		}
	...
	public EList<MostComfortableLevelType> getMostComfortableLevel() {
		if (mostComfortableLevel == null) {
			mostComfortableLevel = new EObjectContainmentEList<MostComfortableLevelType>(MostComfortableLevelType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__MOST_COMFORTABLE_LEVEL);
		}
	...
	public EList<SpeechDiscriminationAudiogramType> getSpeechDiscriminationAudiogram() {
		if (speechDiscriminationAudiogram == null) {
			speechDiscriminationAudiogram = new EObjectContainmentEList<SpeechDiscriminationAudiogramType>(SpeechDiscriminationAudiogramType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_DISCRIMINATION_AUDIOGRAM);
		}
	...
	public EList<SpeechReceptionThresholdAudiogramType> getSpeechReceptionThresholdAudiogram() {
		if (speechReceptionThresholdAudiogram == null) {
			speechReceptionThresholdAudiogram = new EObjectContainmentEList<SpeechReceptionThresholdAudiogramType>(SpeechReceptionThresholdAudiogramType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM);
		}
	...
	public EList<SpeechMostComfortableLevelType> getSpeechMostComfortableLevel() {
		if (speechMostComfortableLevel == null) {
			speechMostComfortableLevel = new EObjectContainmentEList<SpeechMostComfortableLevelType>(SpeechMostComfortableLevelType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_MOST_COMFORTABLE_LEVEL);
		}
	...
	public EList<SpeechUncomfortableLevelType> getSpeechUncomfortableLevel() {
		if (speechUncomfortableLevel == null) {
			speechUncomfortableLevel = new EObjectContainmentEList<SpeechUncomfortableLevelType>(SpeechUncomfortableLevelType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_UNCOMFORTABLE_LEVEL);
		}
	...
	public NotificationChain basicSetToneNotes(MeasurementNotesType newToneNotes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_NOTES, oldToneNotes, newToneNotes);
	...
	public void setToneNotes(MeasurementNotesType newToneNotes) {
		if (newToneNotes != toneNotes) {
			...
			if (toneNotes != null)
				msgs = ((InternalEObject)toneNotes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_NOTES, null, msgs);
			if (newToneNotes != null)
				msgs = ((InternalEObject)newToneNotes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_NOTES, null, msgs);
			msgs = basicSetToneNotes(newToneNotes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_NOTES, newToneNotes, newToneNotes));
	}
	...
	public NotificationChain basicSetSpeechNotes(MeasurementNotesType newSpeechNotes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_NOTES, oldSpeechNotes, newSpeechNotes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpeechNotes(MeasurementNotesType newSpeechNotes) {
		if (newSpeechNotes != speechNotes) {
			NotificationChain msgs = null;
			if (speechNotes != null)
				msgs = ((InternalEObject)speechNotes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_NOTES, null, msgs);
			if (newSpeechNotes != null)
				msgs = ((InternalEObject)newSpeechNotes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_NOTES, null, msgs);
			msgs = basicSetSpeechNotes(newSpeechNotes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_NOTES, newSpeechNotes, newSpeechNotes));
	}
	...
	public NotificationChain basicSetFrequenciesUsedForToneAverage(FrequenciesUsedForToneAverageType newFrequenciesUsedForToneAverage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__FREQUENCIES_USED_FOR_TONE_AVERAGE, oldFrequenciesUsedForToneAverage, newFrequenciesUsedForToneAverage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFrequenciesUsedForToneAverage(FrequenciesUsedForToneAverageType newFrequenciesUsedForToneAverage) {
		if (newFrequenciesUsedForToneAverage != frequenciesUsedForToneAverage) {
			...
			if (frequenciesUsedForToneAverage != null)
				msgs = ((InternalEObject)frequenciesUsedForToneAverage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__FREQUENCIES_USED_FOR_TONE_AVERAGE, null, msgs);
			if (newFrequenciesUsedForToneAverage != null)
				msgs = ((InternalEObject)newFrequenciesUsedForToneAverage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__FREQUENCIES_USED_FOR_TONE_AVERAGE, null, msgs);
			msgs = basicSetFrequenciesUsedForToneAverage(newFrequenciesUsedForToneAverage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__FREQUENCIES_USED_FOR_TONE_AVERAGE, newFrequenciesUsedForToneAverage, newFrequenciesUsedForToneAverage));
	}
	...
	public EList<DecayAudiogramType> getDecayAudiogram() {
		if (decayAudiogram == null) {
			decayAudiogram = new EObjectContainmentEList<DecayAudiogramType>(DecayAudiogramType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__DECAY_AUDIOGRAM);
		}
	...
	public NotificationChain basicSetAlternateBinauralLoudnessBalanceAudiogram(AlternateBinauralLoudnessBalanceAudiogramType newAlternateBinauralLoudnessBalanceAudiogram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__ALTERNATE_BINAURAL_LOUDNESS_BALANCE_AUDIOGRAM, oldAlternateBinauralLoudnessBalanceAudiogram, newAlternateBinauralLoudnessBalanceAudiogram);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAlternateBinauralLoudnessBalanceAudiogram(AlternateBinauralLoudnessBalanceAudiogramType newAlternateBinauralLoudnessBalanceAudiogram) {
		if (newAlternateBinauralLoudnessBalanceAudiogram != alternateBinauralLoudnessBalanceAudiogram) {
			...
			if (alternateBinauralLoudnessBalanceAudiogram != null)
				msgs = ((InternalEObject)alternateBinauralLoudnessBalanceAudiogram).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__ALTERNATE_BINAURAL_LOUDNESS_BALANCE_AUDIOGRAM, null, msgs);
			if (newAlternateBinauralLoudnessBalanceAudiogram != null)
				msgs = ((InternalEObject)newAlternateBinauralLoudnessBalanceAudiogram).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__ALTERNATE_BINAURAL_LOUDNESS_BALANCE_AUDIOGRAM, null, msgs);
			msgs = basicSetAlternateBinauralLoudnessBalanceAudiogram(newAlternateBinauralLoudnessBalanceAudiogram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__ALTERNATE_BINAURAL_LOUDNESS_BALANCE_AUDIOGRAM, newAlternateBinauralLoudnessBalanceAudiogram, newAlternateBinauralLoudnessBalanceAudiogram));
	}
	...
	public NotificationChain basicSetStengerAudiogram(StengerAudiogramType newStengerAudiogram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__STENGER_AUDIOGRAM, oldStengerAudiogram, newStengerAudiogram);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStengerAudiogram(StengerAudiogramType newStengerAudiogram) {
		if (newStengerAudiogram != stengerAudiogram) {
			...
			if (stengerAudiogram != null)
				msgs = ((InternalEObject)stengerAudiogram).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__STENGER_AUDIOGRAM, null, msgs);
			if (newStengerAudiogram != null)
				msgs = ((InternalEObject)newStengerAudiogram).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__STENGER_AUDIOGRAM, null, msgs);
			msgs = basicSetStengerAudiogram(newStengerAudiogram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__STENGER_AUDIOGRAM, newStengerAudiogram, newStengerAudiogram));
	}
	...
	public EList<DifferenceLimenIntensityType> getDifferenceLimenIntensity() {
		if (differenceLimenIntensity == null) {
			differenceLimenIntensity = new EObjectContainmentEList<DifferenceLimenIntensityType>(DifferenceLimenIntensityType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__DIFFERENCE_LIMEN_INTENSITY);
		}
	...
	public EList<DifferenceLimenFrequencyType> getDifferenceLimenFrequency() {
		if (differenceLimenFrequency == null) {
			differenceLimenFrequency = new EObjectContainmentEList<DifferenceLimenFrequencyType>(DifferenceLimenFrequencyType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__DIFFERENCE_LIMEN_FREQUENCY);
		}
	...
	public EList<ShortIncrementSensitivityIndexType> getShortIncrementSensitivityIndex() {
		if (shortIncrementSensitivityIndex == null) {
			shortIncrementSensitivityIndex = new EObjectContainmentEList<ShortIncrementSensitivityIndexType>(ShortIncrementSensitivityIndexType.class, this, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SHORT_INCREMENT_SENSITIVITY_INDEX);
		}
	...
	public void setPrivateAudiogramData(byte[] newPrivateAudiogramData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__PRIVATE_AUDIOGRAM_DATA, oldPrivateAudiogramData, privateAudiogramData));
	}
	...
	public NotificationChain basicSetWeberPoints(WeberPointsType newWeberPoints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__WEBER_POINTS, oldWeberPoints, newWeberPoints);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWeberPoints(WeberPointsType newWeberPoints) {
		if (newWeberPoints != weberPoints) {
			NotificationChain msgs = null;
			if (weberPoints != null)
				msgs = ((InternalEObject)weberPoints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__WEBER_POINTS, null, msgs);
			if (newWeberPoints != null)
				msgs = ((InternalEObject)newWeberPoints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__WEBER_POINTS, null, msgs);
			msgs = basicSetWeberPoints(newWeberPoints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__WEBER_POINTS, newWeberPoints, newWeberPoints));
	}
	...
	public NotificationChain basicSetSupplementaryData(SupplementaryDataType newSupplementaryData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SUPPLEMENTARY_DATA, oldSupplementaryData, newSupplementaryData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupplementaryData(SupplementaryDataType newSupplementaryData) {
		if (newSupplementaryData != supplementaryData) {
			...
			if (supplementaryData != null)
				msgs = ((InternalEObject)supplementaryData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SUPPLEMENTARY_DATA, null, msgs);
			if (newSupplementaryData != null)
				msgs = ((InternalEObject)newSupplementaryData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SUPPLEMENTARY_DATA, null, msgs);
			msgs = basicSetSupplementaryData(newSupplementaryData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SUPPLEMENTARY_DATA, newSupplementaryData, newSupplementaryData));
	}
	...
	public void setConvertedFromDataStandard(BigInteger newConvertedFromDataStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__CONVERTED_FROM_DATA_STANDARD, oldConvertedFromDataStandard, convertedFromDataStandard));
	}
	...
	public void setValidatedByNOAH(boolean newValidatedByNOAH) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, validatedByNOAH, !oldValidatedByNOAHESet));
	}
	...
	public void unsetValidatedByNOAH() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, VALIDATED_BY_NOAH_EDEFAULT, oldValidatedByNOAHESet));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_THRESHOLD_AUDIOGRAM:
				return ((InternalEList<?>)getToneThresholdAudiogram()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__UNCOMFORTABLE_LEVEL:
				return ((InternalEList<?>)getUncomfortableLevel()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__MOST_COMFORTABLE_LEVEL:
				return ((InternalEList<?>)getMostComfortableLevel()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_DISCRIMINATION_AUDIOGRAM:
				return ((InternalEList<?>)getSpeechDiscriminationAudiogram()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_RECEPTION_THRESHOLD_AUDIOGRAM:
				return ((InternalEList<?>)getSpeechReceptionThresholdAudiogram()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_MOST_COMFORTABLE_LEVEL:
				return ((InternalEList<?>)getSpeechMostComfortableLevel()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_UNCOMFORTABLE_LEVEL:
				return ((InternalEList<?>)getSpeechUncomfortableLevel()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__TONE_NOTES:
				return basicSetToneNotes(null, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SPEECH_NOTES:
				return basicSetSpeechNotes(null, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__FREQUENCIES_USED_FOR_TONE_AVERAGE:
				return basicSetFrequenciesUsedForToneAverage(null, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__DECAY_AUDIOGRAM:
				return ((InternalEList<?>)getDecayAudiogram()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__ALTERNATE_BINAURAL_LOUDNESS_BALANCE_AUDIOGRAM:
				return basicSetAlternateBinauralLoudnessBalanceAudiogram(null, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__STENGER_AUDIOGRAM:
				return basicSetStengerAudiogram(null, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__DIFFERENCE_LIMEN_INTENSITY:
				return ((InternalEList<?>)getDifferenceLimenIntensity()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__DIFFERENCE_LIMEN_FREQUENCY:
				return ((InternalEList<?>)getDifferenceLimenFrequency()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SHORT_INCREMENT_SENSITIVITY_INDEX:
				return ((InternalEList<?>)getShortIncrementSensitivityIndex()).basicRemove(otherEnd, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__WEBER_POINTS:
				return basicSetWeberPoints(null, msgs);
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SUPPLEMENTARY_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__PRIVATE_AUDIOGRAM_DATA:
				return getPrivateAudiogramData();
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__WEBER_POINTS:
				return getWeberPoints();
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__SUPPLEMENTARY_DATA:
				return getSupplementaryData();
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__CONVERTED_FROM_DATA_STANDARD:
				return getConvertedFromDataStandard();
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__VALIDATED_BY_NOAH:
				return isValidatedByNOAH();
			case _502Package.HIMSA_AUDIOMETRIC_STANDARD_TYPE__VERSION:
				return getVersion();
		}
