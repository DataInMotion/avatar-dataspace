 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.DecayPointTypeImpl#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecayPointTypeImpl extends MinimalEObjectImpl.Container implements DecayPointType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.DECAY_POINT_TYPE;
	}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setMaskingFrequency(BigInteger newMaskingFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__MASKING_FREQUENCY, oldMaskingFrequency, maskingFrequency));
	}
	...
	public void setMaskingLevel(BigDecimal newMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__MASKING_LEVEL, oldMaskingLevel, maskingLevel));
	}
	...
	public void setStartTime(BigDecimal newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__START_TIME, oldStartTime, startTime));
	}
	...
	public void setEndTime(BigDecimal newEndTime) {
		...
		endTime = newEndTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__END_TIME, oldEndTime, endTime));
	}
	...
	public NotificationChain basicSetAdditionalMaskingPoint(AdditionalMasking2Type newAdditionalMaskingPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__ADDITIONAL_MASKING_POINT, oldAdditionalMaskingPoint, newAdditionalMaskingPoint);
	...
	public void setAdditionalMaskingPoint(AdditionalMasking2Type newAdditionalMaskingPoint) {
		if (newAdditionalMaskingPoint != additionalMaskingPoint) {
			...
			if (additionalMaskingPoint != null)
				msgs = ((InternalEObject)additionalMaskingPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.DECAY_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			if (newAdditionalMaskingPoint != null)
				msgs = ((InternalEObject)newAdditionalMaskingPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.DECAY_POINT_TYPE__ADDITIONAL_MASKING_POINT, null, msgs);
			msgs = basicSetAdditionalMaskingPoint(newAdditionalMaskingPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.DECAY_POINT_TYPE__ADDITIONAL_MASKING_POINT, newAdditionalMaskingPoint, newAdditionalMaskingPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.DECAY_POINT_TYPE__ADDITIONAL_MASKING_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.DECAY_POINT_TYPE__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case _502Package.DECAY_POINT_TYPE__STIMULUS_LEVEL:
				return getStimulusLevel();
			case _502Package.DECAY_POINT_TYPE__MASKING_FREQUENCY:
				return getMaskingFrequency();
			case _502Package.DECAY_POINT_TYPE__MASKING_LEVEL:
				return getMaskingLevel();
			case _502Package.DECAY_POINT_TYPE__START_TIME:
				return getStartTime();
			case _502Package.DECAY_POINT_TYPE__END_TIME:
				return getEndTime();
			case _502Package.DECAY_POINT_TYPE__ADDITIONAL_MASKING_POINT:
