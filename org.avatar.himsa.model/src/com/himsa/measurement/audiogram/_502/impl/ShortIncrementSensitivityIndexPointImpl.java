...
import com.himsa.measurement.audiogram._502.AdditionalMasking2Type;
import com.himsa.measurement.audiogram._502.ShortIncrementSensitivityIndexPoint;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getModulationSize <em>Modulation Size</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getNumberOfAnswers <em>Number Of Answers</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getNumberOfIncrements <em>Number Of Increments</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexPointImpl#getAdditionalMaskingPoint <em>Additional Masking Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShortIncrementSensitivityIndexPointImpl extends MinimalEObjectImpl.Container implements ShortIncrementSensitivityIndexPoint {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT;
	}
	...
	public void setStimulusFrequency(BigInteger newStimulusFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__STIMULUS_FREQUENCY, oldStimulusFrequency, stimulusFrequency));
	}
	...
	public void setStimulusLevel(BigDecimal newStimulusLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__STIMULUS_LEVEL, oldStimulusLevel, stimulusLevel));
	}
	...
	public void setMaskingFrequency(BigInteger newMaskingFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__MASKING_FREQUENCY, oldMaskingFrequency, maskingFrequency));
	}
	...
	public void setMaskingLevel(BigDecimal newMaskingLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__MASKING_LEVEL, oldMaskingLevel, maskingLevel));
	}
	...
	public void setModulationSize(BigDecimal newModulationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__MODULATION_SIZE, oldModulationSize, modulationSize));
	}
	...
	public void setNumberOfAnswers(BigInteger newNumberOfAnswers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__NUMBER_OF_ANSWERS, oldNumberOfAnswers, numberOfAnswers));
	}
	...
	public void setNumberOfIncrements(BigInteger newNumberOfIncrements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__NUMBER_OF_INCREMENTS, oldNumberOfIncrements, numberOfIncrements));
	}
	...
	public NotificationChain basicSetAdditionalMaskingPoint(AdditionalMasking2Type newAdditionalMaskingPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__ADDITIONAL_MASKING_POINT, oldAdditionalMaskingPoint, newAdditionalMaskingPoint);
	...
	public void setAdditionalMaskingPoint(AdditionalMasking2Type newAdditionalMaskingPoint) {
		if (newAdditionalMaskingPoint != additionalMaskingPoint) {
			...
			if (additionalMaskingPoint != null)
				msgs = ((InternalEObject)additionalMaskingPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__ADDITIONAL_MASKING_POINT, null, msgs);
			if (newAdditionalMaskingPoint != null)
				msgs = ((InternalEObject)newAdditionalMaskingPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__ADDITIONAL_MASKING_POINT, null, msgs);
			msgs = basicSetAdditionalMaskingPoint(newAdditionalMaskingPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__ADDITIONAL_MASKING_POINT, newAdditionalMaskingPoint, newAdditionalMaskingPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__ADDITIONAL_MASKING_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__STIMULUS_FREQUENCY:
				return getStimulusFrequency();
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__STIMULUS_LEVEL:
				return getStimulusLevel();
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__MASKING_FREQUENCY:
				return getMaskingFrequency();
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__MASKING_LEVEL:
				return getMaskingLevel();
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__MODULATION_SIZE:
				return getModulationSize();
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__NUMBER_OF_ANSWERS:
				return getNumberOfAnswers();
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_POINT__NUMBER_OF_INCREMENTS:
