 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexTypeImpl#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.ShortIncrementSensitivityIndexTypeImpl#getShortIncrementSensitivityIndexPoints <em>Short Increment Sensitivity Index Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShortIncrementSensitivityIndexTypeImpl extends MinimalEObjectImpl.Container implements ShortIncrementSensitivityIndexType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE;
	}
	...
	public NotificationChain basicSetAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__AUD_MEASUREMENT_CONDITIONS, oldAudMeasurementConditions, newAudMeasurementConditions);
	...
	public void setAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions) {
		if (newAudMeasurementConditions != audMeasurementConditions) {
			...
			if (audMeasurementConditions != null)
				msgs = ((InternalEObject)audMeasurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			if (newAudMeasurementConditions != null)
				msgs = ((InternalEObject)newAudMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetAudMeasurementConditions(newAudMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__AUD_MEASUREMENT_CONDITIONS, newAudMeasurementConditions, newAudMeasurementConditions));
	}
	...
	public EList<ShortIncrementSensitivityIndexPoint> getShortIncrementSensitivityIndexPoints() {
		if (shortIncrementSensitivityIndexPoints == null) {
			shortIncrementSensitivityIndexPoints = new EObjectContainmentEList<ShortIncrementSensitivityIndexPoint>(ShortIncrementSensitivityIndexPoint.class, this, _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__SHORT_INCREMENT_SENSITIVITY_INDEX_POINTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__AUD_MEASUREMENT_CONDITIONS:
				return basicSetAudMeasurementConditions(null, msgs);
			case _502Package.SHORT_INCREMENT_SENSITIVITY_INDEX_TYPE__SHORT_INCREMENT_SENSITIVITY_INDEX_POINTS:
