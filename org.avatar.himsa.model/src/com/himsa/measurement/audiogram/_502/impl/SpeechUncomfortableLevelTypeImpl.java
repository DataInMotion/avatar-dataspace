 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechUncomfortableLevelTypeImpl#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.SpeechUncomfortableLevelTypeImpl#getSpeechUncomfortablePoint <em>Speech Uncomfortable Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeechUncomfortableLevelTypeImpl extends MinimalEObjectImpl.Container implements SpeechUncomfortableLevelType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.SPEECH_UNCOMFORTABLE_LEVEL_TYPE;
	}
	...
	public NotificationChain basicSetAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, oldAudMeasurementConditions, newAudMeasurementConditions);
	...
	public void setAudMeasurementConditions(AudioMetricMeasurementConditionsType newAudMeasurementConditions) {
		if (newAudMeasurementConditions != audMeasurementConditions) {
			...
			if (audMeasurementConditions != null)
				msgs = ((InternalEObject)audMeasurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			if (newAudMeasurementConditions != null)
				msgs = ((InternalEObject)newAudMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetAudMeasurementConditions(newAudMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS, newAudMeasurementConditions, newAudMeasurementConditions));
	}
	...
	public NotificationChain basicSetSpeechUncomfortablePoint(SpeechScorePointType newSpeechUncomfortablePoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__SPEECH_UNCOMFORTABLE_POINT, oldSpeechUncomfortablePoint, newSpeechUncomfortablePoint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpeechUncomfortablePoint(SpeechScorePointType newSpeechUncomfortablePoint) {
		if (newSpeechUncomfortablePoint != speechUncomfortablePoint) {
			...
			if (speechUncomfortablePoint != null)
				msgs = ((InternalEObject)speechUncomfortablePoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__SPEECH_UNCOMFORTABLE_POINT, null, msgs);
			if (newSpeechUncomfortablePoint != null)
				msgs = ((InternalEObject)newSpeechUncomfortablePoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__SPEECH_UNCOMFORTABLE_POINT, null, msgs);
			msgs = basicSetSpeechUncomfortablePoint(newSpeechUncomfortablePoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__SPEECH_UNCOMFORTABLE_POINT, newSpeechUncomfortablePoint, newSpeechUncomfortablePoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__AUD_MEASUREMENT_CONDITIONS:
				return basicSetAudMeasurementConditions(null, msgs);
			case _502Package.SPEECH_UNCOMFORTABLE_LEVEL_TYPE__SPEECH_UNCOMFORTABLE_POINT:
