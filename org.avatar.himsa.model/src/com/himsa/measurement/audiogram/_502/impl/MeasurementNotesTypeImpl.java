 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.MeasurementNotesTypeImpl#getAudiometerMakeModel <em>Audiometer Make Model</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.MeasurementNotesTypeImpl#getAudiometerSerialNumber <em>Audiometer Serial Number</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.MeasurementNotesTypeImpl#getAudiometerLastCalibration <em>Audiometer Last Calibration</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.MeasurementNotesTypeImpl#getTestMethod <em>Test Method</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.MeasurementNotesTypeImpl#getTestReliability <em>Test Reliability</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.impl.MeasurementNotesTypeImpl#getIsDeaf <em>Is Deaf</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementNotesTypeImpl extends MinimalEObjectImpl.Container implements MeasurementNotesType {
	...
	protected EClass eStaticClass() {
		return _502Package.Literals.MEASUREMENT_NOTES_TYPE;
	}
	...
	public void setAudiometerMakeModel(String newAudiometerMakeModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.MEASUREMENT_NOTES_TYPE__AUDIOMETER_MAKE_MODEL, oldAudiometerMakeModel, audiometerMakeModel));
	}
	...
	public void setAudiometerSerialNumber(String newAudiometerSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.MEASUREMENT_NOTES_TYPE__AUDIOMETER_SERIAL_NUMBER, oldAudiometerSerialNumber, audiometerSerialNumber));
	}
	...
	public void setAudiometerLastCalibration(XMLGregorianCalendar newAudiometerLastCalibration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.MEASUREMENT_NOTES_TYPE__AUDIOMETER_LAST_CALIBRATION, oldAudiometerLastCalibration, audiometerLastCalibration));
	}
	...
	public void setTestMethod(String newTestMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.MEASUREMENT_NOTES_TYPE__TEST_METHOD, oldTestMethod, testMethod));
	}
	...
	public void setTestReliability(String newTestReliability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.MEASUREMENT_NOTES_TYPE__TEST_RELIABILITY, oldTestReliability, testReliability));
	}
	...
	public void setIsDeaf(EarType newIsDeaf) {
		...
		isDeafESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _502Package.MEASUREMENT_NOTES_TYPE__IS_DEAF, oldIsDeaf, isDeaf, !oldIsDeafESet));
	}
	...
	public void unsetIsDeaf() {
		...
		isDeafESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _502Package.MEASUREMENT_NOTES_TYPE__IS_DEAF, oldIsDeaf, IS_DEAF_EDEFAULT, oldIsDeafESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _502Package.MEASUREMENT_NOTES_TYPE__AUDIOMETER_MAKE_MODEL:
				return getAudiometerMakeModel();
			case _502Package.MEASUREMENT_NOTES_TYPE__AUDIOMETER_SERIAL_NUMBER:
				return getAudiometerSerialNumber();
			case _502Package.MEASUREMENT_NOTES_TYPE__AUDIOMETER_LAST_CALIBRATION:
				return getAudiometerLastCalibration();
			case _502Package.MEASUREMENT_NOTES_TYPE__TEST_METHOD:
				return getTestMethod();
			case _502Package.MEASUREMENT_NOTES_TYPE__TEST_RELIABILITY:
				return getTestReliability();
			case _502Package.MEASUREMENT_NOTES_TYPE__IS_DEAF:
				return getIsDeaf();
		}
