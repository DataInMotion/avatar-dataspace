...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Speech Most Comfortable Level Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.SpeechMostComfortableLevelType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.SpeechMostComfortableLevelType#getSpeechMostComfortablePoint <em>Speech Most Comfortable Point</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechMostComfortableLevelType()
 * @model extendedMetaData="name='SpeechMostComfortableLevel_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface SpeechMostComfortableLevelType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechMostComfortableLevelType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram._502.SpeechMostComfortableLevelType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Speech Most Comfortable Point</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Speech Most Comfortable Point</em>' containment reference.
	 * @see #setSpeechMostComfortablePoint(SpeechScorePointType)
	 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechMostComfortableLevelType_SpeechMostComfortablePoint()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='SpeechMostComfortablePoint' namespace='##targetNamespace'"
	 * @generated
	 */
	SpeechScorePointType getSpeechMostComfortablePoint();

	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram._502.SpeechMostComfortableLevelType#getSpeechMostComfortablePoint <em>Speech Most Comfortable Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Speech Most Comfortable Point</em>' containment reference.
	 * @see #getSpeechMostComfortablePoint()
	 * @generated
	 */
	void setSpeechMostComfortablePoint(SpeechScorePointType value);

} // SpeechMostComfortableLevelType
