...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Speech Discrimination Audiogram Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram._502.SpeechDiscriminationAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram._502.SpeechDiscriminationAudiogramType#getSpeechDiscriminationPoints <em>Speech Discrimination Points</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechDiscriminationAudiogramType()
 * @model extendedMetaData="name='SpeechDiscriminationAudiogram_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface SpeechDiscriminationAudiogramType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechDiscriminationAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram._502.SpeechDiscriminationAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Speech Discrimination Points</b></em>' containment reference list.
	 * The list contents are of type {@link com.himsa.measurement.audiogram._502.SpeechScorePointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Speech Discrimination Points</em>' containment reference list.
	 * @see com.himsa.measurement.audiogram._502._502Package#getSpeechDiscriminationAudiogramType_SpeechDiscriminationPoints()
	 * @model containment="true" required="true" upper="24"
	 *        extendedMetaData="kind='element' name='SpeechDiscriminationPoints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<SpeechScorePointType> getSpeechDiscriminationPoints();

} // SpeechDiscriminationAudiogramType
