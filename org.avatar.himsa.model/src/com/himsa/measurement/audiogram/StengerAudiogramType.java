...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Stenger Audiogram Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.audiogram.StengerAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.audiogram.StengerAudiogramType#getStengerPoints <em>Stenger Points</em>}</li>
 * </ul>
 *
 * @see com.himsa.measurement.audiogram.AudiogramPackage#getStengerAudiogramType()
 * @model extendedMetaData="name='StengerAudiogram_._type' kind='elementOnly'"
 * @generated
 */
@ProviderType
public interface StengerAudiogramType extends EObject {
	/**
	 ...
	 * @see com.himsa.measurement.audiogram.AudiogramPackage#getStengerAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link com.himsa.measurement.audiogram.StengerAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Stenger Points</b></em>' containment reference list.
	 ...
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Stenger Points</em>' containment reference list.
	 * @see com.himsa.measurement.audiogram.AudiogramPackage#getStengerAudiogramType_StengerPoints()
	 * @model containment="true" required="true" upper="24"
	 *        extendedMetaData="kind='element' name='StengerPoints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<TonePointsType> getStengerPoints();

} // StengerAudiogramType
