...
import com.himsa.measurement.tinnitus._500.MinimumMaskingLevelType;
import com.himsa.measurement.tinnitus._500.ResidualInhibitionType;
import com.himsa.measurement.tinnitus._500.TinnitusLoudnessMatchType;
import com.himsa.measurement.tinnitus._500.TinnitusMeasurementDataType;
import com.himsa.measurement.tinnitus._500.TinnitusMeasurementNotesType;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tinnitus Measurement Data Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getTinnitusMeasurementNotes <em>Tinnitus Measurement Notes</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getTinnitusMeasurementEquipment <em>Tinnitus Measurement Equipment</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getTinnitusPitchMatch <em>Tinnitus Pitch Match</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getTinnitusLoudnessMatch <em>Tinnitus Loudness Match</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getMinimumMaskingLevel <em>Minimum Masking Level</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getResidualInhibition <em>Residual Inhibition</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementDataTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TinnitusMeasurementDataTypeImpl extends MinimalEObjectImpl.Container implements TinnitusMeasurementDataType {
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.TINNITUS_MEASUREMENT_DATA_TYPE;
	}
	...
	public NotificationChain basicSetTinnitusMeasurementNotes(TinnitusMeasurementNotesType newTinnitusMeasurementNotes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_NOTES, oldTinnitusMeasurementNotes, newTinnitusMeasurementNotes);
	...
	public void setTinnitusMeasurementNotes(TinnitusMeasurementNotesType newTinnitusMeasurementNotes) {
		if (newTinnitusMeasurementNotes != tinnitusMeasurementNotes) {
			...
			if (tinnitusMeasurementNotes != null)
				msgs = ((InternalEObject)tinnitusMeasurementNotes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_NOTES, null, msgs);
			if (newTinnitusMeasurementNotes != null)
				msgs = ((InternalEObject)newTinnitusMeasurementNotes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_NOTES, null, msgs);
			msgs = basicSetTinnitusMeasurementNotes(newTinnitusMeasurementNotes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_NOTES, newTinnitusMeasurementNotes, newTinnitusMeasurementNotes));
	}
	...
	public NotificationChain basicSetTinnitusMeasurementEquipment(MeasurementEquipmentType newTinnitusMeasurementEquipment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_EQUIPMENT, oldTinnitusMeasurementEquipment, newTinnitusMeasurementEquipment);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTinnitusMeasurementEquipment(MeasurementEquipmentType newTinnitusMeasurementEquipment) {
		if (newTinnitusMeasurementEquipment != tinnitusMeasurementEquipment) {
			...
			if (tinnitusMeasurementEquipment != null)
				msgs = ((InternalEObject)tinnitusMeasurementEquipment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_EQUIPMENT, null, msgs);
			if (newTinnitusMeasurementEquipment != null)
				msgs = ((InternalEObject)newTinnitusMeasurementEquipment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_EQUIPMENT, null, msgs);
			msgs = basicSetTinnitusMeasurementEquipment(newTinnitusMeasurementEquipment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_EQUIPMENT, newTinnitusMeasurementEquipment, newTinnitusMeasurementEquipment));
	}
	...
	public EList<TinnitusPitchMatchType> getTinnitusPitchMatch() {
		if (tinnitusPitchMatch == null) {
			tinnitusPitchMatch = new EObjectContainmentEList<TinnitusPitchMatchType>(TinnitusPitchMatchType.class, this, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_PITCH_MATCH);
		}
	...
	public EList<TinnitusLoudnessMatchType> getTinnitusLoudnessMatch() {
		if (tinnitusLoudnessMatch == null) {
			tinnitusLoudnessMatch = new EObjectContainmentEList<TinnitusLoudnessMatchType>(TinnitusLoudnessMatchType.class, this, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_LOUDNESS_MATCH);
		}
	...
	public EList<MinimumMaskingLevelType> getMinimumMaskingLevel() {
		if (minimumMaskingLevel == null) {
			minimumMaskingLevel = new EObjectContainmentEList<MinimumMaskingLevelType>(MinimumMaskingLevelType.class, this, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__MINIMUM_MASKING_LEVEL);
		}
	...
	public EList<ResidualInhibitionType> getResidualInhibition() {
		if (residualInhibition == null) {
			residualInhibition = new EObjectContainmentEList<ResidualInhibitionType>(ResidualInhibitionType.class, this, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__RESIDUAL_INHIBITION);
		}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_NOTES:
				return basicSetTinnitusMeasurementNotes(null, msgs);
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_MEASUREMENT_EQUIPMENT:
				return basicSetTinnitusMeasurementEquipment(null, msgs);
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_PITCH_MATCH:
				return ((InternalEList<?>)getTinnitusPitchMatch()).basicRemove(otherEnd, msgs);
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__TINNITUS_LOUDNESS_MATCH:
				return ((InternalEList<?>)getTinnitusLoudnessMatch()).basicRemove(otherEnd, msgs);
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__MINIMUM_MASKING_LEVEL:
				return ((InternalEList<?>)getMinimumMaskingLevel()).basicRemove(otherEnd, msgs);
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__RESIDUAL_INHIBITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _500Package.TINNITUS_MEASUREMENT_DATA_TYPE__VERSION:
				return getVersion();
		}
