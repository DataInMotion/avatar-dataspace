...
import com.himsa.measurement.tinnitus._500.TinnitusTemporalCharacteristicType;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tinnitus Measurement Notes Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementNotesTypeImpl#getTinnitusPerceptionLocation <em>Tinnitus Perception Location</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementNotesTypeImpl#getTinnitusTemporalCharacteristic <em>Tinnitus Temporal Characteristic</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusMeasurementNotesTypeImpl#getOtherMeasurementNotes <em>Other Measurement Notes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TinnitusMeasurementNotesTypeImpl extends MinimalEObjectImpl.Container implements TinnitusMeasurementNotesType {
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.TINNITUS_MEASUREMENT_NOTES_TYPE;
	}
	...
	public void setTinnitusPerceptionLocation(TinnitusPerceptionLocationType newTinnitusPerceptionLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__TINNITUS_PERCEPTION_LOCATION, oldTinnitusPerceptionLocation, tinnitusPerceptionLocation, !oldTinnitusPerceptionLocationESet));
	}
	...
	public void unsetTinnitusPerceptionLocation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__TINNITUS_PERCEPTION_LOCATION, oldTinnitusPerceptionLocation, TINNITUS_PERCEPTION_LOCATION_EDEFAULT, oldTinnitusPerceptionLocationESet));
	}
	...
	public void setTinnitusTemporalCharacteristic(TinnitusTemporalCharacteristicType newTinnitusTemporalCharacteristic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__TINNITUS_TEMPORAL_CHARACTERISTIC, oldTinnitusTemporalCharacteristic, tinnitusTemporalCharacteristic, !oldTinnitusTemporalCharacteristicESet));
	}
	...
	public void unsetTinnitusTemporalCharacteristic() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__TINNITUS_TEMPORAL_CHARACTERISTIC, oldTinnitusTemporalCharacteristic, TINNITUS_TEMPORAL_CHARACTERISTIC_EDEFAULT, oldTinnitusTemporalCharacteristicESet));
	}
	...
	public void setOtherMeasurementNotes(String newOtherMeasurementNotes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__OTHER_MEASUREMENT_NOTES, oldOtherMeasurementNotes, otherMeasurementNotes));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__TINNITUS_PERCEPTION_LOCATION:
				return getTinnitusPerceptionLocation();
			case _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__TINNITUS_TEMPORAL_CHARACTERISTIC:
				return getTinnitusTemporalCharacteristic();
			case _500Package.TINNITUS_MEASUREMENT_NOTES_TYPE__OTHER_MEASUREMENT_NOTES:
