...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tinnitus Loudness Match Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusLoudnessMatchTypeImpl#getMeasurementConditions <em>Measurement Conditions</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusLoudnessMatchTypeImpl#getMeasurementPoint <em>Measurement Point</em>}</li>
 *   <li>{@link com.himsa.measurement.tinnitus._500.impl.TinnitusLoudnessMatchTypeImpl#getMatchingSuccess <em>Matching Success</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TinnitusLoudnessMatchTypeImpl extends MinimalEObjectImpl.Container implements TinnitusLoudnessMatchType {
	/**
	 ...
	 * @generated
	 */
	protected TinnitusLoudnessMatchTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return _500Package.Literals.TINNITUS_LOUDNESS_MATCH_TYPE;
	}
	...
	public NotificationChain basicSetMeasurementConditions(MeasurementConditionsType newMeasurementConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_CONDITIONS, oldMeasurementConditions, newMeasurementConditions);
	...
	public void setMeasurementConditions(MeasurementConditionsType newMeasurementConditions) {
		if (newMeasurementConditions != measurementConditions) {
			...
			if (measurementConditions != null)
				msgs = ((InternalEObject)measurementConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_CONDITIONS, null, msgs);
			if (newMeasurementConditions != null)
				msgs = ((InternalEObject)newMeasurementConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_CONDITIONS, null, msgs);
			msgs = basicSetMeasurementConditions(newMeasurementConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_CONDITIONS, newMeasurementConditions, newMeasurementConditions));
	}
	...
	public NotificationChain basicSetMeasurementPoint(MeasurementIntensityPointType newMeasurementPoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_POINT, oldMeasurementPoint, newMeasurementPoint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementPoint(MeasurementIntensityPointType newMeasurementPoint) {
		if (newMeasurementPoint != measurementPoint) {
			...
			if (measurementPoint != null)
				msgs = ((InternalEObject)measurementPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_POINT, null, msgs);
			if (newMeasurementPoint != null)
				msgs = ((InternalEObject)newMeasurementPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_POINT, null, msgs);
			msgs = basicSetMeasurementPoint(newMeasurementPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_POINT, newMeasurementPoint, newMeasurementPoint));
	}
	...
	public void setMatchingSuccess(TinnitusMatchSucessType newMatchingSuccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MATCHING_SUCCESS, oldMatchingSuccess, matchingSuccess, !oldMatchingSuccessESet));
	}
	...
	public void unsetMatchingSuccess() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MATCHING_SUCCESS, oldMatchingSuccess, MATCHING_SUCCESS_EDEFAULT, oldMatchingSuccessESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_CONDITIONS:
				return basicSetMeasurementConditions(null, msgs);
			case _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MEASUREMENT_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _500Package.TINNITUS_LOUDNESS_MATCH_TYPE__MATCHING_SUCCESS:
