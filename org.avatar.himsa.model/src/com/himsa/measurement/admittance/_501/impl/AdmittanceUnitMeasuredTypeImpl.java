...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Admittance Unit Measured Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AdmittanceUnitMeasuredTypeImpl#getGUnit <em>GUnit</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AdmittanceUnitMeasuredTypeImpl#getBUnit <em>BUnit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdmittanceUnitMeasuredTypeImpl extends MinimalEObjectImpl.Container implements AdmittanceUnitMeasuredType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.ADMITTANCE_UNIT_MEASURED_TYPE;
	}
	...
	public void setGUnit(UnitType newGUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ADMITTANCE_UNIT_MEASURED_TYPE__GUNIT, oldGUnit, gUnit, !oldGUnitESet));
	}
	...
	public void unsetGUnit() {
		...
		gUnitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.ADMITTANCE_UNIT_MEASURED_TYPE__GUNIT, oldGUnit, GUNIT_EDEFAULT, oldGUnitESet));
	}
	...
	public void setBUnit(UnitType newBUnit) {
		...
		bUnitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ADMITTANCE_UNIT_MEASURED_TYPE__BUNIT, oldBUnit, bUnit, !oldBUnitESet));
	}
	...
	public void unsetBUnit() {
		...
		bUnitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.ADMITTANCE_UNIT_MEASURED_TYPE__BUNIT, oldBUnit, BUNIT_EDEFAULT, oldBUnitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.ADMITTANCE_UNIT_MEASURED_TYPE__GUNIT:
				return getGUnit();
			case _501Package.ADMITTANCE_UNIT_MEASURED_TYPE__BUNIT:
				return getBUnit();
		}
