 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.MeasuredType1Impl#getMeasuredAdmittancePoints <em>Measured Admittance Points</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.MeasuredType1Impl#getMeasuredAdmittanceUnit <em>Measured Admittance Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasuredType1Impl extends MinimalEObjectImpl.Container implements MeasuredType1 {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.MEASURED_TYPE1;
	}
	...
	public NotificationChain basicSetMeasuredAdmittancePoints(MeasuredAdmittancePointsType newMeasuredAdmittancePoints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_POINTS, oldMeasuredAdmittancePoints, newMeasuredAdmittancePoints);
	...
	public void setMeasuredAdmittancePoints(MeasuredAdmittancePointsType newMeasuredAdmittancePoints) {
		if (newMeasuredAdmittancePoints != measuredAdmittancePoints) {
			...
			if (measuredAdmittancePoints != null)
				msgs = ((InternalEObject)measuredAdmittancePoints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_POINTS, null, msgs);
			if (newMeasuredAdmittancePoints != null)
				msgs = ((InternalEObject)newMeasuredAdmittancePoints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_POINTS, null, msgs);
			msgs = basicSetMeasuredAdmittancePoints(newMeasuredAdmittancePoints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_POINTS, newMeasuredAdmittancePoints, newMeasuredAdmittancePoints));
	}
	...
	public NotificationChain basicSetMeasuredAdmittanceUnit(AdmittanceUnitMeasuredType newMeasuredAdmittanceUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_UNIT, oldMeasuredAdmittanceUnit, newMeasuredAdmittanceUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasuredAdmittanceUnit(AdmittanceUnitMeasuredType newMeasuredAdmittanceUnit) {
		if (newMeasuredAdmittanceUnit != measuredAdmittanceUnit) {
			...
			if (measuredAdmittanceUnit != null)
				msgs = ((InternalEObject)measuredAdmittanceUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_UNIT, null, msgs);
			if (newMeasuredAdmittanceUnit != null)
				msgs = ((InternalEObject)newMeasuredAdmittanceUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_UNIT, null, msgs);
			msgs = basicSetMeasuredAdmittanceUnit(newMeasuredAdmittanceUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_UNIT, newMeasuredAdmittanceUnit, newMeasuredAdmittanceUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_POINTS:
				return basicSetMeasuredAdmittancePoints(null, msgs);
			case _501Package.MEASURED_TYPE1__MEASURED_ADMITTANCE_UNIT:
