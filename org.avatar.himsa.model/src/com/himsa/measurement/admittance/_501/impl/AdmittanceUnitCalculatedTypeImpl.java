...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Admittance Unit Calculated Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AdmittanceUnitCalculatedTypeImpl#getYUnit <em>YUnit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdmittanceUnitCalculatedTypeImpl extends MinimalEObjectImpl.Container implements AdmittanceUnitCalculatedType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.ADMITTANCE_UNIT_CALCULATED_TYPE;
	}
	...
	public void setYUnit(UnitType newYUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ADMITTANCE_UNIT_CALCULATED_TYPE__YUNIT, oldYUnit, yUnit, !oldYUnitESet));
	}
	...
	public void unsetYUnit() {
		...
		yUnitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.ADMITTANCE_UNIT_CALCULATED_TYPE__YUNIT, oldYUnit, YUNIT_EDEFAULT, oldYUnitESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.ADMITTANCE_UNIT_CALCULATED_TYPE__YUNIT:
				return getYUnit();
		}
