 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.TympanogramMeasurementConditionsTypeImpl#getSweepSpeed <em>Sweep Speed</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.TympanogramMeasurementConditionsTypeImpl#getRecordMode <em>Record Mode</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.TympanogramMeasurementConditionsTypeImpl#getProbeFrequency <em>Probe Frequency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TympanogramMeasurementConditionsTypeImpl extends MinimalEObjectImpl.Container implements TympanogramMeasurementConditionsType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE;
	}
	...
	public void setSweepSpeed(BigInteger newSweepSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__SWEEP_SPEED, oldSweepSpeed, sweepSpeed));
	}
	...
	public void setRecordMode(RecordingModeType newRecordMode) {
		...
		recordModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__RECORD_MODE, oldRecordMode, recordMode, !oldRecordModeESet));
	}
	...
	public void unsetRecordMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__RECORD_MODE, oldRecordMode, RECORD_MODE_EDEFAULT, oldRecordModeESet));
	}
	...
	public NotificationChain basicSetProbeFrequency(ProbeFrequencyType newProbeFrequency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__PROBE_FREQUENCY, oldProbeFrequency, newProbeFrequency);
	...
	public void setProbeFrequency(ProbeFrequencyType newProbeFrequency) {
		if (newProbeFrequency != probeFrequency) {
			...
			if (probeFrequency != null)
				msgs = ((InternalEObject)probeFrequency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__PROBE_FREQUENCY, null, msgs);
			if (newProbeFrequency != null)
				msgs = ((InternalEObject)newProbeFrequency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__PROBE_FREQUENCY, null, msgs);
			msgs = basicSetProbeFrequency(newProbeFrequency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__PROBE_FREQUENCY, newProbeFrequency, newProbeFrequency));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__PROBE_FREQUENCY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__SWEEP_SPEED:
				return getSweepSpeed();
			case _501Package.TYMPANOGRAM_MEASUREMENT_CONDITIONS_TYPE__RECORD_MODE:
