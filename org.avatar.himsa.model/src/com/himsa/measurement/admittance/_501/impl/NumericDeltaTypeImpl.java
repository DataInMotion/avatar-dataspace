 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.NumericDeltaTypeImpl#getNumericDeltaYPoints <em>Numeric Delta YPoints</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.NumericDeltaTypeImpl#getCalculatedAdmittanceUnit <em>Calculated Admittance Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumericDeltaTypeImpl extends MinimalEObjectImpl.Container implements NumericDeltaType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.NUMERIC_DELTA_TYPE;
	}
	...
	public NotificationChain basicSetNumericDeltaYPoints(NumericDeltaYPointsType newNumericDeltaYPoints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.NUMERIC_DELTA_TYPE__NUMERIC_DELTA_YPOINTS, oldNumericDeltaYPoints, newNumericDeltaYPoints);
	...
	public void setNumericDeltaYPoints(NumericDeltaYPointsType newNumericDeltaYPoints) {
		if (newNumericDeltaYPoints != numericDeltaYPoints) {
			...
			if (numericDeltaYPoints != null)
				msgs = ((InternalEObject)numericDeltaYPoints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.NUMERIC_DELTA_TYPE__NUMERIC_DELTA_YPOINTS, null, msgs);
			if (newNumericDeltaYPoints != null)
				msgs = ((InternalEObject)newNumericDeltaYPoints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.NUMERIC_DELTA_TYPE__NUMERIC_DELTA_YPOINTS, null, msgs);
			msgs = basicSetNumericDeltaYPoints(newNumericDeltaYPoints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.NUMERIC_DELTA_TYPE__NUMERIC_DELTA_YPOINTS, newNumericDeltaYPoints, newNumericDeltaYPoints));
	}
	...
	public NotificationChain basicSetCalculatedAdmittanceUnit(AdmittanceUnitCalculatedType newCalculatedAdmittanceUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.NUMERIC_DELTA_TYPE__CALCULATED_ADMITTANCE_UNIT, oldCalculatedAdmittanceUnit, newCalculatedAdmittanceUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalculatedAdmittanceUnit(AdmittanceUnitCalculatedType newCalculatedAdmittanceUnit) {
		if (newCalculatedAdmittanceUnit != calculatedAdmittanceUnit) {
			...
			if (calculatedAdmittanceUnit != null)
				msgs = ((InternalEObject)calculatedAdmittanceUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.NUMERIC_DELTA_TYPE__CALCULATED_ADMITTANCE_UNIT, null, msgs);
			if (newCalculatedAdmittanceUnit != null)
				msgs = ((InternalEObject)newCalculatedAdmittanceUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.NUMERIC_DELTA_TYPE__CALCULATED_ADMITTANCE_UNIT, null, msgs);
			msgs = basicSetCalculatedAdmittanceUnit(newCalculatedAdmittanceUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.NUMERIC_DELTA_TYPE__CALCULATED_ADMITTANCE_UNIT, newCalculatedAdmittanceUnit, newCalculatedAdmittanceUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.NUMERIC_DELTA_TYPE__NUMERIC_DELTA_YPOINTS:
				return basicSetNumericDeltaYPoints(null, msgs);
			case _501Package.NUMERIC_DELTA_TYPE__CALCULATED_ADMITTANCE_UNIT:
