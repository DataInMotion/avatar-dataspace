 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ResultOfReflexTestTypeImpl#isReflexDetected <em>Reflex Detected</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ResultOfReflexTestTypeImpl#getDecayBasicResult <em>Decay Basic Result</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ResultOfReflexTestTypeImpl#getDecayPercent <em>Decay Percent</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ResultOfReflexTestTypeImpl#getLatencyTime <em>Latency Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultOfReflexTestTypeImpl extends MinimalEObjectImpl.Container implements ResultOfReflexTestType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.RESULT_OF_REFLEX_TEST_TYPE;
	}
	...
	public void setReflexDetected(boolean newReflexDetected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.RESULT_OF_REFLEX_TEST_TYPE__REFLEX_DETECTED, oldReflexDetected, reflexDetected, !oldReflexDetectedESet));
	}
	...
	public void unsetReflexDetected() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.RESULT_OF_REFLEX_TEST_TYPE__REFLEX_DETECTED, oldReflexDetected, REFLEX_DETECTED_EDEFAULT, oldReflexDetectedESet));
	}
	...
	public void setDecayBasicResult(DecayBasicResultType newDecayBasicResult) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.RESULT_OF_REFLEX_TEST_TYPE__DECAY_BASIC_RESULT, oldDecayBasicResult, decayBasicResult, !oldDecayBasicResultESet));
	}
	...
	public void unsetDecayBasicResult() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.RESULT_OF_REFLEX_TEST_TYPE__DECAY_BASIC_RESULT, oldDecayBasicResult, DECAY_BASIC_RESULT_EDEFAULT, oldDecayBasicResultESet));
	}
	...
	public void setDecayPercent(BigInteger newDecayPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.RESULT_OF_REFLEX_TEST_TYPE__DECAY_PERCENT, oldDecayPercent, decayPercent));
	}
	...
	public void setLatencyTime(BigInteger newLatencyTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.RESULT_OF_REFLEX_TEST_TYPE__LATENCY_TIME, oldLatencyTime, latencyTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.RESULT_OF_REFLEX_TEST_TYPE__REFLEX_DETECTED:
				return isReflexDetected();
			case _501Package.RESULT_OF_REFLEX_TEST_TYPE__DECAY_BASIC_RESULT:
				return getDecayBasicResult();
			case _501Package.RESULT_OF_REFLEX_TEST_TYPE__DECAY_PERCENT:
				return getDecayPercent();
			case _501Package.RESULT_OF_REFLEX_TEST_TYPE__LATENCY_TIME:
