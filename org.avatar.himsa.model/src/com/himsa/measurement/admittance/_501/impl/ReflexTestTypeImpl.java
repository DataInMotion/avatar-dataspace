...
import com.himsa.measurement.admittance._501.ResultOfReflexTestType;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ReflexTestTypeImpl#getReflexCurve <em>Reflex Curve</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ReflexTestTypeImpl#getResultOfReflexTest <em>Result Of Reflex Test</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ReflexTestTypeImpl#getAdmittanceMeasurementCondition <em>Admittance Measurement Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReflexTestTypeImpl extends MinimalEObjectImpl.Container implements ReflexTestType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.REFLEX_TEST_TYPE;
	}
	...
	public NotificationChain basicSetReflexCurve(ReflexCurveType newReflexCurve, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.REFLEX_TEST_TYPE__REFLEX_CURVE, oldReflexCurve, newReflexCurve);
	...
	public void setReflexCurve(ReflexCurveType newReflexCurve) {
		if (newReflexCurve != reflexCurve) {
			...
			if (reflexCurve != null)
				msgs = ((InternalEObject)reflexCurve).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.REFLEX_TEST_TYPE__REFLEX_CURVE, null, msgs);
			if (newReflexCurve != null)
				msgs = ((InternalEObject)newReflexCurve).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.REFLEX_TEST_TYPE__REFLEX_CURVE, null, msgs);
			msgs = basicSetReflexCurve(newReflexCurve, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.REFLEX_TEST_TYPE__REFLEX_CURVE, newReflexCurve, newReflexCurve));
	}
	...
	public NotificationChain basicSetResultOfReflexTest(ResultOfReflexTestType newResultOfReflexTest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.REFLEX_TEST_TYPE__RESULT_OF_REFLEX_TEST, oldResultOfReflexTest, newResultOfReflexTest);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResultOfReflexTest(ResultOfReflexTestType newResultOfReflexTest) {
		if (newResultOfReflexTest != resultOfReflexTest) {
			...
			if (resultOfReflexTest != null)
				msgs = ((InternalEObject)resultOfReflexTest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.REFLEX_TEST_TYPE__RESULT_OF_REFLEX_TEST, null, msgs);
			if (newResultOfReflexTest != null)
				msgs = ((InternalEObject)newResultOfReflexTest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.REFLEX_TEST_TYPE__RESULT_OF_REFLEX_TEST, null, msgs);
			msgs = basicSetResultOfReflexTest(newResultOfReflexTest, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.REFLEX_TEST_TYPE__RESULT_OF_REFLEX_TEST, newResultOfReflexTest, newResultOfReflexTest));
	}
	...
	public NotificationChain basicSetAdmittanceMeasurementCondition(AdmittanceMeasurementConditionType newAdmittanceMeasurementCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.REFLEX_TEST_TYPE__ADMITTANCE_MEASUREMENT_CONDITION, oldAdmittanceMeasurementCondition, newAdmittanceMeasurementCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAdmittanceMeasurementCondition(AdmittanceMeasurementConditionType newAdmittanceMeasurementCondition) {
		if (newAdmittanceMeasurementCondition != admittanceMeasurementCondition) {
			...
			if (admittanceMeasurementCondition != null)
				msgs = ((InternalEObject)admittanceMeasurementCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.REFLEX_TEST_TYPE__ADMITTANCE_MEASUREMENT_CONDITION, null, msgs);
			if (newAdmittanceMeasurementCondition != null)
				msgs = ((InternalEObject)newAdmittanceMeasurementCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.REFLEX_TEST_TYPE__ADMITTANCE_MEASUREMENT_CONDITION, null, msgs);
			msgs = basicSetAdmittanceMeasurementCondition(newAdmittanceMeasurementCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.REFLEX_TEST_TYPE__ADMITTANCE_MEASUREMENT_CONDITION, newAdmittanceMeasurementCondition, newAdmittanceMeasurementCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.REFLEX_TEST_TYPE__REFLEX_CURVE:
				return basicSetReflexCurve(null, msgs);
			case _501Package.REFLEX_TEST_TYPE__RESULT_OF_REFLEX_TEST:
				return basicSetResultOfReflexTest(null, msgs);
			case _501Package.REFLEX_TEST_TYPE__ADMITTANCE_MEASUREMENT_CONDITION:
