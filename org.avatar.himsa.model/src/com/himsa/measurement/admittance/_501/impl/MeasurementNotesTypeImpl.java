 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.MeasurementNotesTypeImpl#getTympanometerMakeModel <em>Tympanometer Make Model</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.MeasurementNotesTypeImpl#getTympanometerSerialNumber <em>Tympanometer Serial Number</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.MeasurementNotesTypeImpl#getTympanometerLastCalibration <em>Tympanometer Last Calibration</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.MeasurementNotesTypeImpl#getIsDeaf <em>Is Deaf</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementNotesTypeImpl extends MinimalEObjectImpl.Container implements MeasurementNotesType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.MEASUREMENT_NOTES_TYPE;
	}
	...
	public void setTympanometerMakeModel(String newTympanometerMakeModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.MEASUREMENT_NOTES_TYPE__TYMPANOMETER_MAKE_MODEL, oldTympanometerMakeModel, tympanometerMakeModel));
	}
	...
	public void setTympanometerSerialNumber(String newTympanometerSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.MEASUREMENT_NOTES_TYPE__TYMPANOMETER_SERIAL_NUMBER, oldTympanometerSerialNumber, tympanometerSerialNumber));
	}
	...
	public void setTympanometerLastCalibration(XMLGregorianCalendar newTympanometerLastCalibration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.MEASUREMENT_NOTES_TYPE__TYMPANOMETER_LAST_CALIBRATION, oldTympanometerLastCalibration, tympanometerLastCalibration));
	}
	...
	public void setIsDeaf(EarType newIsDeaf) {
		...
		isDeafESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.MEASUREMENT_NOTES_TYPE__IS_DEAF, oldIsDeaf, isDeaf, !oldIsDeafESet));
	}
	...
	public void unsetIsDeaf() {
		...
		isDeafESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.MEASUREMENT_NOTES_TYPE__IS_DEAF, oldIsDeaf, IS_DEAF_EDEFAULT, oldIsDeafESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.MEASUREMENT_NOTES_TYPE__TYMPANOMETER_MAKE_MODEL:
				return getTympanometerMakeModel();
			case _501Package.MEASUREMENT_NOTES_TYPE__TYMPANOMETER_SERIAL_NUMBER:
				return getTympanometerSerialNumber();
			case _501Package.MEASUREMENT_NOTES_TYPE__TYMPANOMETER_LAST_CALIBRATION:
				return getTympanometerLastCalibration();
			case _501Package.MEASUREMENT_NOTES_TYPE__IS_DEAF:
				return getIsDeaf();
		}
