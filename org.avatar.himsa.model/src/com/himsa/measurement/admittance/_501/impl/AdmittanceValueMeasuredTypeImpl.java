...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Admittance Value Measured Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AdmittanceValueMeasuredTypeImpl#getG <em>G</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AdmittanceValueMeasuredTypeImpl#getB <em>B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdmittanceValueMeasuredTypeImpl extends MinimalEObjectImpl.Container implements AdmittanceValueMeasuredType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.ADMITTANCE_VALUE_MEASURED_TYPE;
	}
	...
	public void setG(BigDecimal newG) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ADMITTANCE_VALUE_MEASURED_TYPE__G, oldG, g));
	}
	...
	public void setB(BigDecimal newB) {
		...
		b = newB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ADMITTANCE_VALUE_MEASURED_TYPE__B, oldB, b));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.ADMITTANCE_VALUE_MEASURED_TYPE__G:
				return getG();
			case _501Package.ADMITTANCE_VALUE_MEASURED_TYPE__B:
				return getB();
		}
