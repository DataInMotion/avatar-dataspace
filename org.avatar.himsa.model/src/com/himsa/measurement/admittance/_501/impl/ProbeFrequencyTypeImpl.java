 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ProbeFrequencyTypeImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.ProbeFrequencyTypeImpl#getOther <em>Other</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProbeFrequencyTypeImpl extends MinimalEObjectImpl.Container implements ProbeFrequencyType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.PROBE_FREQUENCY_TYPE;
	}
	...
	public void setFrequency(BigInteger newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.PROBE_FREQUENCY_TYPE__FREQUENCY, oldFrequency, frequency, !oldFrequencyESet));
	}
	...
	public void unsetFrequency() {
		...
		frequencyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.PROBE_FREQUENCY_TYPE__FREQUENCY, oldFrequency, FREQUENCY_EDEFAULT, oldFrequencyESet));
	}
	...
	public void setOther(FrequencyOtherType newOther) {
		...
		otherESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.PROBE_FREQUENCY_TYPE__OTHER, oldOther, other, !oldOtherESet));
	}
	...
	public void unsetOther() {
		...
		otherESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.PROBE_FREQUENCY_TYPE__OTHER, oldOther, OTHER_EDEFAULT, oldOtherESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.PROBE_FREQUENCY_TYPE__FREQUENCY:
				return getFrequency();
			case _501Package.PROBE_FREQUENCY_TYPE__OTHER:
				return getOther();
		}
