 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.CalculatedAdmittancePointsTypeImpl#getPt <em>Pt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CalculatedAdmittancePointsTypeImpl extends MinimalEObjectImpl.Container implements CalculatedAdmittancePointsType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.CALCULATED_ADMITTANCE_POINTS_TYPE;
	}
	...
	public EList<AdmittanceValuePointCalculatedType> getPt() {
		if (pt == null) {
			pt = new EObjectContainmentEList<AdmittanceValuePointCalculatedType>(AdmittanceValuePointCalculatedType.class, this, _501Package.CALCULATED_ADMITTANCE_POINTS_TYPE__PT);
		}
		return pt;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.CALCULATED_ADMITTANCE_POINTS_TYPE__PT:
