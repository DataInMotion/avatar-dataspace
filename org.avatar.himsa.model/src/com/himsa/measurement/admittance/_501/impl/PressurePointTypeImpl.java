 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.PressurePointTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.PressurePointTypeImpl#getPressure <em>Pressure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PressurePointTypeImpl extends MinimalEObjectImpl.Container implements PressurePointType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.PRESSURE_POINT_TYPE;
	}
	...
	public void setTime(BigDecimal newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.PRESSURE_POINT_TYPE__TIME, oldTime, time));
	}
	...
	public void setPressure(BigInteger newPressure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.PRESSURE_POINT_TYPE__PRESSURE, oldPressure, pressure));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _501Package.PRESSURE_POINT_TYPE__TIME:
				return getTime();
			case _501Package.PRESSURE_POINT_TYPE__PRESSURE:
				return getPressure();
		}
