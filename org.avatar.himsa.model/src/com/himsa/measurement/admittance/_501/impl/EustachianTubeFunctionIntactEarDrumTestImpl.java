 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.EustachianTubeFunctionIntactEarDrumTestImpl#getAdmittanceCurve <em>Admittance Curve</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.EustachianTubeFunctionIntactEarDrumTestImpl#getPressure <em>Pressure</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.EustachianTubeFunctionIntactEarDrumTestImpl#getCanalVolume <em>Canal Volume</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.EustachianTubeFunctionIntactEarDrumTestImpl#getMeasurementCondition <em>Measurement Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EustachianTubeFunctionIntactEarDrumTestImpl extends MinimalEObjectImpl.Container implements EustachianTubeFunctionIntactEarDrumTest {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST;
	}
	...
	public EList<AdmittanceCurveType> getAdmittanceCurve() {
		if (admittanceCurve == null) {
			admittanceCurve = new EObjectContainmentEList<AdmittanceCurveType>(AdmittanceCurveType.class, this, _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__ADMITTANCE_CURVE);
		}
	...
	public EList<BigInteger> getPressure() {
		if (pressure == null) {
			pressure = new EDataTypeEList<BigInteger>(BigInteger.class, this, _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__PRESSURE);
		}
		return pressure;
	}
	...
	public NotificationChain basicSetCanalVolume(AdmittanceType newCanalVolume, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__CANAL_VOLUME, oldCanalVolume, newCanalVolume);
	...
	public void setCanalVolume(AdmittanceType newCanalVolume) {
		if (newCanalVolume != canalVolume) {
			...
			if (canalVolume != null)
				msgs = ((InternalEObject)canalVolume).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__CANAL_VOLUME, null, msgs);
			if (newCanalVolume != null)
				msgs = ((InternalEObject)newCanalVolume).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__CANAL_VOLUME, null, msgs);
			msgs = basicSetCanalVolume(newCanalVolume, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__CANAL_VOLUME, newCanalVolume, newCanalVolume));
	}
	...
	public NotificationChain basicSetMeasurementCondition(TympanogramMeasurementConditionsType newMeasurementCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__MEASUREMENT_CONDITION, oldMeasurementCondition, newMeasurementCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasurementCondition(TympanogramMeasurementConditionsType newMeasurementCondition) {
		if (newMeasurementCondition != measurementCondition) {
			...
			if (measurementCondition != null)
				msgs = ((InternalEObject)measurementCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__MEASUREMENT_CONDITION, null, msgs);
			if (newMeasurementCondition != null)
				msgs = ((InternalEObject)newMeasurementCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__MEASUREMENT_CONDITION, null, msgs);
			msgs = basicSetMeasurementCondition(newMeasurementCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__MEASUREMENT_CONDITION, newMeasurementCondition, newMeasurementCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__ADMITTANCE_CURVE:
				return ((InternalEList<?>)getAdmittanceCurve()).basicRemove(otherEnd, msgs);
			case _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__CANAL_VOLUME:
				return basicSetCanalVolume(null, msgs);
			case _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__MEASUREMENT_CONDITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__PRESSURE:
				return getPressure();
			case _501Package.EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST__CANAL_VOLUME:
