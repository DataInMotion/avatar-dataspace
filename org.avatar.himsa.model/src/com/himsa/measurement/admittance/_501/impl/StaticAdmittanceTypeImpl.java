 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.StaticAdmittanceTypeImpl#getStaticAdmittanceValue <em>Static Admittance Value</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.StaticAdmittanceTypeImpl#getStaticAdmittanceUnit <em>Static Admittance Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaticAdmittanceTypeImpl extends MinimalEObjectImpl.Container implements StaticAdmittanceType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.STATIC_ADMITTANCE_TYPE;
	}
	...
	public NotificationChain basicSetStaticAdmittanceValue(AdmittanceValueType newStaticAdmittanceValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_VALUE, oldStaticAdmittanceValue, newStaticAdmittanceValue);
	...
	public void setStaticAdmittanceValue(AdmittanceValueType newStaticAdmittanceValue) {
		if (newStaticAdmittanceValue != staticAdmittanceValue) {
			...
			if (staticAdmittanceValue != null)
				msgs = ((InternalEObject)staticAdmittanceValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_VALUE, null, msgs);
			if (newStaticAdmittanceValue != null)
				msgs = ((InternalEObject)newStaticAdmittanceValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_VALUE, null, msgs);
			msgs = basicSetStaticAdmittanceValue(newStaticAdmittanceValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_VALUE, newStaticAdmittanceValue, newStaticAdmittanceValue));
	}
	...
	public NotificationChain basicSetStaticAdmittanceUnit(AdmittanceUnitType newStaticAdmittanceUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_UNIT, oldStaticAdmittanceUnit, newStaticAdmittanceUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStaticAdmittanceUnit(AdmittanceUnitType newStaticAdmittanceUnit) {
		if (newStaticAdmittanceUnit != staticAdmittanceUnit) {
			...
			if (staticAdmittanceUnit != null)
				msgs = ((InternalEObject)staticAdmittanceUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_UNIT, null, msgs);
			if (newStaticAdmittanceUnit != null)
				msgs = ((InternalEObject)newStaticAdmittanceUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_UNIT, null, msgs);
			msgs = basicSetStaticAdmittanceUnit(newStaticAdmittanceUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_UNIT, newStaticAdmittanceUnit, newStaticAdmittanceUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_VALUE:
				return basicSetStaticAdmittanceValue(null, msgs);
			case _501Package.STATIC_ADMITTANCE_TYPE__STATIC_ADMITTANCE_UNIT:
