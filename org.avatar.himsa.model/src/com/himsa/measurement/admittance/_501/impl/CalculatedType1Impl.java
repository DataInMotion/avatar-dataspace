 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.CalculatedType1Impl#getCalculatedAdmittancePoints <em>Calculated Admittance Points</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.CalculatedType1Impl#getCalculatedAdmittanceUnit <em>Calculated Admittance Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CalculatedType1Impl extends MinimalEObjectImpl.Container implements CalculatedType1 {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.CALCULATED_TYPE1;
	}
	...
	public NotificationChain basicSetCalculatedAdmittancePoints(CalculatedAdmittancePointsType newCalculatedAdmittancePoints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_POINTS, oldCalculatedAdmittancePoints, newCalculatedAdmittancePoints);
	...
	public void setCalculatedAdmittancePoints(CalculatedAdmittancePointsType newCalculatedAdmittancePoints) {
		if (newCalculatedAdmittancePoints != calculatedAdmittancePoints) {
			...
			if (calculatedAdmittancePoints != null)
				msgs = ((InternalEObject)calculatedAdmittancePoints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_POINTS, null, msgs);
			if (newCalculatedAdmittancePoints != null)
				msgs = ((InternalEObject)newCalculatedAdmittancePoints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_POINTS, null, msgs);
			msgs = basicSetCalculatedAdmittancePoints(newCalculatedAdmittancePoints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_POINTS, newCalculatedAdmittancePoints, newCalculatedAdmittancePoints));
	}
	...
	public NotificationChain basicSetCalculatedAdmittanceUnit(AdmittanceUnitCalculatedType newCalculatedAdmittanceUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_UNIT, oldCalculatedAdmittanceUnit, newCalculatedAdmittanceUnit);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalculatedAdmittanceUnit(AdmittanceUnitCalculatedType newCalculatedAdmittanceUnit) {
		if (newCalculatedAdmittanceUnit != calculatedAdmittanceUnit) {
			...
			if (calculatedAdmittanceUnit != null)
				msgs = ((InternalEObject)calculatedAdmittanceUnit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_UNIT, null, msgs);
			if (newCalculatedAdmittanceUnit != null)
				msgs = ((InternalEObject)newCalculatedAdmittanceUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_UNIT, null, msgs);
			msgs = basicSetCalculatedAdmittanceUnit(newCalculatedAdmittanceUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_UNIT, newCalculatedAdmittanceUnit, newCalculatedAdmittanceUnit));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_POINTS:
				return basicSetCalculatedAdmittancePoints(null, msgs);
			case _501Package.CALCULATED_TYPE1__CALCULATED_ADMITTANCE_UNIT:
