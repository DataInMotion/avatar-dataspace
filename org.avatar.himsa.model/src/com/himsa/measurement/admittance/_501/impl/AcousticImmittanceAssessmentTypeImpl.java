...
import com.himsa.measurement.admittance._501.EustachianTubeFunctionIntactEarDrumTest;
import com.himsa.measurement.admittance._501.EustachianTubeFunctionPerforatedEarDrumTest;
import com.himsa.measurement.admittance._501.MeasurementNotesType;
import com.himsa.measurement.admittance._501.ReflexTestType;
import com.himsa.measurement.admittance._501.SupplementaryDataType;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getTympanogramTest <em>Tympanogram Test</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getReflexTest <em>Reflex Test</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getEustachianTubeFunctionIntactEarDrumTest <em>Eustachian Tube Function Intact Ear Drum Test</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getEustachianTubeFunctionPerforatedEarDrumTest <em>Eustachian Tube Function Perforated Ear Drum Test</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getSupplementaryData <em>Supplementary Data</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link com.himsa.measurement.admittance._501.impl.AcousticImmittanceAssessmentTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AcousticImmittanceAssessmentTypeImpl extends MinimalEObjectImpl.Container implements AcousticImmittanceAssessmentType {
	...
	protected EClass eStaticClass() {
		return _501Package.Literals.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE;
	}
	...
	public EList<TympanogramTestType> getTympanogramTest() {
		if (tympanogramTest == null) {
			tympanogramTest = new EObjectContainmentEList<TympanogramTestType>(TympanogramTestType.class, this, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__TYMPANOGRAM_TEST);
		}
	...
	public EList<ReflexTestType> getReflexTest() {
		if (reflexTest == null) {
			reflexTest = new EObjectContainmentEList<ReflexTestType>(ReflexTestType.class, this, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__REFLEX_TEST);
		}
		return reflexTest;
	}
	...
	public NotificationChain basicSetEustachianTubeFunctionIntactEarDrumTest(EustachianTubeFunctionIntactEarDrumTest newEustachianTubeFunctionIntactEarDrumTest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST, oldEustachianTubeFunctionIntactEarDrumTest, newEustachianTubeFunctionIntactEarDrumTest);
	...
	public void setEustachianTubeFunctionIntactEarDrumTest(EustachianTubeFunctionIntactEarDrumTest newEustachianTubeFunctionIntactEarDrumTest) {
		if (newEustachianTubeFunctionIntactEarDrumTest != eustachianTubeFunctionIntactEarDrumTest) {
			...
			if (eustachianTubeFunctionIntactEarDrumTest != null)
				msgs = ((InternalEObject)eustachianTubeFunctionIntactEarDrumTest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST, null, msgs);
			if (newEustachianTubeFunctionIntactEarDrumTest != null)
				msgs = ((InternalEObject)newEustachianTubeFunctionIntactEarDrumTest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST, null, msgs);
			msgs = basicSetEustachianTubeFunctionIntactEarDrumTest(newEustachianTubeFunctionIntactEarDrumTest, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST, newEustachianTubeFunctionIntactEarDrumTest, newEustachianTubeFunctionIntactEarDrumTest));
	}
	...
	public NotificationChain basicSetEustachianTubeFunctionPerforatedEarDrumTest(EustachianTubeFunctionPerforatedEarDrumTest newEustachianTubeFunctionPerforatedEarDrumTest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST, oldEustachianTubeFunctionPerforatedEarDrumTest, newEustachianTubeFunctionPerforatedEarDrumTest);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEustachianTubeFunctionPerforatedEarDrumTest(EustachianTubeFunctionPerforatedEarDrumTest newEustachianTubeFunctionPerforatedEarDrumTest) {
		if (newEustachianTubeFunctionPerforatedEarDrumTest != eustachianTubeFunctionPerforatedEarDrumTest) {
			...
			if (eustachianTubeFunctionPerforatedEarDrumTest != null)
				msgs = ((InternalEObject)eustachianTubeFunctionPerforatedEarDrumTest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST, null, msgs);
			if (newEustachianTubeFunctionPerforatedEarDrumTest != null)
				msgs = ((InternalEObject)newEustachianTubeFunctionPerforatedEarDrumTest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST, null, msgs);
			msgs = basicSetEustachianTubeFunctionPerforatedEarDrumTest(newEustachianTubeFunctionPerforatedEarDrumTest, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST, newEustachianTubeFunctionPerforatedEarDrumTest, newEustachianTubeFunctionPerforatedEarDrumTest));
	}
	...
	public NotificationChain basicSetSupplementaryData(SupplementaryDataType newSupplementaryData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__SUPPLEMENTARY_DATA, oldSupplementaryData, newSupplementaryData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupplementaryData(SupplementaryDataType newSupplementaryData) {
		if (newSupplementaryData != supplementaryData) {
			...
			if (supplementaryData != null)
				msgs = ((InternalEObject)supplementaryData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__SUPPLEMENTARY_DATA, null, msgs);
			if (newSupplementaryData != null)
				msgs = ((InternalEObject)newSupplementaryData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__SUPPLEMENTARY_DATA, null, msgs);
			msgs = basicSetSupplementaryData(newSupplementaryData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__SUPPLEMENTARY_DATA, newSupplementaryData, newSupplementaryData));
	}
	...
	public NotificationChain basicSetNotes(MeasurementNotesType newNotes, NotificationChain msgs) {
		...
		notes = newNotes;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__NOTES, oldNotes, newNotes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNotes(MeasurementNotesType newNotes) {
		if (newNotes != notes) {
			NotificationChain msgs = null;
			if (notes != null)
				msgs = ((InternalEObject)notes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__NOTES, null, msgs);
			if (newNotes != null)
				msgs = ((InternalEObject)newNotes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__NOTES, null, msgs);
			msgs = basicSetNotes(newNotes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__NOTES, newNotes, newNotes));
	}
	...
	public void setConvertedFromDataStandard(BigInteger newConvertedFromDataStandard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__CONVERTED_FROM_DATA_STANDARD, oldConvertedFromDataStandard, convertedFromDataStandard));
	}
	...
	public void setValidatedByNOAH(boolean newValidatedByNOAH) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, validatedByNOAH, !oldValidatedByNOAHESet));
	}
	...
	public void unsetValidatedByNOAH() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__VALIDATED_BY_NOAH, oldValidatedByNOAH, VALIDATED_BY_NOAH_EDEFAULT, oldValidatedByNOAHESet));
	}
	...
	public void setVersion(BigInteger newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__TYMPANOGRAM_TEST:
				return ((InternalEList<?>)getTympanogramTest()).basicRemove(otherEnd, msgs);
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__REFLEX_TEST:
				return ((InternalEList<?>)getReflexTest()).basicRemove(otherEnd, msgs);
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_INTACT_EAR_DRUM_TEST:
				return basicSetEustachianTubeFunctionIntactEarDrumTest(null, msgs);
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__EUSTACHIAN_TUBE_FUNCTION_PERFORATED_EAR_DRUM_TEST:
				return basicSetEustachianTubeFunctionPerforatedEarDrumTest(null, msgs);
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__SUPPLEMENTARY_DATA:
				return basicSetSupplementaryData(null, msgs);
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__NOTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__NOTES:
				return getNotes();
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__CONVERTED_FROM_DATA_STANDARD:
				return getConvertedFromDataStandard();
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__VALIDATED_BY_NOAH:
				return isValidatedByNOAH();
			case _501Package.ACOUSTIC_IMMITTANCE_ASSESSMENT_TYPE__VERSION:
				return getVersion();
		}
