 ...
 * @generated
 */
public class _501Validator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final _501Validator INSTANCE = new _501Validator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "com.himsa.measurement.admittance._501";
	...
	public boolean validateConvertedFromDataStandardType_Min(BigInteger convertedFromDataStandardType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(_501Package.Literals.CONVERTED_FROM_DATA_STANDARD_TYPE, convertedFromDataStandardType, CONVERTED_FROM_DATA_STANDARD_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateStimulusLevelType_FractionDigits(BigDecimal stimulusLevelType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(_501Package.Literals.STIMULUS_LEVEL_TYPE, stimulusLevelType, 1, diagnostics, context);
		return result;
	}
	...
	public boolean validateTimeBaseType_FractionDigits(BigDecimal timeBaseType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(_501Package.Literals.TIME_BASE_TYPE, timeBaseType, 2, diagnostics, context);
		return result;
	}
	...
	public boolean validateTimeBaseType_Min(BigDecimal timeBaseType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(_501Package.Literals.TIME_BASE_TYPE, timeBaseType, TIME_BASE_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateTimeType_FractionDigits(BigDecimal timeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportFractionDigitsViolation(_501Package.Literals.TIME_TYPE, timeType, 2, diagnostics, context);
		return result;
	}
	...
	public boolean validateTimeType_Min(BigDecimal timeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(_501Package.Literals.TIME_TYPE, timeType, TIME_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateTympanometerMakeModelType_MaxLength(String tympanometerMakeModelType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxLengthViolation(_501Package.Literals.TYMPANOMETER_MAKE_MODEL_TYPE, tympanometerMakeModelType, length, 41, diagnostics, context);
		return result;
	}
	...
	public boolean validateTympanometerSerialNumberType_MaxLength(String tympanometerSerialNumberType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		boolean result = length <= 41;
		if (!result && diagnostics != null)
			reportMaxLengthViolation(_501Package.Literals.TYMPANOMETER_SERIAL_NUMBER_TYPE, tympanometerSerialNumberType, length, 41, diagnostics, context);
		return result;
	}
	...
	public boolean validateVersionType_Min(BigInteger versionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(_501Package.Literals.VERSION_TYPE, versionType, VERSION_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
