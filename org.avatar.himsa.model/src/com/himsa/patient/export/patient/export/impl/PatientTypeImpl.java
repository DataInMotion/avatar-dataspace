...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Patient Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getPatientGUID <em>Patient GUID</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getLastName <em>Last Name</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getMiddleName <em>Middle Name</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getPatientNo <em>Patient No</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getActivePatient <em>Active Patient</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getBirthDate <em>Birth Date</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getUserId <em>User Id</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getCreateDate <em>Create Date</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getAddress1 <em>Address1</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getAddress2 <em>Address2</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getAddress3 <em>Address3</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getSalutation <em>Salutation</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getSSNumber <em>SS Number</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getZip <em>Zip</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getCity <em>City</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getProvince <em>Province</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getEMail <em>EMail</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getHomeTelephone <em>Home Telephone</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getWorkTelephone <em>Work Telephone</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getMobileTelephone <em>Mobile Telephone</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getInsurance1 <em>Insurance1</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getInsurance2 <em>Insurance2</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getPhysician <em>Physician</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getReferral <em>Referral</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getOther1 <em>Other1</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getOther2 <em>Other2</em>}</li>
 *   <li>{@link com.himsa.patient.export.patient.export.impl.PatientTypeImpl#getBackEndSystemPatientId <em>Back End System Patient Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatientTypeImpl extends MinimalEObjectImpl.Container implements PatientType {
	/**
	...
	protected EClass eStaticClass() {
		return ExportPackage.Literals.PATIENT_TYPE;
	}
	...
	public void setPatientGUID(String newPatientGUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__PATIENT_GUID, oldPatientGUID, patientGUID, !oldPatientGUIDESet));
	}
	...
	public void unsetPatientGUID() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__PATIENT_GUID, oldPatientGUID, PATIENT_GUID_EDEFAULT, oldPatientGUIDESet));
	}
	...
	public void setFirstName(String newFirstName) {
		...
		firstNameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__FIRST_NAME, oldFirstName, firstName, !oldFirstNameESet));
	}
	...
	public void unsetFirstName() {
		...
		firstNameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__FIRST_NAME, oldFirstName, FIRST_NAME_EDEFAULT, oldFirstNameESet));
	}
	...
	public void setLastName(String newLastName) {
		...
		lastNameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__LAST_NAME, oldLastName, lastName, !oldLastNameESet));
	}
	...
	public void unsetLastName() {
		...
		lastNameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__LAST_NAME, oldLastName, LAST_NAME_EDEFAULT, oldLastNameESet));
	}
	...
	public void setMiddleName(String newMiddleName) {
		...
		middleNameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__MIDDLE_NAME, oldMiddleName, middleName, !oldMiddleNameESet));
	}
	...
	public void unsetMiddleName() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__MIDDLE_NAME, oldMiddleName, MIDDLE_NAME_EDEFAULT, oldMiddleNameESet));
	}
	...
	public void setPatientNo(String newPatientNo) {
		...
		patientNoESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__PATIENT_NO, oldPatientNo, patientNo, !oldPatientNoESet));
	}
	...
	public void unsetPatientNo() {
		...
		patientNoESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__PATIENT_NO, oldPatientNo, PATIENT_NO_EDEFAULT, oldPatientNoESet));
	}
	...
	public void setActivePatient(Boolean newActivePatient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__ACTIVE_PATIENT, oldActivePatient, activePatient, !oldActivePatientESet));
	}
	...
	public void unsetActivePatient() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__ACTIVE_PATIENT, oldActivePatient, ACTIVE_PATIENT_EDEFAULT, oldActivePatientESet));
	}
	...
	public void setGender(GenderType newGender) {
		...
		genderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__GENDER, oldGender, gender, !oldGenderESet));
	}
	...
	public void unsetGender() {
		...
		genderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__GENDER, oldGender, GENDER_EDEFAULT, oldGenderESet));
	}
	...
	public void setBirthDate(XMLGregorianCalendar newBirthDate) {
		...
		birthDateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__BIRTH_DATE, oldBirthDate, birthDate, !oldBirthDateESet));
	}
	...
	public void unsetBirthDate() {
		...
		birthDateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__BIRTH_DATE, oldBirthDate, BIRTH_DATE_EDEFAULT, oldBirthDateESet));
	}
	...
	public void setUserId(String newUserId) {
		...
		userId = newUserId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__USER_ID, oldUserId, userId));
	}
	...
	public void setCreateDate(XMLGregorianCalendar newCreateDate) {
		...
		createDateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__CREATE_DATE, oldCreateDate, createDate, !oldCreateDateESet));
	}
	...
	public void unsetCreateDate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__CREATE_DATE, oldCreateDate, CREATE_DATE_EDEFAULT, oldCreateDateESet));
	}
	...
	public void setAddress1(String newAddress1) {
		...
		address1ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__ADDRESS1, oldAddress1, address1, !oldAddress1ESet));
	}
	...
	public void unsetAddress1() {
		...
		address1ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__ADDRESS1, oldAddress1, ADDRESS1_EDEFAULT, oldAddress1ESet));
	}
	...
	public void setAddress2(String newAddress2) {
		...
		address2ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__ADDRESS2, oldAddress2, address2, !oldAddress2ESet));
	}
	...
	public void unsetAddress2() {
		...
		address2ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__ADDRESS2, oldAddress2, ADDRESS2_EDEFAULT, oldAddress2ESet));
	}
	...
	public void setAddress3(String newAddress3) {
		...
		address3ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__ADDRESS3, oldAddress3, address3, !oldAddress3ESet));
	}
	...
	public void unsetAddress3() {
		...
		address3ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__ADDRESS3, oldAddress3, ADDRESS3_EDEFAULT, oldAddress3ESet));
	}
	...
	public void setTitle(String newTitle) {
		...
		titleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__TITLE, oldTitle, title, !oldTitleESet));
	}
	...
	public void unsetTitle() {
		...
		titleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__TITLE, oldTitle, TITLE_EDEFAULT, oldTitleESet));
	}
	...
	public void setSalutation(String newSalutation) {
		...
		salutationESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__SALUTATION, oldSalutation, salutation, !oldSalutationESet));
	}
	...
	public void unsetSalutation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__SALUTATION, oldSalutation, SALUTATION_EDEFAULT, oldSalutationESet));
	}
	...
	public void setSSNumber(String newSSNumber) {
		...
		sSNumberESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__SS_NUMBER, oldSSNumber, sSNumber, !oldSSNumberESet));
	}
	...
	public void unsetSSNumber() {
		...
		sSNumberESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__SS_NUMBER, oldSSNumber, SS_NUMBER_EDEFAULT, oldSSNumberESet));
	}
	...
	public void setZip(String newZip) {
		...
		zipESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__ZIP, oldZip, zip, !oldZipESet));
	}
	...
	public void unsetZip() {
		...
		zipESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__ZIP, oldZip, ZIP_EDEFAULT, oldZipESet));
	}
	...
	public void setCity(String newCity) {
		...
		cityESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__CITY, oldCity, city, !oldCityESet));
	}
	...
	public void unsetCity() {
		...
		cityESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__CITY, oldCity, CITY_EDEFAULT, oldCityESet));
	}
	...
	public void setProvince(String newProvince) {
		...
		provinceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__PROVINCE, oldProvince, province, !oldProvinceESet));
	}
	...
	public void unsetProvince() {
		...
		provinceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__PROVINCE, oldProvince, PROVINCE_EDEFAULT, oldProvinceESet));
	}
	...
	public void setCountry(String newCountry) {
		...
		countryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__COUNTRY, oldCountry, country, !oldCountryESet));
	}
	...
	public void unsetCountry() {
		...
		countryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__COUNTRY, oldCountry, COUNTRY_EDEFAULT, oldCountryESet));
	}
	...
	public void setEMail(String newEMail) {
		...
		eMailESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__EMAIL, oldEMail, eMail, !oldEMailESet));
	}
	...
	public void unsetEMail() {
		...
		eMailESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__EMAIL, oldEMail, EMAIL_EDEFAULT, oldEMailESet));
	}
	...
	public void setHomeTelephone(String newHomeTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__HOME_TELEPHONE, oldHomeTelephone, homeTelephone, !oldHomeTelephoneESet));
	}
	...
	public void unsetHomeTelephone() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__HOME_TELEPHONE, oldHomeTelephone, HOME_TELEPHONE_EDEFAULT, oldHomeTelephoneESet));
	}
	...
	public void setWorkTelephone(String newWorkTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__WORK_TELEPHONE, oldWorkTelephone, workTelephone, !oldWorkTelephoneESet));
	}
	...
	public void unsetWorkTelephone() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__WORK_TELEPHONE, oldWorkTelephone, WORK_TELEPHONE_EDEFAULT, oldWorkTelephoneESet));
	}
	...
	public void setMobileTelephone(String newMobileTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__MOBILE_TELEPHONE, oldMobileTelephone, mobileTelephone, !oldMobileTelephoneESet));
	}
	...
	public void unsetMobileTelephone() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__MOBILE_TELEPHONE, oldMobileTelephone, MOBILE_TELEPHONE_EDEFAULT, oldMobileTelephoneESet));
	}
	...
	public void setInsurance1(String newInsurance1) {
		...
		insurance1ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__INSURANCE1, oldInsurance1, insurance1, !oldInsurance1ESet));
	}
	...
	public void unsetInsurance1() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__INSURANCE1, oldInsurance1, INSURANCE1_EDEFAULT, oldInsurance1ESet));
	}
	...
	public void setInsurance2(String newInsurance2) {
		...
		insurance2ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__INSURANCE2, oldInsurance2, insurance2, !oldInsurance2ESet));
	}
	...
	public void unsetInsurance2() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__INSURANCE2, oldInsurance2, INSURANCE2_EDEFAULT, oldInsurance2ESet));
	}
	...
	public void setPhysician(String newPhysician) {
		...
		physicianESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__PHYSICIAN, oldPhysician, physician, !oldPhysicianESet));
	}
	...
	public void unsetPhysician() {
		...
		physicianESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__PHYSICIAN, oldPhysician, PHYSICIAN_EDEFAULT, oldPhysicianESet));
	}
	...
	public void setReferral(String newReferral) {
		...
		referralESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__REFERRAL, oldReferral, referral, !oldReferralESet));
	}
	...
	public void unsetReferral() {
		...
		referralESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__REFERRAL, oldReferral, REFERRAL_EDEFAULT, oldReferralESet));
	}
	...
	public void setOther1(String newOther1) {
		...
		other1ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__OTHER1, oldOther1, other1, !oldOther1ESet));
	}
	...
	public void unsetOther1() {
		...
		other1ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__OTHER1, oldOther1, OTHER1_EDEFAULT, oldOther1ESet));
	}
	...
	public void setOther2(String newOther2) {
		...
		other2ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__OTHER2, oldOther2, other2, !oldOther2ESet));
	}
	...
	public void unsetOther2() {
		...
		other2ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__OTHER2, oldOther2, OTHER2_EDEFAULT, oldOther2ESet));
	}
	...
	public void setBackEndSystemPatientId(String newBackEndSystemPatientId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExportPackage.PATIENT_TYPE__BACK_END_SYSTEM_PATIENT_ID, oldBackEndSystemPatientId, backEndSystemPatientId, !oldBackEndSystemPatientIdESet));
	}
	...
	public void unsetBackEndSystemPatientId() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ExportPackage.PATIENT_TYPE__BACK_END_SYSTEM_PATIENT_ID, oldBackEndSystemPatientId, BACK_END_SYSTEM_PATIENT_ID_EDEFAULT, oldBackEndSystemPatientIdESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExportPackage.PATIENT_TYPE__PATIENT_GUID:
				return getPatientGUID();
			case ExportPackage.PATIENT_TYPE__FIRST_NAME:
				return getFirstName();
			case ExportPackage.PATIENT_TYPE__LAST_NAME:
				return getLastName();
			case ExportPackage.PATIENT_TYPE__MIDDLE_NAME:
				return getMiddleName();
			case ExportPackage.PATIENT_TYPE__PATIENT_NO:
				return getPatientNo();
			case ExportPackage.PATIENT_TYPE__ACTIVE_PATIENT:
				return getActivePatient();
			case ExportPackage.PATIENT_TYPE__GENDER:
				return getGender();
			case ExportPackage.PATIENT_TYPE__BIRTH_DATE:
				return getBirthDate();
			case ExportPackage.PATIENT_TYPE__USER_ID:
				return getUserId();
			case ExportPackage.PATIENT_TYPE__CREATE_DATE:
				return getCreateDate();
			case ExportPackage.PATIENT_TYPE__ADDRESS1:
				return getAddress1();
			case ExportPackage.PATIENT_TYPE__ADDRESS2:
				return getAddress2();
			case ExportPackage.PATIENT_TYPE__ADDRESS3:
				return getAddress3();
			case ExportPackage.PATIENT_TYPE__TITLE:
				return getTitle();
			case ExportPackage.PATIENT_TYPE__SALUTATION:
				return getSalutation();
			case ExportPackage.PATIENT_TYPE__SS_NUMBER:
				return getSSNumber();
			case ExportPackage.PATIENT_TYPE__ZIP:
				return getZip();
			case ExportPackage.PATIENT_TYPE__CITY:
				return getCity();
			case ExportPackage.PATIENT_TYPE__PROVINCE:
				return getProvince();
			case ExportPackage.PATIENT_TYPE__COUNTRY:
				return getCountry();
			case ExportPackage.PATIENT_TYPE__EMAIL:
				return getEMail();
			case ExportPackage.PATIENT_TYPE__HOME_TELEPHONE:
				return getHomeTelephone();
			case ExportPackage.PATIENT_TYPE__WORK_TELEPHONE:
				return getWorkTelephone();
			case ExportPackage.PATIENT_TYPE__MOBILE_TELEPHONE:
				return getMobileTelephone();
			case ExportPackage.PATIENT_TYPE__INSURANCE1:
				return getInsurance1();
			case ExportPackage.PATIENT_TYPE__INSURANCE2:
				return getInsurance2();
			case ExportPackage.PATIENT_TYPE__PHYSICIAN:
				return getPhysician();
			case ExportPackage.PATIENT_TYPE__REFERRAL:
				return getReferral();
			case ExportPackage.PATIENT_TYPE__OTHER1:
				return getOther1();
			case ExportPackage.PATIENT_TYPE__OTHER2:
				return getOther2();
			case ExportPackage.PATIENT_TYPE__BACK_END_SYSTEM_PATIENT_ID:
