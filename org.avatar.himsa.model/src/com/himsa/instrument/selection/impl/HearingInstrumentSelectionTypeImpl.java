 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getInstrumentTypeName <em>Instrument Type Name</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getDeviceCategory <em>Device Category</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getSerialNumber <em>Serial Number</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getVentType <em>Vent Type</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getEarMoldForm <em>Ear Mold Form</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getEarMoldText <em>Ear Mold Text</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getSoundCanalType <em>Sound Canal Type</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getBatteryType <em>Battery Type</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getReserved <em>Reserved</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getPrivateSelectionData <em>Private Selection Data</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link com.himsa.instrument.selection.impl.HearingInstrumentSelectionTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
