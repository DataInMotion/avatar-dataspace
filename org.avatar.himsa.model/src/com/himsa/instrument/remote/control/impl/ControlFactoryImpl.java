...
public class ControlFactoryImpl extends EFactoryImpl implements ControlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ControlPackage.BATTERY_TYPE: return createBatteryType();
			case ControlPackage.REMOTE_CONTROL_SELECTION_TYPE: return createRemoteControlSelectionType();
			case ControlPackage.DOCUMENT_ROOT: return createDocumentRoot();
			default:
