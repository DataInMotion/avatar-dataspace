/**
 */
package com.himsa.instrument.remote.control.util;

import com.himsa.instrument.remote.control.*;
 ...
 * @generated
 */
public class ControlValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final ControlValidator INSTANCE = new ControlValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "com.himsa.instrument.remote.control";
	...
	public boolean validateBatteryTypeTextType_MaxLength(String batteryTypeTextType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxLengthViolation(ControlPackage.Literals.BATTERY_TYPE_TEXT_TYPE, batteryTypeTextType, length, 21, diagnostics, context);
		return result;
	}
	...
	public boolean validateConvertedFromDataStandardType_Min(BigInteger convertedFromDataStandardType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(ControlPackage.Literals.CONVERTED_FROM_DATA_STANDARD_TYPE, convertedFromDataStandardType, CONVERTED_FROM_DATA_STANDARD_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateInstrumentTypeNameType_MaxLength(String instrumentTypeNameType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxLengthViolation(ControlPackage.Literals.INSTRUMENT_TYPE_NAME_TYPE, instrumentTypeNameType, length, 41, diagnostics, context);
		return result;
	}
	...
	public boolean validateSerialNumberType_MaxLength(String serialNumberType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		boolean result = length <= 21;
		if (!result && diagnostics != null)
			reportMaxLengthViolation(ControlPackage.Literals.SERIAL_NUMBER_TYPE, serialNumberType, length, 21, diagnostics, context);
		return result;
	}
