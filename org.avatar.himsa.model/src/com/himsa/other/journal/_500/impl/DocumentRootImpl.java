 ...
 * </p>
 * <ul>
 *   <li>{@link com.himsa.other.journal._500.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.himsa.other.journal._500.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.himsa.other.journal._500.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.himsa.other.journal._500.impl.DocumentRootImpl#getHIMSAJournalStandard <em>HIMSA Journal Standard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public HIMSAJournalStandardType getHIMSAJournalStandard() {
		return (HIMSAJournalStandardType)getMixed().get(_500Package.Literals.DOCUMENT_ROOT__HIMSA_JOURNAL_STANDARD, true);
	}
	...
	public NotificationChain basicSetHIMSAJournalStandard(HIMSAJournalStandardType newHIMSAJournalStandard, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(_500Package.Literals.DOCUMENT_ROOT__HIMSA_JOURNAL_STANDARD, newHIMSAJournalStandard, msgs);
	}
	...
	public void setHIMSAJournalStandard(HIMSAJournalStandardType newHIMSAJournalStandard) {
		((FeatureMap.Internal)getMixed()).set(_500Package.Literals.DOCUMENT_ROOT__HIMSA_JOURNAL_STANDARD, newHIMSAJournalStandard);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case _500Package.DOCUMENT_ROOT__HIMSA_JOURNAL_STANDARD:
