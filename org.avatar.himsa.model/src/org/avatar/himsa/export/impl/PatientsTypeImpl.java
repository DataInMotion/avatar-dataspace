 ...
 * </p>
 * <ul>
 *   <li>{@link org.avatar.himsa.export.impl.PatientsTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PatientsTypeImpl#getPatient <em>Patient</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatientsTypeImpl extends MinimalEObjectImpl.Container implements PatientsType {
	...
	protected EClass eStaticClass() {
		return PatientExportPackage.Literals.PATIENTS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, PatientExportPackage.PATIENTS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<PatientType1> getPatient() {
		return getGroup().list(PatientExportPackage.Literals.PATIENTS_TYPE__PATIENT);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PatientExportPackage.PATIENTS_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case PatientExportPackage.PATIENTS_TYPE__PATIENT:
