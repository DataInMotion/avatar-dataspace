...
import audiogrammetadata.HIMSAAudiogramMetadataStandardType;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHIMSAAudiometricStandard <em>HIMSA Audiometric Standard</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHIMSAAudiometricStandard1 <em>HIMSA Audiometric Standard1</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHearingInstrumentSelection <em>Hearing Instrument Selection</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHearingInstrumentFitting <em>Hearing Instrument Fitting</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getRemoteControlSelection <em>Remote Control Selection</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHIMSARemStandard <em>HIMSA Rem Standard</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHIMSAHitStandard <em>HIMSA Hit Standard</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getAcousticImpedanceCompleteMeasurement <em>Acoustic Impedance Complete Measurement</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getAcousticImmittanceAssessment <em>Acoustic Immittance Assessment</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getTinnitusMeasurementData <em>Tinnitus Measurement Data</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHIMSAAudiogramMetadataStandard <em>HIMSA Audiogram Metadata Standard</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getCochlearImplantSoundProcessorSelection <em>Cochlear Implant Sound Processor Selection</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getHIMSAJournalStandard <em>HIMSA Journal Standard</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getNotificationAction <em>Notification Action</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.PubliclyFormattedDataImpl#getScanMetaDataStandard <em>Scan Meta Data Standard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PubliclyFormattedDataImpl extends MinimalEObjectImpl.Container implements PubliclyFormattedData {
	 ...
	 * @ordered
	 */
	protected audiogram502.HIMSAAudiometricStandardType hIMSAAudiometricStandard1;
	...
	protected EClass eStaticClass() {
		return PatientExportPackage.Literals.PUBLICLY_FORMATTED_DATA;
	}
	...
	public NotificationChain basicSetHIMSAAudiometricStandard(HIMSAAudiometricStandardType newHIMSAAudiometricStandard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD, oldHIMSAAudiometricStandard, newHIMSAAudiometricStandard);
	...
	public void setHIMSAAudiometricStandard(HIMSAAudiometricStandardType newHIMSAAudiometricStandard) {
		if (newHIMSAAudiometricStandard != hIMSAAudiometricStandard) {
			...
			if (hIMSAAudiometricStandard != null)
				msgs = ((InternalEObject)hIMSAAudiometricStandard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD, null, msgs);
			if (newHIMSAAudiometricStandard != null)
				msgs = ((InternalEObject)newHIMSAAudiometricStandard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD, null, msgs);
			msgs = basicSetHIMSAAudiometricStandard(newHIMSAAudiometricStandard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD, newHIMSAAudiometricStandard, newHIMSAAudiometricStandard));
	}
	 ...
	 */
	@Override
	public audiogram502.HIMSAAudiometricStandardType getHIMSAAudiometricStandard1() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHIMSAAudiometricStandard1(audiogram502.HIMSAAudiometricStandardType newHIMSAAudiometricStandard1, NotificationChain msgs) {
		audiogram502.HIMSAAudiometricStandardType oldHIMSAAudiometricStandard1 = hIMSAAudiometricStandard1;
		hIMSAAudiometricStandard1 = newHIMSAAudiometricStandard1;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1, oldHIMSAAudiometricStandard1, newHIMSAAudiometricStandard1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 */
	@Override
	public void setHIMSAAudiometricStandard1(audiogram502.HIMSAAudiometricStandardType newHIMSAAudiometricStandard1) {
		if (newHIMSAAudiometricStandard1 != hIMSAAudiometricStandard1) {
			NotificationChain msgs = null;
			if (hIMSAAudiometricStandard1 != null)
				msgs = ((InternalEObject)hIMSAAudiometricStandard1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1, null, msgs);
			if (newHIMSAAudiometricStandard1 != null)
				msgs = ((InternalEObject)newHIMSAAudiometricStandard1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1, null, msgs);
			msgs = basicSetHIMSAAudiometricStandard1(newHIMSAAudiometricStandard1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1, newHIMSAAudiometricStandard1, newHIMSAAudiometricStandard1));
	}
	...
	public NotificationChain basicSetHearingInstrumentSelection(HearingInstrumentSelectionType newHearingInstrumentSelection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION, oldHearingInstrumentSelection, newHearingInstrumentSelection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHearingInstrumentSelection(HearingInstrumentSelectionType newHearingInstrumentSelection) {
		if (newHearingInstrumentSelection != hearingInstrumentSelection) {
			...
			if (hearingInstrumentSelection != null)
				msgs = ((InternalEObject)hearingInstrumentSelection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION, null, msgs);
			if (newHearingInstrumentSelection != null)
				msgs = ((InternalEObject)newHearingInstrumentSelection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION, null, msgs);
			msgs = basicSetHearingInstrumentSelection(newHearingInstrumentSelection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION, newHearingInstrumentSelection, newHearingInstrumentSelection));
	}
	...
	public NotificationChain basicSetHearingInstrumentFitting(HearingInstrumentFittingType newHearingInstrumentFitting, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_FITTING, oldHearingInstrumentFitting, newHearingInstrumentFitting);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHearingInstrumentFitting(HearingInstrumentFittingType newHearingInstrumentFitting) {
		if (newHearingInstrumentFitting != hearingInstrumentFitting) {
			...
			if (hearingInstrumentFitting != null)
				msgs = ((InternalEObject)hearingInstrumentFitting).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_FITTING, null, msgs);
			if (newHearingInstrumentFitting != null)
				msgs = ((InternalEObject)newHearingInstrumentFitting).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_FITTING, null, msgs);
			msgs = basicSetHearingInstrumentFitting(newHearingInstrumentFitting, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_FITTING, newHearingInstrumentFitting, newHearingInstrumentFitting));
	}
	...
	public NotificationChain basicSetRemoteControlSelection(RemoteControlSelectionType newRemoteControlSelection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__REMOTE_CONTROL_SELECTION, oldRemoteControlSelection, newRemoteControlSelection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRemoteControlSelection(RemoteControlSelectionType newRemoteControlSelection) {
		if (newRemoteControlSelection != remoteControlSelection) {
			...
			if (remoteControlSelection != null)
				msgs = ((InternalEObject)remoteControlSelection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__REMOTE_CONTROL_SELECTION, null, msgs);
			if (newRemoteControlSelection != null)
				msgs = ((InternalEObject)newRemoteControlSelection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__REMOTE_CONTROL_SELECTION, null, msgs);
			msgs = basicSetRemoteControlSelection(newRemoteControlSelection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__REMOTE_CONTROL_SELECTION, newRemoteControlSelection, newRemoteControlSelection));
	}
	...
	public NotificationChain basicSetHIMSARemStandard(HIMSARemStandardType newHIMSARemStandard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_REM_STANDARD, oldHIMSARemStandard, newHIMSARemStandard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHIMSARemStandard(HIMSARemStandardType newHIMSARemStandard) {
		if (newHIMSARemStandard != hIMSARemStandard) {
			...
			if (hIMSARemStandard != null)
				msgs = ((InternalEObject)hIMSARemStandard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_REM_STANDARD, null, msgs);
			if (newHIMSARemStandard != null)
				msgs = ((InternalEObject)newHIMSARemStandard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_REM_STANDARD, null, msgs);
			msgs = basicSetHIMSARemStandard(newHIMSARemStandard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_REM_STANDARD, newHIMSARemStandard, newHIMSARemStandard));
	}
	...
	public NotificationChain basicSetHIMSAHitStandard(HIMSAHitStandardType newHIMSAHitStandard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_HIT_STANDARD, oldHIMSAHitStandard, newHIMSAHitStandard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHIMSAHitStandard(HIMSAHitStandardType newHIMSAHitStandard) {
		if (newHIMSAHitStandard != hIMSAHitStandard) {
			...
			if (hIMSAHitStandard != null)
				msgs = ((InternalEObject)hIMSAHitStandard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_HIT_STANDARD, null, msgs);
			if (newHIMSAHitStandard != null)
				msgs = ((InternalEObject)newHIMSAHitStandard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_HIT_STANDARD, null, msgs);
			msgs = basicSetHIMSAHitStandard(newHIMSAHitStandard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_HIT_STANDARD, newHIMSAHitStandard, newHIMSAHitStandard));
	}
	...
	public NotificationChain basicSetAcousticImpedanceCompleteMeasurement(AcousticImpedanceCompleteMeasurementType newAcousticImpedanceCompleteMeasurement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMPEDANCE_COMPLETE_MEASUREMENT, oldAcousticImpedanceCompleteMeasurement, newAcousticImpedanceCompleteMeasurement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAcousticImpedanceCompleteMeasurement(AcousticImpedanceCompleteMeasurementType newAcousticImpedanceCompleteMeasurement) {
		if (newAcousticImpedanceCompleteMeasurement != acousticImpedanceCompleteMeasurement) {
			...
			if (acousticImpedanceCompleteMeasurement != null)
				msgs = ((InternalEObject)acousticImpedanceCompleteMeasurement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMPEDANCE_COMPLETE_MEASUREMENT, null, msgs);
			if (newAcousticImpedanceCompleteMeasurement != null)
				msgs = ((InternalEObject)newAcousticImpedanceCompleteMeasurement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMPEDANCE_COMPLETE_MEASUREMENT, null, msgs);
			msgs = basicSetAcousticImpedanceCompleteMeasurement(newAcousticImpedanceCompleteMeasurement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMPEDANCE_COMPLETE_MEASUREMENT, newAcousticImpedanceCompleteMeasurement, newAcousticImpedanceCompleteMeasurement));
	}
	...
	public NotificationChain basicSetAcousticImmittanceAssessment(AcousticImmittanceAssessmentType newAcousticImmittanceAssessment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMMITTANCE_ASSESSMENT, oldAcousticImmittanceAssessment, newAcousticImmittanceAssessment);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAcousticImmittanceAssessment(AcousticImmittanceAssessmentType newAcousticImmittanceAssessment) {
		if (newAcousticImmittanceAssessment != acousticImmittanceAssessment) {
			...
			if (acousticImmittanceAssessment != null)
				msgs = ((InternalEObject)acousticImmittanceAssessment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMMITTANCE_ASSESSMENT, null, msgs);
			if (newAcousticImmittanceAssessment != null)
				msgs = ((InternalEObject)newAcousticImmittanceAssessment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMMITTANCE_ASSESSMENT, null, msgs);
			msgs = basicSetAcousticImmittanceAssessment(newAcousticImmittanceAssessment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMMITTANCE_ASSESSMENT, newAcousticImmittanceAssessment, newAcousticImmittanceAssessment));
	}
	...
	public NotificationChain basicSetTinnitusMeasurementData(TinnitusMeasurementDataType newTinnitusMeasurementData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__TINNITUS_MEASUREMENT_DATA, oldTinnitusMeasurementData, newTinnitusMeasurementData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTinnitusMeasurementData(TinnitusMeasurementDataType newTinnitusMeasurementData) {
		if (newTinnitusMeasurementData != tinnitusMeasurementData) {
			...
			if (tinnitusMeasurementData != null)
				msgs = ((InternalEObject)tinnitusMeasurementData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__TINNITUS_MEASUREMENT_DATA, null, msgs);
			if (newTinnitusMeasurementData != null)
				msgs = ((InternalEObject)newTinnitusMeasurementData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__TINNITUS_MEASUREMENT_DATA, null, msgs);
			msgs = basicSetTinnitusMeasurementData(newTinnitusMeasurementData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__TINNITUS_MEASUREMENT_DATA, newTinnitusMeasurementData, newTinnitusMeasurementData));
	}
	...
	public NotificationChain basicSetHIMSAAudiogramMetadataStandard(HIMSAAudiogramMetadataStandardType newHIMSAAudiogramMetadataStandard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOGRAM_METADATA_STANDARD, oldHIMSAAudiogramMetadataStandard, newHIMSAAudiogramMetadataStandard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHIMSAAudiogramMetadataStandard(HIMSAAudiogramMetadataStandardType newHIMSAAudiogramMetadataStandard) {
		if (newHIMSAAudiogramMetadataStandard != hIMSAAudiogramMetadataStandard) {
			...
			if (hIMSAAudiogramMetadataStandard != null)
				msgs = ((InternalEObject)hIMSAAudiogramMetadataStandard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOGRAM_METADATA_STANDARD, null, msgs);
			if (newHIMSAAudiogramMetadataStandard != null)
				msgs = ((InternalEObject)newHIMSAAudiogramMetadataStandard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOGRAM_METADATA_STANDARD, null, msgs);
			msgs = basicSetHIMSAAudiogramMetadataStandard(newHIMSAAudiogramMetadataStandard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOGRAM_METADATA_STANDARD, newHIMSAAudiogramMetadataStandard, newHIMSAAudiogramMetadataStandard));
	}
	...
	public NotificationChain basicSetCochlearImplantSoundProcessorSelection(CochlearImplantSoundProcessorSelectionType newCochlearImplantSoundProcessorSelection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION, oldCochlearImplantSoundProcessorSelection, newCochlearImplantSoundProcessorSelection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCochlearImplantSoundProcessorSelection(CochlearImplantSoundProcessorSelectionType newCochlearImplantSoundProcessorSelection) {
		if (newCochlearImplantSoundProcessorSelection != cochlearImplantSoundProcessorSelection) {
			...
			if (cochlearImplantSoundProcessorSelection != null)
				msgs = ((InternalEObject)cochlearImplantSoundProcessorSelection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION, null, msgs);
			if (newCochlearImplantSoundProcessorSelection != null)
				msgs = ((InternalEObject)newCochlearImplantSoundProcessorSelection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION, null, msgs);
			msgs = basicSetCochlearImplantSoundProcessorSelection(newCochlearImplantSoundProcessorSelection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION, newCochlearImplantSoundProcessorSelection, newCochlearImplantSoundProcessorSelection));
	}
	...
	public NotificationChain basicSetHIMSAJournalStandard(HIMSAJournalStandardType newHIMSAJournalStandard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_JOURNAL_STANDARD, oldHIMSAJournalStandard, newHIMSAJournalStandard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHIMSAJournalStandard(HIMSAJournalStandardType newHIMSAJournalStandard) {
		if (newHIMSAJournalStandard != hIMSAJournalStandard) {
			...
			if (hIMSAJournalStandard != null)
				msgs = ((InternalEObject)hIMSAJournalStandard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_JOURNAL_STANDARD, null, msgs);
			if (newHIMSAJournalStandard != null)
				msgs = ((InternalEObject)newHIMSAJournalStandard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_JOURNAL_STANDARD, null, msgs);
			msgs = basicSetHIMSAJournalStandard(newHIMSAJournalStandard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_JOURNAL_STANDARD, newHIMSAJournalStandard, newHIMSAJournalStandard));
	}
	...
	public NotificationChain basicSetNotificationAction(NotificationActionType newNotificationAction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__NOTIFICATION_ACTION, oldNotificationAction, newNotificationAction);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNotificationAction(NotificationActionType newNotificationAction) {
		if (newNotificationAction != notificationAction) {
			...
			if (notificationAction != null)
				msgs = ((InternalEObject)notificationAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__NOTIFICATION_ACTION, null, msgs);
			if (newNotificationAction != null)
				msgs = ((InternalEObject)newNotificationAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__NOTIFICATION_ACTION, null, msgs);
			msgs = basicSetNotificationAction(newNotificationAction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__NOTIFICATION_ACTION, newNotificationAction, newNotificationAction));
	}
	...
	public NotificationChain basicSetScanMetaDataStandard(ScanMetaDataStandardType newScanMetaDataStandard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__SCAN_META_DATA_STANDARD, oldScanMetaDataStandard, newScanMetaDataStandard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setScanMetaDataStandard(ScanMetaDataStandardType newScanMetaDataStandard) {
		if (newScanMetaDataStandard != scanMetaDataStandard) {
			...
			if (scanMetaDataStandard != null)
				msgs = ((InternalEObject)scanMetaDataStandard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__SCAN_META_DATA_STANDARD, null, msgs);
			if (newScanMetaDataStandard != null)
				msgs = ((InternalEObject)newScanMetaDataStandard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.PUBLICLY_FORMATTED_DATA__SCAN_META_DATA_STANDARD, null, msgs);
			msgs = basicSetScanMetaDataStandard(newScanMetaDataStandard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.PUBLICLY_FORMATTED_DATA__SCAN_META_DATA_STANDARD, newScanMetaDataStandard, newScanMetaDataStandard));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD:
				return basicSetHIMSAAudiometricStandard(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1:
				return basicSetHIMSAAudiometricStandard1(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION:
				return basicSetHearingInstrumentSelection(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_FITTING:
				return basicSetHearingInstrumentFitting(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__REMOTE_CONTROL_SELECTION:
				return basicSetRemoteControlSelection(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_REM_STANDARD:
				return basicSetHIMSARemStandard(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_HIT_STANDARD:
				return basicSetHIMSAHitStandard(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMPEDANCE_COMPLETE_MEASUREMENT:
				return basicSetAcousticImpedanceCompleteMeasurement(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__ACOUSTIC_IMMITTANCE_ASSESSMENT:
				return basicSetAcousticImmittanceAssessment(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__TINNITUS_MEASUREMENT_DATA:
				return basicSetTinnitusMeasurementData(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOGRAM_METADATA_STANDARD:
				return basicSetHIMSAAudiogramMetadataStandard(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__COCHLEAR_IMPLANT_SOUND_PROCESSOR_SELECTION:
				return basicSetCochlearImplantSoundProcessorSelection(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_JOURNAL_STANDARD:
				return basicSetHIMSAJournalStandard(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__NOTIFICATION_ACTION:
				return basicSetNotificationAction(null, msgs);
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__SCAN_META_DATA_STANDARD:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD:
				...
				return;
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1:
				setHIMSAAudiometricStandard1((audiogram502.HIMSAAudiometricStandardType)newValue);
				return;
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD:
				...
				return;
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HIMSA_AUDIOMETRIC_STANDARD1:
				setHIMSAAudiometricStandard1((audiogram502.HIMSAAudiometricStandardType)null);
				return;
			case PatientExportPackage.PUBLICLY_FORMATTED_DATA__HEARING_INSTRUMENT_SELECTION:
