 ...
 * </p>
 * <ul>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getTypeOfData <em>Type Of Data</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getDataFormat <em>Data Format</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getActionDate <em>Action Date</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getLastModifiedDate <em>Last Modified Date</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getUserId <em>User Id</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getPublicData <em>Public Data</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getActionGroup <em>Action Group</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getModuleId <em>Module Id</em>}</li>
 *   <li>{@link org.avatar.himsa.export.impl.ActionDataTypeImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionDataTypeImpl extends MinimalEObjectImpl.Container implements ActionDataType {
	...
	protected EClass eStaticClass() {
		return PatientExportPackage.Literals.ACTION_DATA_TYPE;
	}
	...
	public void setTypeOfData(TypeOfDataType newTypeOfData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__TYPE_OF_DATA, oldTypeOfData, typeOfData, !oldTypeOfDataESet));
	}
	...
	public void unsetTypeOfData() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__TYPE_OF_DATA, oldTypeOfData, TYPE_OF_DATA_EDEFAULT, oldTypeOfDataESet));
	}
	...
	public void setDataFormat(BigInteger newDataFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__DATA_FORMAT, oldDataFormat, dataFormat));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setActionDate(XMLGregorianCalendar newActionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__ACTION_DATE, oldActionDate, actionDate));
	}
	...
	public void setLastModifiedDate(XMLGregorianCalendar newLastModifiedDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__LAST_MODIFIED_DATE, oldLastModifiedDate, lastModifiedDate, !oldLastModifiedDateESet));
	}
	...
	public void unsetLastModifiedDate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__LAST_MODIFIED_DATE, oldLastModifiedDate, LAST_MODIFIED_DATE_EDEFAULT, oldLastModifiedDateESet));
	}
	...
	public void setUserId(String newUserId) {
		...
		userId = newUserId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__USER_ID, oldUserId, userId));
	}
	...
	public NotificationChain basicSetPublicData(PubliclyFormattedData newPublicData, NotificationChain msgs) {
		...
		publicDataESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA, oldPublicData, newPublicData, !oldPublicDataESet);
	...
	public void setPublicData(PubliclyFormattedData newPublicData) {
		if (newPublicData != publicData) {
			...
			if (publicData != null)
				msgs = ((InternalEObject)publicData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA, null, msgs);
			if (newPublicData != null)
				msgs = ((InternalEObject)newPublicData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA, null, msgs);
			...
			publicDataESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA, newPublicData, newPublicData, !oldPublicDataESet));
		}
	}
	...
	public NotificationChain basicUnsetPublicData(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA, oldPublicData, null, oldPublicDataESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetPublicData() {
		if (publicData != null) {
			...
			publicDataESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA, null, null, oldPublicDataESet));
		}
	}
	...
	public void setActionGroup(XMLGregorianCalendar newActionGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__ACTION_GROUP, oldActionGroup, actionGroup, !oldActionGroupESet));
	}
	...
	public void unsetActionGroup() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__ACTION_GROUP, oldActionGroup, ACTION_GROUP_EDEFAULT, oldActionGroupESet));
	}
	...
	public void setDeviceType(int newDeviceType) {
		...
		deviceTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__DEVICE_TYPE, oldDeviceType, deviceType, !oldDeviceTypeESet));
	}
	...
	public void unsetDeviceType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__DEVICE_TYPE, oldDeviceType, DEVICE_TYPE_EDEFAULT, oldDeviceTypeESet));
	}
	...
	public void setModuleId(BigInteger newModuleId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__MODULE_ID, oldModuleId, moduleId));
	}
	...
	public void setOperation(OperationTYPE newOperation) {
		...
		operationESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatientExportPackage.ACTION_DATA_TYPE__OPERATION, oldOperation, operation, !oldOperationESet));
	}
	...
	public void unsetOperation() {
		...
		operationESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PatientExportPackage.ACTION_DATA_TYPE__OPERATION, oldOperation, OPERATION_EDEFAULT, oldOperationESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PatientExportPackage.ACTION_DATA_TYPE__TYPE_OF_DATA:
				return getTypeOfData();
			case PatientExportPackage.ACTION_DATA_TYPE__DATA_FORMAT:
				return getDataFormat();
			case PatientExportPackage.ACTION_DATA_TYPE__DESCRIPTION:
				return getDescription();
			case PatientExportPackage.ACTION_DATA_TYPE__ACTION_DATE:
				return getActionDate();
			case PatientExportPackage.ACTION_DATA_TYPE__LAST_MODIFIED_DATE:
				return getLastModifiedDate();
			case PatientExportPackage.ACTION_DATA_TYPE__USER_ID:
				return getUserId();
			case PatientExportPackage.ACTION_DATA_TYPE__PUBLIC_DATA:
				return getPublicData();
			case PatientExportPackage.ACTION_DATA_TYPE__ACTION_GROUP:
				return getActionGroup();
			case PatientExportPackage.ACTION_DATA_TYPE__DEVICE_TYPE:
				return getDeviceType();
			case PatientExportPackage.ACTION_DATA_TYPE__MODULE_ID:
				return getModuleId();
			case PatientExportPackage.ACTION_DATA_TYPE__OPERATION:
				return getOperation();
		}
