 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram.DifferenceLimenIntensityType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link audiogram.DifferenceLimenIntensityType#getDifferenceLimenIntensityPoints <em>Difference Limen Intensity Points</em>}</li>
 * </ul>
 *
 * @see audiogram.AudiogramPackage#getDifferenceLimenIntensityType()
...
public interface DifferenceLimenIntensityType extends EObject {
	 ...
	 * @see audiogram.AudiogramPackage#getDifferenceLimenIntensityType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link audiogram.DifferenceLimenIntensityType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link audiogram.DifferenceLimenIntensityPointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * ## TDLIPoint ##
	 ...
	 * @see audiogram.AudiogramPackage#getDifferenceLimenIntensityType_DifferenceLimenIntensityPoints()
