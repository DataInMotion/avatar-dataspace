 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram.ToneThresholdAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link audiogram.ToneThresholdAudiogramType#getTonePoints <em>Tone Points</em>}</li>
 * </ul>
 *
 * @see audiogram.AudiogramPackage#getToneThresholdAudiogramType()
...
public interface ToneThresholdAudiogramType extends EObject {
	 ...
	 * @see audiogram.AudiogramPackage#getToneThresholdAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link audiogram.ToneThresholdAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram.AudiogramPackage#getToneThresholdAudiogramType_TonePoints()
