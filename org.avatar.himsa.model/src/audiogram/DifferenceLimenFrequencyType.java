 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram.DifferenceLimenFrequencyType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link audiogram.DifferenceLimenFrequencyType#getDifferenceLimenFrequencyPoints <em>Difference Limen Frequency Points</em>}</li>
 * </ul>
 *
 * @see audiogram.AudiogramPackage#getDifferenceLimenFrequencyType()
...
public interface DifferenceLimenFrequencyType extends EObject {
	 ...
	 * @see audiogram.AudiogramPackage#getDifferenceLimenFrequencyType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link audiogram.DifferenceLimenFrequencyType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link audiogram.DifferenceLimenFrequencyPointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * ## TDLFPoint ##
	 ...
	 * @see audiogram.AudiogramPackage#getDifferenceLimenFrequencyType_DifferenceLimenFrequencyPoints()
