 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram.SpeechReceptionThresholdAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link audiogram.SpeechReceptionThresholdAudiogramType#getSpeechReceptionPoints <em>Speech Reception Points</em>}</li>
 * </ul>
 *
 * @see audiogram.AudiogramPackage#getSpeechReceptionThresholdAudiogramType()
...
public interface SpeechReceptionThresholdAudiogramType extends EObject {
	 ...
	 * @see audiogram.AudiogramPackage#getSpeechReceptionThresholdAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link audiogram.SpeechReceptionThresholdAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link audiogram.SpeechScorePointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Speech Reception Points</em>' containment reference list.
	 * @see audiogram.AudiogramPackage#getSpeechReceptionThresholdAudiogramType_SpeechReceptionPoints()
