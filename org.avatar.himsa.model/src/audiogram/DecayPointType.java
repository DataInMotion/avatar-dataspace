 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram.DecayPointType#getStimulusFrequency <em>Stimulus Frequency</em>}</li>
 *   <li>{@link audiogram.DecayPointType#getStimulusLevel <em>Stimulus Level</em>}</li>
 *   <li>{@link audiogram.DecayPointType#getMaskingFrequency <em>Masking Frequency</em>}</li>
 *   <li>{@link audiogram.DecayPointType#getMaskingLevel <em>Masking Level</em>}</li>
 *   <li>{@link audiogram.DecayPointType#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link audiogram.DecayPointType#getEndTime <em>End Time</em>}</li>
 * </ul>
 *
 * @see audiogram.AudiogramPackage#getDecayPointType()
...
public interface DecayPointType extends EObject {
	 ...
	 * @see audiogram.AudiogramPackage#getDecayPointType_StimulusFrequency()
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayPointType#getStimulusFrequency <em>Stimulus Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram.AudiogramPackage#getDecayPointType_StimulusLevel()
	 * @model dataType="audiogram.StimulusLevelType" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayPointType#getStimulusLevel <em>Stimulus Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram.AudiogramPackage#getDecayPointType_MaskingFrequency()
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayPointType#getMaskingFrequency <em>Masking Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram.AudiogramPackage#getDecayPointType_MaskingLevel()
	 * @model dataType="audiogram.MaskingLevelType2"
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayPointType#getMaskingLevel <em>Masking Level</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram.AudiogramPackage#getDecayPointType_StartTime()
	 * @model dataType="audiogram.StartTimeType" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayPointType#getStartTime <em>Start Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see audiogram.AudiogramPackage#getDecayPointType_EndTime()
	 * @model dataType="audiogram.EndTimeType" required="true"
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayPointType#getEndTime <em>End Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
