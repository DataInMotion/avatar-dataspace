 ...
 * </p>
 * <ul>
 *   <li>{@link audiogram.DecayAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}</li>
 *   <li>{@link audiogram.DecayAudiogramType#getDecayPoints <em>Decay Points</em>}</li>
 * </ul>
 *
 * @see audiogram.AudiogramPackage#getDecayAudiogramType()
...
public interface DecayAudiogramType extends EObject {
	 ...
	 * @see audiogram.AudiogramPackage#getDecayAudiogramType_AudMeasurementConditions()
	...
	/**
	 * Sets the value of the '{@link audiogram.DecayAudiogramType#getAudMeasurementConditions <em>Aud Measurement Conditions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link audiogram.DecayPointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Decay Points</em>' containment reference list.
	 * @see audiogram.AudiogramPackage#getDecayAudiogramType_DecayPoints()
