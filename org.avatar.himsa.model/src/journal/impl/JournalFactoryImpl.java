 ...
 * @generated
 */
public class JournalFactoryImpl extends EFactoryImpl implements JournalFactory {
	/**
	 ...
	 * @generated
	 */
	public static JournalFactory init() {
		try {
			JournalFactory theJournalFactory = (JournalFactory)EPackage.Registry.INSTANCE.getEFactory(JournalPackage.eNS_URI);
			if (theJournalFactory != null) {
				return theJournalFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new JournalFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case JournalPackage.DOCUMENT_ROOT: return createDocumentRoot();
			case JournalPackage.HIMSA_JOURNAL_STANDARD_TYPE: return createHIMSAJournalStandardType();
			default:
	...
	public JournalPackage getJournalPackage() {
		return (JournalPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static JournalPackage getPackage() {
