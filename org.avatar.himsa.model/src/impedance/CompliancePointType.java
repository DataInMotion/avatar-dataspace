 ...
 * </p>
 * <ul>
 *   <li>{@link impedance.CompliancePointType#getPressure <em>Pressure</em>}</li>
 *   <li>{@link impedance.CompliancePointType#getCompliance <em>Compliance</em>}</li>
 * </ul>
 *
 * @see impedance.ImpedancePackage#getCompliancePointType()
...
public interface CompliancePointType extends EObject {
	 ...
	 * @see impedance.ImpedancePackage#getCompliancePointType_Pressure()
	...
	/**
	 * Sets the value of the '{@link impedance.CompliancePointType#getPressure <em>Pressure</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see impedance.ImpedancePackage#getCompliancePointType_Compliance()
	...
	/**
	 * Sets the value of the '{@link impedance.CompliancePointType#getCompliance <em>Compliance</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
