 ...
 * </p>
 * <ul>
 *   <li>{@link impedance.EustachianTubeFunctionPerforatedEarDrumTest#getPressurePoint <em>Pressure Point</em>}</li>
 *   <li>{@link impedance.EustachianTubeFunctionPerforatedEarDrumTest#getOpenPoint <em>Open Point</em>}</li>
 *   <li>{@link impedance.EustachianTubeFunctionPerforatedEarDrumTest#getClosePoint <em>Close Point</em>}</li>
 *   <li>{@link impedance.EustachianTubeFunctionPerforatedEarDrumTest#getTimeBase <em>Time Base</em>}</li>
 * </ul>
 *
 * @see impedance.ImpedancePackage#getEustachianTubeFunctionPerforatedEarDrumTest()
...
public interface EustachianTubeFunctionPerforatedEarDrumTest extends EObject {
	 ...
	 * The list contents are of type {@link impedance.PressurePointType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Measurement points
	 ...
	 * @see impedance.ImpedancePackage#getEustachianTubeFunctionPerforatedEarDrumTest_PressurePoint()
	 ...
	 * @see impedance.ImpedancePackage#getEustachianTubeFunctionPerforatedEarDrumTest_OpenPoint()
	 ...
	 * @see impedance.ImpedancePackage#getEustachianTubeFunctionPerforatedEarDrumTest_ClosePoint()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.Integer" upper="3"
	 ...
	 * @see impedance.ImpedancePackage#getEustachianTubeFunctionPerforatedEarDrumTest_TimeBase()
	 * @model dataType="impedance.TimeBaseType"
	...
	/**
	 * Sets the value of the '{@link impedance.EustachianTubeFunctionPerforatedEarDrumTest#getTimeBase <em>Time Base</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
