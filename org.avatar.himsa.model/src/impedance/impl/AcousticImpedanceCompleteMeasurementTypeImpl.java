...
import impedance.EustachianTubeFunctionIntactEarDrumTest;
 ...
 * </p>
 * <ul>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getTympanogramTest <em>Tympanogram Test</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getReflexTest <em>Reflex Test</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getEustachianTubeFunctionIntactEarDrumTest <em>Eustachian Tube Function Intact Ear Drum Test</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getEustachianTubeFunctionPerforatedEarDrumTest <em>Eustachian Tube Function Perforated Ear Drum Test</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getPrivateImpedanceData <em>Private Impedance Data</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getConvertedFromDataStandard <em>Converted From Data Standard</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#isValidatedByNOAH <em>Validated By NOAH</em>}</li>
 *   <li>{@link impedance.impl.AcousticImpedanceCompleteMeasurementTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
